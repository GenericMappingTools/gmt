...
\else
   ...
   \newcommand{\GMT}{\htmladdnormallink{\includegraphics{eps/GMT_glyph10.eps}}{http://gmt.soest.hawaii.edu}}
...
\newcommand{\gmt}{\href{http://gmt.soest.hawaii.edu}{\textbf{GMT}}}
...
% that.
\begin{htmlonly}
   \gdef\GMT{\htmladdnormallink{\textbf{GMT}}{http://gmt.soest.hawaii.edu}}
   \gdef\gmt{\GMT}
