%------------------------------------------
%       $Id: GMT_Appendix_B.tex,v 1.26 2007-09-19 01:51:30 remko Exp $
%
...
\Opt{b} option.  Thus, for input you may set \Opt{bi}[\textbf{s}][\emph{n}],
...
\GMTfig[h]{GMT_App_B_1}{Grid line registration of data nodes.}
