%------------------------------------------
%       $Id: GMT_Appendix_B.tex,v 1.44 2011-05-18 22:23:49 remko Exp $
%
...
first \emph{n} bytes.  The data can be in any format, mixing different data types
...
Here, \emph{n} is the number of each data type in your binary input file; the
