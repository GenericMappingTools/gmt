%------------------------------------------
%       $Id: GMT_Appendix_B.tex,v 1.40 2011-03-22 15:46:42 remko Exp $
%
...
NaN.  The format and number of fields are specified with the \Opt{b} option.
...
If you need to swap the byte-order on either input or output you must use upper case
...
(see Section~\ref{sec:registration}).
