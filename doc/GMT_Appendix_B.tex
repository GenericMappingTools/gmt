%------------------------------------------
%	$Id: GMT_Appendix_B.tex,v 1.1.1.1 2000-12-28 01:23:45 gmt Exp $
%
...
the parameter N\_HEADER\_RECS in the \filename{.gmtdefaults} file
...
may contain \Opt{W} and \Opt{G} options for specifying pen and
...
(the programs know how many columns to write).
