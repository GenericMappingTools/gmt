#!/bin/sh
#	$Id: GMT_App_K_3.sh,v 1.4 2004-05-12 20:45:51 pwessel Exp $
#
...
psbasemap -R -J -O -K -Tm133/2/1i+45/10/5:: --HEADER_FONT_SIZE=12p --TICK_LENGTH=0.05i --ANNOT_FONT_SIZE_SECONDARY=8p >> GMT_App_K_3.ps
