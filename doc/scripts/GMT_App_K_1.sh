#!/bin/sh 
#	$Id: GMT_App_K_1.sh,v 1.10 2007-02-08 21:46:27 remko Exp $
#
...
./getrect.sh -JE130.35/-0.2/1i -2000 2000 -2000 2000 | psxy -R -JE130.35/-0.2/3.5i -O \
	-Wthicker -L -A >> GMT_App_K_1.ps
