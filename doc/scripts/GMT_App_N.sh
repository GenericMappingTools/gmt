#!/bin/sh
#	$Id: GMT_App_N.sh,v 1.7 2006-02-21 17:09:11 remko Exp $
#
...
EOF
	...
	psxy -R0/$n_cols/0/$H -Jx$width -P -K -M $$.lines -W1p -B0 > GMT_App_N_$p.ps
	psxy -R -Jx -O -K -S$width -W0.25p $$.symbols >> GMT_App_N_$p.ps
