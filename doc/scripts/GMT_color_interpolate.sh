...
gmt psscale -D1.7/1.6/3i/0.3ih -Ctmp.cpt -B0.5f0.1 -O -K >> $ps
gmt psscale -D1.7/0.7/3i/0.3ih -Ctmp.cpt -B0.5f0.1 -O -K --COLOR_MODEL=hsv >> $ps

# Plot rainbow color map in the left; right (top) and wrong (bottom)
gmt makecpt -Crainbow -T-1/1/2 -Z > tmp.cpt
gmt psscale -D5.1/1.6/3i/0.3ih -Ctmp.cpt -B0.5f0.1 -O -K >> $ps
gmt psscale -D5.1/0.7/3i/0.3ih -Ctmp.cpt -B0.5f0.1 -O -K --COLOR_MODEL=rgb >> $ps
