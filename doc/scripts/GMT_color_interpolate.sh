#!/bin/sh
#	$Id: GMT_color_interpolate.sh,v 1.1 2008-03-07 17:15:48 remko Exp $
#
...
psscale -D5.1/1.6/3i/0.3ih -Crainbow.cpt -B0.5f0.1 -O -K >> $ps
psscale -D5.1/0.7/3i/0.3ih -Crainbow.cpt -B0.5f0.1 -O -K --COLOR_MODEL=+RGB >> $ps
