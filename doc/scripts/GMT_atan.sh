#!/bin/bash
#	$Id: GMT_atan.sh,v 1.11 2011-03-15 02:06:29 guru Exp $
#
. functions.sh

grdgradient -A45 ../../share/doc/gmt/tutorial/us.nc -N -fg -G$$.t.nc
grd2xyz -Z $$.t.nc > $$.d
cp $$.d save.d
...
0	1
EOF
grdgradient -A45 ../../share/doc/gmt/tutorial/us.nc -Nt -fg -G$$.tt.nc
grd2xyz -Z $$.tt.nc > $$.d
cp $$.d save.d
