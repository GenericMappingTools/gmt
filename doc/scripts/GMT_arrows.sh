...
gmt plot -R0/5/0/5 -JX1.75i -S -W1.5p -Gred -B0 --MAP_VECTOR_SHAPE=0.5 --PS_COMMENTS=true << EOF 
...
EOF
# Circular arrows
gmt plot -S -W1.5p -Gred -B0 --MAP_VECTOR_SHAPE=0.5 -X2i --PS_COMMENTS=true << EOF 
...
EOF
# Geo arrows
gmt plot -R0/90/-41.17/41.17 -JM1.75i -S -W1.5p -Gred -B0 --MAP_VECTOR_SHAPE=0.5 -X2i --MAP_FRAME_TYPE=plain --PS_COMMENTS=true << EOF 
10	0	90	8000	=0.2i
