...
\texttt{	uint8_t *uc1;}	&       /* \emph{Pointer for unsigned 1-byte array} */ \\
\texttt{	int8_t *sc1;}		&       /* \emph{Pointer for signed 1-byte array} */ \\
\texttt{	uint16_t *ui2;}	&       /* \emph{Pointer for unsigned 2-byte array} */ \\
\texttt{	int16_t *si2;}		&       /* \emph{Pointer for signed 2-byte array} */ \\
\texttt{	uint32_t *ui4;}	&       /* \emph{Pointer for unsigned 4-byte array} */ \\
\texttt{	int32_t *si4;}		&       /* \emph{Pointer for signed 4-byte array} */ \\
\texttt{	uint64_t *ui8;}	&       /* \emph{Pointer for unsigned 8-byte array} */ \\
\texttt{	int64_t *si8;}		&       /* \emph{Pointer for signed 8-byte array} */ \\
...
\texttt{	uint64\_t n\_rows;}	&       /* \emph{Number of rows in each vector} */ \\
\texttt{	enum GMT\_enum\_alloc alloc\_mode;}	&       /* \emph{Determines if we may free the vectors or not}  */\\
\texttt{	enum GMT\_enum\_type *type;}		&       /* \emph{Array with data type for each vector}  */\\
...
\texttt{	size\_t dim;}		&       /* \emph{Length of dimension for row (C) or column (Fortran)}  */\\
\texttt{	size\_t size;}		&       /* \emph{Byte length of data}  */\\
\texttt{	enum GMT\_enum\_alloc alloc\_mode;}	&       /* \emph{Determines if we may free the vectors or not}  */\\
\texttt{	enum GMT\_enum\_type type;}		&       /* \emph{The matrix data type}  */\\
