...
long GMT_Register_IO (struct GMTAPI_CTRL *API, long family, long method, \
   long geometry, long direction, double wesn[], void *ptr)
\end{verbatim}
...
void * GMT_Read_Data (struct GMTAPI_CTRL *API, int family, int method, \
    int geometry, int mode, double wesn[], char *input, void *data)
\end{verbatim}
...
int GMT_Write_Data (struct GMTAPI_CTRL *API, int family, int method, \
    int geometry, int mode, double wesn[], void *output, void *data)
\end{verbatim}
