%-----------------------------------------
%	$Id: GMT_Appendix_A.tex,v 1.25 2007-03-23 03:51:12 remko Exp $
%
...
\PS\ to raster formats (see Appendix~\ref{app:C}), and \GMTprog{nc2xy} which can extract data from column-oriented netCDF files.
The package is maintained by Paul Wessel.
