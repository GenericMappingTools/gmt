%------------------------------------------
%	$Id: GMT_Appendix_O.tex,v 1.10 2004-07-13 18:47:09 pwessel Exp $
%
...
for parallel [Default], {\bf n} for normal, or a fixed {\it angle} measured counter-clockwise
...
because the placement of those symbols are based on the mean coordinates of the contour and
not the location of the (local or global) extrema.
...
travel time calculator, \progname{ttt}.}.  We lay down a color map based on the travel times
