...
gmt begin
	...
	gmt grdview @HI_topo_04.nc -R195/210/18/25/-6/4 -Jz0.8c -p -C -N-6+glightgray -Qsm -B2 -Bz2+l"Topo (km)" -BneswZ -Y5c
	echo 7 12 H@#awaiian@# R@#idge@# | gmt text -R0/20/0/20 -Jx1c -F+f50p,ZapfChancery-MediumItalic+jCB
	...
	gmt grdview @HI_topo_04.nc -I+a0+nt0.75 -R195/210/18/25/-6/4 -JZ8c -p60/30 -C@topo_04.cpt -N-6+glightgray -Qc100 -B2 -Bz2+l"Topo (km)" -BneswZ -Y5c
	echo 7 12 H@#awaiian@# R@#idge@# | gmt text -R0/20/0/20 -Jx1c -F+f50p,ZapfChancery-MediumItalic+jCB
gmt end show
