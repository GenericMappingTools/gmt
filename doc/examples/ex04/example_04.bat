...
gmt psscale -R -J -p -DjBC+o0/0.5i+w5i/0.3i+h -Cgeoid.cpt -I -O -K -Bx2+l"Geoid (m)" >> %ps%
gmt psbasemap -R -J -p -O -K -Td209/19.5+w1i+l --COLOR_BACKGROUND=red --MAP_TICK_PEN_PRIMARY=thinner,red --FONT=red >> %ps%
