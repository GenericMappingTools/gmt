...
echo 0 -30 Honolulu, Hawaii, April 1, 2013 | pstext -R -J -O -K -F+f18p,Helvetica-Bold,green=thinnest >> %ps%
...
echo 0 20 10TH INTERNATIONAL | pstext -R -J -O -K -F+f32p,Helvetica-Bold,red=thinner >> %ps%
echo 0 -10 GMT CONFERENCE | pstext -R -J -O -K -F+f32p,Helvetica-Bold,red=thinner >> %ps%
echo 0 -30 Honolulu, Hawaii, April 1, 2013 | pstext -R -J -O -F+f18p,Helvetica-Bold,green=thinnest >> %ps%
