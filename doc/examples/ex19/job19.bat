REM		GMT EXAMPLE 19
REM
REM		$Id: job19.bat,v 1.21 2011-05-18 16:24:14 remko Exp $
REM
...
grdimage lat.nc -JI0/6.5i -Clat.cpt -P -K -Y7.5i -B/ -nl > %ps%
...
pscoast -R -J -O -K -Dc -A5000 -Gp100/86:FredByellow -Sp100/circuit.ras -B/ -Y-3.25i >> %ps%
...
grdimage lon.nc -J -Clon.cpt -O -K -Y-3.25i -B/ -U"Example 19 in Cookbook" -nl >> %ps%
pscoast -R -J -O -K -Dc -A5000 -Gc >> %ps%
