REM		GMT EXAMPLE 19
REM
REM		$Id: job19.bat,v 1.19 2011-03-15 02:06:31 guru Exp $
REM
...
echo 0 -30 Honolulu, Hawaii, April 1, 2011 | pstext -R -J -O -K -F+f18p,Helvetica-Bold,green=thinnest >> %ps%
...
echo 0 20 9TH INTERNATIONAL | pstext -R -J -O -K -F+f32p,Helvetica-Bold,red=thinner >> %ps%
echo 0 -10 GMT CONFERENCE | pstext -R -J -O -K -F+f32p,Helvetica-Bold,red=thinner >> %ps%
echo 0 -30 Honolulu, Hawaii, April 1, 2011 | pstext -R -J -O -F+f18p,Helvetica-Bold,green=thinnest >> %ps%
