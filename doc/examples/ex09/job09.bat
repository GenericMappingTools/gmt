REM		GMT EXAMPLE 09
REM
REM		$Id: job09.bat,v 1.5 2004-09-29 01:29:02 pwessel Exp $
REM
...
if %master%==y cd ex09
pswiggle all.xys -R185/250/-68/-42 -U"Example 9 in Cookbook" -K -Jm0.13i -Ba10f5 -Gblack -Z2000 -W0.25p -M -S240/-67/500/@~m@~rad > example_09.ps
