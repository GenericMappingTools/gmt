...
#		GMT EXAMPLE 09
#
#		$Id: job09.sh,v 1.1 2001-09-14 18:55:04 pwessel Exp $
#
...
for file in track_*.xys	# Make label file
do
	tail -1 $file >> tmp
done
ls track_*.xys | $AWK -F. '{print $2}' > tracks.lis
paste tmp tracks.lis | $AWK '{print $1, $2, 10, 50, 1, 7, $4}' | pstext -R -Jm -D-0.05i/-0.05i -O >> example_09.ps
