#!/bin/sh
#		GMT EXAMPLE 01
#		$Id: job01.sh,v 1.14 2008-02-22 21:10:42 remko Exp $
#
...
grdcontour -R osu91a1f_16.nc -J -C10 -A50+s7 -Gd4i -L-1000/-1 -Wcthinnest,- -Wathin,- -O -K \
	-T0.1i/0.02i >> $ps
grdcontour -R osu91a1f_16.nc -J -C10 -A50+s7 -Gd4i -L-1/1000 -O -K -T0.1i/0.02i >> $ps
pscoast -Rg -JH180/6i -Y4i -O -K -Bg30:."Low Order Geoid": -Dc -Glightgray >> $ps
