REM		GMT EXAMPLE 18
REM
REM		$Id: job18.bat,v 1.1.1.1 2000-12-28 01:23:45 gmt Exp $
REM
...
gawk -f t pratt.d | pstext -R -JM -O -K -D0.1i/0.1i >> example_18.ps
gawk "{print $1, $2, 0, 200, 200}" pratt.d | psxy -R -JM -O -K -SE -W0.25p >> example_18.ps
...
grdcontour AK_gulf_grav.grd -JM -C10 -L49/51 -O -K -D- -Wc0.75p/0/255/0 >> example_18.ps
...
gmtselect -R -JM -C200/pratt.d centers.d > tmp
psxy tmp -R -JM -O -K -SC0.04i -G255/0/0 -W0.25p >> example_18.ps
...
psxy -R -JM -A -O -K -L -W0.75p -G255 tmp >> example_18.ps
