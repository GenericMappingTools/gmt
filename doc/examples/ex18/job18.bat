REM		GMT EXAMPLE 18
REM
REM		$Id: job18.bat,v 1.7 2006-10-22 14:26:49 remko Exp $
REM
...
grdcontour AK_gulf_grav.grd -J -C10 -L49/51 -O -K -D- -Wcthin,green >> example_18.ps
...
psxy tmp -R -J -O -K -SC0.04i -Gred -Wthinnest >> example_18.ps
