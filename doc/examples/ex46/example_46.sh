...
gmt pscoast -Rd -JKs0/9i -Dl -A5000 -W0.5p -N1/0.5p,gray -S175/210/255 -Bafg --MAP_FRAME_TYPE=plain -K -Xc > $ps
...
echo -56.4477 -14.7067 | gmt psxy -R -J -Sksunglasses/1.5c -Gyellow -O >> $ps
