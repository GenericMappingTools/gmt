#!/bin/sh
#
#	GMT Example 24  $Id: job24.sh,v 1.3 2006-05-08 01:35:12 pwessel Exp $
#
...
gmtselect oz_quakes.d -L1000/dateline.d -Nk/s -C3000/point.d -fg -R -Il | psxy -R -JM -O -K -Sc0.05i -Ggreen >> example_24.ps
