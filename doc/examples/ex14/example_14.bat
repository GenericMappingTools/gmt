...
REM GMT progs:	gmtset, gmtconvert, blockmean, grdcontour, grdtrack, grdtrend
...
gmt convert mean.xyz --FORMAT_FLOAT_OUT=%%.1f | gmt pstext -R -J -D0.15c/0 -F+f6p+jLM -O -K -Gwhite -W -C0.01i -N >> %ps%
