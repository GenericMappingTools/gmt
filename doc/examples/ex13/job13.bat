REM		GMT EXAMPLE 13
REM
REM		$Id: job13.bat,v 1.7 2010-06-21 23:42:55 guru Exp $
REM
...
grdcontour dzdx.nc -JX3i -B1/1WSne -C0.1 -A0.5 -K -P -G2i/10 -S4 -T0.1i/0.03i -U"Example 13 in Cookbook" > example_13.ps
grdcontour dzdy.nc -J -B1/1WSne -C0.05 -A0.2 -O -K -G2i/10 -S4 -T0.1i/0.03i -X3.45i >> example_13.ps
grdcontour z.nc -J -B1/1WSne -C0.05 -A0.1 -O -K -G2i/10 -S4 -T0.1i/0.03i -X-3.45i -Y3.45i >> example_13.ps
grdcontour z.nc -J -B1/1WSne -C0.05 -O -K -G2i/10 -S4 -X3.45i >> example_13.ps
