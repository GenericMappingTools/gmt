#!/bin/sh
#		GMT EXAMPLE 30
#		$Id: job30.sh,v 1.1 2010-01-05 03:49:47 guru Exp $
#
...
psbasemap -R0/360/-1.25/1.75 -JX8i/6i -B90f30:,-\\232:/1g10:."Two Trigonometric Functions":WS -K \
...
-0.33333 0.6 12 30 4 LB 120\\232
EOF
