...
grdimage key.nc -JKs180/9i -B60/30:."Antipodal comparisons":WsNE -K -Ckey.cpt -Y1.2i -UL/-0.75i/-0.95i/"Example 25 in Cookbook" -nn > %ps%
...
pslegend -R0/9/0/0.5 -Jx1i -O -Dx4.5i/0/6i/0.3i/TC -Y-0.2i -F+pthick tmp >> %ps%
del *.nc
del key.*
del tmp
del awk.txt
