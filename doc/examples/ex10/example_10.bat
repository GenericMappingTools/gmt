...
REM GMT progs:	gmtwhich, pscoast, pstext, psxyz, pslegend
...
gmt psxyz @languages_10.txt -R-180/180/-90/90/0/2500 -J -JZ2.5i -So0.3i+Z5 -Ct.cpt -Wthinner --FONT_TITLE=30p,Times-Bold --MAP_TITLE_OFFSET=-0.7i -O -K -p --FORMAT_GEO_MAP=dddF -Bx60 -By30 -Bza500+lLanguages -BWSneZ+t"World Languages By Continent" >> %ps%
