REM		GMT EXAMPLE 10
REM
REM		$Id: job10.bat,v 1.8 2008-05-06 22:14:48 guru Exp $
REM
...
psxyz agu2008.txt -R-180/180/-90/90/1/100000 -J -JZ2.5il -So0.3ib1 -Ggray -Wthinner -B60g60/30g30/a1p:Memberships:WSneZ -O -K -E200/40 >> example_10.ps
gawk "{print $1, $2, 20, 0, 0, 7, $3}" agu2008.txt | pstext -Rd -J -O -K -E200/40 -Gwhite -Sthinner -D-0.2i/0 >> example_10.ps
