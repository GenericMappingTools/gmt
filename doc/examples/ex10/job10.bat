REM		GMT EXAMPLE 10
REM
REM		$Id: job10.bat,v 1.3 2003-12-18 02:27:21 pwessel Exp $
REM
...
psxyz agu.d -R-180/180/-90/90/1/100000 -J -JZ2.5il -So0.3ib1 -G140 -W0.5p -B60g60/30g30/a1p:Memberships:WSneZ -O -K -E200/40 >> example_10.ps
gawk "{print $1-10, $2, 20, 0, 0, 7, $3}" agu.d | pstext -R-180/180/-90/90 -J -O -K -E200/40 -G255 -S0.5p >> example_10.ps
