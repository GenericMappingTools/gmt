...
# GMT modules:	gmtwhich, pscoast, pstext, psxyz, pslegend
# Unix progs:	$AWK
#
ps=example_10.ps
...
gmt psxyz languages_10.txt -R-180/180/-90/90/0/2500 -J -JZ2.5i -So0.3i -Gpurple -Wthinner \
...
$AWK '{print $1, $2, $3+$4, $3}' languages_10.txt \
	| gmt psxyz -R -J -JZ -So0.3ib -Gblue -Wthinner -O -K -p >> $ps
$AWK '{print $1, $2, $3+$4+$5, $3+$4}' languages_10.txt \
	| gmt psxyz -R -J -JZ -So0.3ib -Gdarkgreen -Wthinner -O -K -p >> $ps
$AWK '{print $1, $2, $3+$4+$5+$6, $3+$4+$5}' languages_10.txt \
	| gmt psxyz -R -J -JZ -So0.3ib -Gyellow -Wthinner -O -K -p >> $ps
$AWK '{print $1, $2, $3+$4+$5+$6+$7, $3+$4+$5+$6}' languages_10.txt \
