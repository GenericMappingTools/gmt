...
#		GMT EXAMPLE 10
#
#		$Id: job10.sh,v 1.5 2004-04-10 17:19:14 pwessel Exp $
#
# Purpose:	Make 3-D bar graph on top of perspective map
# GMT progs:	pscoast, pstext, psxyz
# Unix progs:	$AWK, rm
#
pscoast -R-180/180/-90/90 -JX8i/5id -Dc -Gblack -E200/40 -K -U"Example 10 in Cookbook" > example_10.ps
...
$AWK '{print $1-10, $2, 20, 0, 0, "RM", $3}' agu.d | pstext -R-180/180/-90/90 -J -O -K -E200/40 -Gwhite -S0.5p >> example_10.ps
