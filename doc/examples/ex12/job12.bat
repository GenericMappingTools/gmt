REM		GMT EXAMPLE 12
REM
REM		$Id: job12.bat,v 1.2 2002-01-30 03:40:56 ben Exp $
REM
...
gawk "{print $1, $2, 6, 0, 0, 6, NR-1}" table_5.11 | pstext -R -JX -O -K >> example_12.ps
REM
...
gawk "{print $1, $2, 6, 0, 0, 5, $3}" table_5.11 | pstext -R -JX -O -K -W255o -C0.01i/0.01i -D0.08i/0i -N >> example_12.ps
REM
