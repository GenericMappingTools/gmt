...
gmt psbasemap -R -J -O -K -DjTR/1.5i/1.5i/TR/0.15i/0.1i+stmp -F+gwhite+p1p+c0.1c+stmp >> %ps%
...
gmt psbasemap -R -J -O -K -DjTR/5.08c/2.36650592089c/TR/0.15i/0.1i+stmp -F+gwhite+p1p+c0.1c+stmp >> %ps%
REM read x0 y0 w h < tmp
