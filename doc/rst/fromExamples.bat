...
REM	$Id$
REM
REM call fromExamples 40 %name% %ext% %frmt% %path_build% %pathGallery%  %pato%
...
IF "%3"=="pdf" (
	gmt ps2raster %~dp0../examples/ex%1/example_%1.ps -A+S0.6 -P -T%4 -D%5
	echo .. figure:: %5/%2.%3 > %7\fig_%2.rst_
	echo.   >> %7\fig_%2.rst_

) ELSE (
	gmt ps2raster %~dp0../examples/ex%1/example_%1.ps -A -E150 -P -T%frmt% -Qt4 -D%5
