...
is used to create a network of lines based on a file with
the nodes (the 6 airports).  We also demonstrate how the
...
cells by :doc:`sphtriangulate </sphtriangulate>` and used
with transparent coloring, allowing us to see the seafloor
texture image beneath.  Finally,
