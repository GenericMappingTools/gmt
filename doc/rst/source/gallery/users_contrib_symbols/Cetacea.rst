...
4: Run the bash script, print/open the output postscript file myfile.ps, or convert
   to PDF or rasters with gmt psconvert.
...
# 1.1 The symbols are not drawn

When In run the script I obtain GMT ERROR: psxy:
  ## 1.1.1 Could not find custom symbol symbolname.def!
  ## 1.1.2 Could not find custom symbol mydirsymbolname! 
  ## 1.1.3 Cannot open file mydirmyfile.xy!
 -------------------------------------------------------
  1.1.1 
...
*1.2 Symbol customization

  *1.2.1 The symbols are to much big!, What size should I use?
  *1.2.2 I don't want color symbols!
  *1.2.3 How can I change the colour of the symbols?
  *1.2.4 After editing the def file I obtain strange 
   polygonal patches instead the desired symbol but all points 
...
*1.3 Other questions
  ...
  *1.3.1 Why they are so may similar symbols low, 
  high, etc... for the same species?
  --------------------------------------------
 ...
 *1.3.2 Where fall the real coordinates in the figure?   
 -----------------------------------------------------
