 ...
 **CUMSUM**      2 1    Cumulative sum of each row (B=±1|3) or column (B=±2|4) in A. Sign of B gives direction of summation     Arithmetic         
 ...
 **SADDLE**      1 1    -1/+1 indicates a saddle point, with (local) minimum (-1) or maximum (+1) in x-direction, 0 elsewhere   Calculus           
...
#. The operators **YLM** and **YLMg** calculate normalized spherical
   ...
   complex spherical harmonic. Use the **POP** operator (and **EXCH**) toABS
...
d^2(A)/dx^2 Central 2nd derivative

D2DY2

1 1

d^2(A)/dy^2 Central 2nd derivative

D2DXY

1 1

d^2(A)/dxdy Central 2nd derivative
...
-1/+1 indicates a saddle point, with (local) minimum (-1) or maximum (+1) in x-direction, 0 elsewhere
