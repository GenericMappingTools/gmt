...
will in addition need to supply information about which contours to draw. Unfortunately, :doc:`/grdcontour` is a 
complicated module with too many options. We put a positive spin on this situation by touting its flexibility.
...
:doc:`/blockmean`, :doc:`/blockmedian`, and :doc:`/blockmode`. The first averages values inside the
