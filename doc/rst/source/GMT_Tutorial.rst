...
#. To view a *PostScript* file (e.g., map.ps) on a UNIX workstation
   ...
   files to PDF using the :doc:`ps2raster` module.  Turning the file map.ps to map.pdf
   is done with

   ::

    gmt ps2raster -Tf map.ps
...
to another module.  This is achieved with UNIX *pipes*:
...
Most UNIX programa and GMT modules will on occasion write error messages.
