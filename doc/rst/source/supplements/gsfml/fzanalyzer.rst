...
produced by :doc:`grdtrack`.  It then analyzes the trace of each FZ
...
*crossprofiles*
    This file is a table with cross-profiles as produced by :doc:`grdtrack` **-C**
...
The two input files are themselves generated by running :doc:`grdtrack` first.  This step
...
are all NaNs.  You design your cross-profile layout and resampled FZ trackes using :doc:`grdtrack`
options  **-C** and **-D**..
