%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.116 2009-05-15 01:40:07 guru Exp $
%
...
model, a more sophisticated alternative to IGRF, or the IGRF.
...
\begin{description}
	...
	\item [\GMTprog{mgd77/mgd77.c}]: Was failing to read Windows terminated ASCII files.
		...
		when geocentric coordinates were used.
...
\begin{enumerate}
	...
	\item \GMTprog{pglegend.c} allows {\bf S} record not to have {\it text}. Until now, when left empty would
		use whatever {\it text} was set to in previous record.
