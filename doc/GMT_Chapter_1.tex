%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.36 2006-05-08 03:24:05 pwessel Exp $
%
...
that require Matlab (--disable-mex) and X11 (--disable-xgridX).
...
\item [\GMTprog{grdmask.c}]: Did not explicitly close polygons before using them.
...
\item [\GMTprog{mgd77/mgd77manage.c}]: Did no properly close the file after ingesting E77 information.
