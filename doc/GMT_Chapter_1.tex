%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.68 2007-09-30 03:17:41 guru Exp $
%
...
\item \GMTprog{grdproject} has considers \Opt{R} and optional setting.
...
\item \GMTprog{ps2raster} now a new \Opt{P} option for forcing portrait orientation.
\item \GMTprog{pshistogram} now a new \Opt{C} option for using a cpt file to paint the bars.
