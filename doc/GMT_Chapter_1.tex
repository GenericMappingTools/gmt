%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.153 2010-10-09 22:26:20 guru Exp $
%
...
However, the \GMT\ 4.5.4 release is mostly bug-fixes as all development is now focussed on \GMT\ 5; this
...
for some time after \GMT 5 is released later this year; an $\alpha$-release was made available for
CVS on Oct-15, 2010.

\subsection{Overview of \gmt\ 4.5.4 [Oct-15, 2010]}
...
\item We have added time-axes support for the Hawaiian language.
\end{enumerate}
...
\begin{description}
	...
	\item [\GMTprog{gmt\_plot.c}]:	Bug in fault symbol \GMTprog{psxy} \Opt{Sfrc} fixed (thanks to J. Robert).
		Also, \GMT_func{GMT\_map\_latline} and \GMT_func{GMT\_map\_lonline} functions tried to draw 
	...
	\item [\GMTprog{nearneighbor.c}]:	Did not check that \Opt{S} had not been set.
	\item [\GMTprog{ps2raster.c}]:	Made tolerant of \\r-only line-endings which caused trouble before.
