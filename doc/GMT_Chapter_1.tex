%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.39 2006-05-15 23:48:19 pwessel Exp $
%
...
as they do not change as frequently as the source code.
...
failed to get correct unit when ddd:mm:ss syntax was used for the position. Corner boundary conditions (needed
by \GMTprog{grdtrack}, \GMTprog{grdsample}, \GMTprog{grdview}, and \GMTprog{grdgradient}) had wrong sign.
