%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.64 2007-03-29 20:19:17 pwessel Exp $
%
...
\item \GMTprog{grdcontour.c} has a new option \Opt{F} to orient dumped contours.
...
\item \GMTprog{grdinfo.c} has an enhanced \Opt{I} option.  With no arguments we return the grid's \Opt{I}{\it dx/dy} string
...
\item \GMTprog{psxy.c} understand \Opt{W-} and \Opt{W+} in multisegment headers which will turn off outline or reset to default, respectively.
...
\item [\GMTprog{grdcontour.c}]: Interior contours were not smoothed unless NaNs were involved.  Also the
...
\item [\GMTprog{x2sys/x2sys\_cross.c}]: Failed to check for crossovers falling exacly on data nodes.
\end{description}
