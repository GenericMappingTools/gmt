%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.24 2005-09-26 03:18:03 pwessel Exp $
%
...
\item [\GMTprog{gmt_map.c}]: Azimuth to angle calculation for linear projections now properly handle different
...
\item [\GMTprog{grdmask.c}]: Now handles both Cartesian and spherical well
...
\item [\GMTprog{psscale.c}]: Vertical annotations w/custom {\bf D\_FORMAT} were not aligned.
\item [\GMTprog{psxy.c}]: \Opt{Sp} is now a true point, but can also take an optional size.
\item [\GMTprog{psxyz.c	}]: Wrong index used in assigning color from cpt and in updating vector lengths.
