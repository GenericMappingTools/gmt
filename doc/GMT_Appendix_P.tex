%------------------------------------------
%	$Id: GMT_Appendix_P.tex,v 1.3 2004-08-26 03:50:47 pwessel Exp $
%
...
changes to your environment (the detauls are shell dependent but explained by \progname{gmtswitch}):
\begin{enumerate}
...
new version breaking things should install both \GMT\ 3.4.5 and 4 and use \progname{gmtswitch} if the need
arises.  You will find \progname{gmtswitch} in the top-level \GMT 4 directory; install as explained above.
