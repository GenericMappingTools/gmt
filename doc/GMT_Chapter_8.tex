%------------------------------------------
%	$Id: GMT_Chapter_8.tex,v 1.22 2011-01-02 20:09:05 guru Exp $
%
...
you will need to convert the frames into a proper movie format such as MPEG-4.
There are both free and commercial tools that
can help with this conversion and they tend to be platform-specific.  For moderate
projects you can use \progname{convert} to build a MP4 file, but longer movies will
require a more flexible tools, such as \progname{ffmpeg}.  These solutions are
preferred as they can be scripted and be included in your animation script.
Most commercial movie
tools such as iMovie or MovieMaker can ingest still images and let you specify
the frame duration.  Under OS X we prefer to use QuickTime 7.\footnote{While QuickTime
