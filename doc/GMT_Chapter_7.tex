%------------------------------------------
%	$Id: GMT_Chapter_7.tex,v 1.55 2008-12-06 02:40:10 guru Exp $
%
...
Cartesian coordinates hence the chosen approach.  We use \GMTProf{greenspline} to produce a crude
...
can use to demonstrate spherical surface gridding.  Since \GMTProf{greenspline} must solve a \emph{N} by \emph{N}
matrix system your system memory may impose limits on how large data sets you can handle.
