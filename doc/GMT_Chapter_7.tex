%------------------------------------------
%	$Id: GMT_Chapter_7.tex,v 1.37 2007-09-11 23:38:24 remko Exp $
%
...
\GMTexample{11}{The RGB color cube.}
...
\script{example_14} 
\GMTexample{14}{Gridding of data and trend surfaces.}
...
\script{example_15} 
\GMTexample{15}{Gridding, contouring, and masking of data.}
...
patterns for interval (900,925) and NaN, and a ``skip slice'' request for interval (700,725).

\script{example_16} 
\GMTexample{16}{More ways to grid data.}
...
\script{example_19} 
\GMTexample{19}{Using color patterns in illustrations.}
...
\GMTexample{25}{Global distribution of antipodes.}
