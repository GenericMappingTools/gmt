%------------------------------------------
%       $Id: GMT_Tutorial.tex,v 1.76 2011-04-07 00:55:30 guru Exp $
%
...
contain the {\it z}-values to be used with the CPT file.
...
\begin{tabular}{|l|l|} \hline
\multicolumn{1}{|c|}{\emph{Option}} & \multicolumn{1}{c|}{\emph{Purpose}} \\ \hline 
\Opt{C}{\it CPT file} & The required CPT file \\ \hline
...
\begin{tabular}{|l|l|} \hline
\multicolumn{1}{|c|}{\emph{Option}} & \multicolumn{1}{c|}{\emph{Purpose}} \\ \hline 
\Opt{C}{\it CPT file} & The {\it CPT file} is required for color -coded surfaces and for contoured mesh plots \\ \hline
