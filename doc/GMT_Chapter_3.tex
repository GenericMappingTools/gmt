%------------------------------------------
%	$Id: GMT_Chapter_3.tex,v 1.38 2008-04-30 03:53:30 remko Exp $
%
...
\GMTprog{xyz2grd}	\>	Convert an equidistant table \emph{xyz} file to a 2-D gridded file
\end{tabbing}
\index{GMT@\GMT!overview|)}
...
\GMTprog{xyz2grd}	&	Convert table data to 2-D gridded file \\ \hline
