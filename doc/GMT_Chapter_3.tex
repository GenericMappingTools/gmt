%------------------------------------------
%	$Id: GMT_Chapter_3.tex,v 1.1.1.1 2000-12-28 01:23:45 gmt Exp $
%
...
\multicolumn{2}{|l|}{\hspace{0.2in}[{\bf a}]{\it tick}[{\bf m}$|${\bf c}][{\bf f}{\it tick}[{\bf m}$|${\bf c}]][{\bf g}{\it tick}[{\bf m}$|${\bf c}]][{\bf l}$|${\bf p}][:"label":][:,"unit":]} \\
...
\hspace{0.2in}\Opt{JX}$width$[{\bf l}$|${\bf p}][/$height$[{\bf l}$|${\bf p}]][{\bf d}]	&	Linear, log$_{10}$, and $x^a$--$–y^b$ (exponential) \\ \hline
