%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.142 2011-05-02 03:26:19 remko Exp $
%
...
you can concatenate several [\emph{n}]\textbf{t} combination,
...
For binary output, use the \Opt{bo}[\emph{n}]\textbf{t} option; see \Opt{bi} for
details.
...
\label{sec:resample}
The \Opt{n}\emph{type} option controls parameters that are
