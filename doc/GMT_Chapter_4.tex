%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.51 2004-07-14 00:46:17 pwessel Exp $
%
...
also be utilized for geographic basemaps.  This is particularly useful to separate the
...
\GMTfig[h]{GMT_-B_geo_2}{Geographic map border with both primary and secondary components.}
...
the supplemental program \GMTprog{img2grd}; see Appendix A for information
...
\Opt{W}0.5p		&	Plain solid line, 0.5 point thick \\ \hline 
...
take an existing color table and resample it to fit your particular data
range.  However, in some situations you will need to make a cpt-file by
...
format.  As distributed, \GMT\ now recognizes 13 predefined file
formats.  These are  
...
\item[12.] NOAA/NGDC MGG grid format
\end{description} 
