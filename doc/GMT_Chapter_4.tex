%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.154 2011-06-22 15:06:06 remko Exp $
%
...
In the case of automatic spacing, but also in general, when the \emph{stride} argument is omitted after \textbf{g}, the grid line spacing is chosen the same as the annotation/major tick spacing. Thus \Opt{B10g} means the same as \Opt{B10g10}.
