%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.26 2003-07-24 21:08:13 pwessel Exp $
%
...
{\bf D}	&	date & Format anotation using {\bf PLOT\_DATE\_FORMAT} \\ \hline
...
\filename{.gmtdefaults4} file which by default is set to {\it yyyy-mm-dd}.  Y2K-challenged input data such as 29/05/89 can be processed by setting {\bf INPUT\_DATE\_FORMAT}
...
\par \Opt{W}{\it width}[/{\it color}][{\bf t}{\it texture}][{\bf c$|$i$|$p$|$m}]\par 
...
is 1/300th of an inch.  Append {\bf c}, {\bf i}, {\bf p}, or {\bf m} to specify pen width in
