...
append \texttt{--}\textbf{FORMAT\_FLOAT\_OUT}=\%.16lg to the command in question.
...
\textbf{O}	&	month		& Format annotation using \textbf{FORMAT\_DATE\_MAP} \\
\textbf{o}	&	month		& Plot as 2-digit integer (1--12) \\
\textbf{U}	&	ISO week	& Format annotation using \textbf{FORMAT\_DATE\_MAP} \\
...
\textbf{D}	&	date		& Format annotation using \textbf{FORMAT\_DATE\_MAP} \\
\textbf{d}	&	day		& Plot day of month (1--31) or day of year (1--366) \\
		&			& (see \bf{FORMAT\_DATE\_MAP} \\
\textbf{R}	&	day		& Same as \textbf{d}; annotations aligned with week (see \textbf{TIME\_WEEK\_START})\\
\textbf{H}	&	hour		& Format annotation using \textbf{FORMAT\_CLOCK\_MAP} \\
\textbf{h}	&	hour		& Plot as 2-digit integer (0--24) \\
\textbf{M}	&	minute		& Format annotation using \textbf{FORMAT\_CLOCK\_MAP} \\
\textbf{m}	&	minute		& Plot as 2-digit integer (0--60) \\
\textbf{S}	&	seconds		& Format annotation using \textbf{FORMAT\_CLOCK\_MAP} \\
...
\emph{x}-direction (by the width of the chosen paper \textbf{PS\_MEDIA)} and then rotating the
...
this behavior can be overridden by setting the \textbf{IO\_GRIDFILE\_FORMAT} defaults parameter
