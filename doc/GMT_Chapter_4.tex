%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.31 2004-01-10 02:34:54 pwessel Exp $
%
...
The fourth example (Figure~\ref{fig:GMT_-B_time4}) only shows a few hours of a day.  We select both upper and lower annotations, ask for a 12-hour
...
in the 0--360, 0--1, 0--1 range; to use this color system you must also set {\bf COLOR\_MODEL} to HSV),
or CMYK color ({\it cyan}/{\it magenta}/{\it yellow}/{\it black},
