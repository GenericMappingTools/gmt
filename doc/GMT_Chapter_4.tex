%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.1.1.1 2000-12-28 01:23:45 gmt Exp $
%
...
There are more than 50 parameters which can be adjusted individually
...
The 13 switches in Table~\ref{tbl:switches} have the same meaning
...
\texttt{-Joc190/25.5/327/56/1:500000} \\ 
...
(See Appendix F).  Also see the definition of (and reason for)
WANT\_EURO\_FONT in the \GMTprog{gmtdefaults} man page.  Basically,
WANT\_EURO\_FONT must be set to TRUE for the special characters to
be available.  Many characters that are not directly available by
