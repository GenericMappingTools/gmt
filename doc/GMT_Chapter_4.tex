%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.43 2004-04-20 18:29:36 pwessel Exp $
%
...
parameters.  These are {\bf GMT\_DATADIR}, {\bf GMT_GRIDDIR}, and
{\bf GMT_IMGDIR} and may be set by the user to point to directories
