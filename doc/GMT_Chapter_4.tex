%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.119 2009-05-03 23:05:02 guru Exp $
%
...
\begin{description}
	...
	\item [\$GMT\_DATADIR] points to a directory where large and/or widely used data files can
	be placed.  All \GMT\ programs look in this directory when a file is specified on the
