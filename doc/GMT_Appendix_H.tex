%------------------------------------------
%	$Id: GMT_Appendix_H.tex,v 1.2 2002-01-17 22:57:17 pwessel Exp $
%
...
as new \PS\ printers.  Sometimes unexpected things
...
The parameter DOTS\_PR\_INCH can be set by the user through
the \filename{.gmtdefaults} file or \GMTprog{gmtset}.  By default
...
edit your \filename{.gmtdefaults} file to set WANT\_EURO\_FONT = FALSE,
which will suppress the printing of this definition in the
\GMT\ \PS\ header.  With this set to FALSE, you can
...
problem:  Set your COLOR\_MODEL to HSV using \GMTprog{gmtset}.  Use
...
the tuning of the \filename{.gmtdefaults}, the cpt file, and
the gradient file.
