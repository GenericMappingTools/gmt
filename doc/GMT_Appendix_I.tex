%------------------------------------------
%	$Id: GMT_Appendix_I.tex,v 1.19 2008-03-11 22:11:54 remko Exp $
%
...
Is chocolate your favorite color, but you do not know the RGB equivalent values? Then look them up in Figure~\ref{fig:RGBchart} or type \progname{man gmtcolors} for a full list. It's 210/105/30. But \GMT\ makes it easy on you: you can specify pen, fill, and palette colors by any of the more than 550 unique names found in that file.
