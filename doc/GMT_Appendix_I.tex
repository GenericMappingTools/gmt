%------------------------------------------
%	$Id: GMT_Appendix_I.tex,v 1.15 2008-03-07 20:54:13 remko Exp $
%
...
Is chocolate your favorite color, but you do not know the RGB equivalent values? Then look them up in the \filename{rgb.txt} file in your X-windows system directory. It's 210/105/30. But \GMT\ makes it easy on you: you can specify pen, fill, and palette colors by any of the more than 600 names found in that file.
