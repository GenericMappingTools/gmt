%------------------------------------------
%	$Id: GMT_Frontmatter.tex,v 1.1.1.1 2000-12-28 01:23:45 gmt Exp $
%
...
\GMT\ versions 3.0--3.3.6 owe their existence to grants EAR-93-02272
and OCE-95-29431 from the National Science Foundation, which we
...
\begin{flushright}
Honolulu, HI and Silver Spring, MD, October 2000
\end{flushright}
\vspace{\baselineskip}
...
to \htmladdnormallink{gmt@soest.hawaii.edu}{mailto:gmt@soest.hawaii.edu}
if you find any.
...
\begin{center}
Copyright \copyright 1991–-- 2000 by Paul Wessel and Walter H. F. Smith
\end{center}
