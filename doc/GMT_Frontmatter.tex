%------------------------------------------
%       $Id: GMT_Frontmatter.tex,v 1.55 2011-03-15 02:06:29 guru Exp $
%
...
\GMT\ series 3.x, 4.x, and 5. owe their existence to grants
...
\includegraphics[height=4cm,bb=0 0 172 138]{Wessel.png} &
\includegraphics[height=4cm,bb=0 0 538 396]{Smith.png} \\
...
& \\
\includegraphics[height=4cm,bb=0 0 533 400]{Scharroo.png} &
\includegraphics[height=4cm,bb=0 0 540 388]{JLuis.png} \\
\normalsize \htmladdnormallink{\textbf{Dr. Remko Scharroo}}{http://www.altimetrics.com} &
\normalsize \htmladdnormallink{\textbf{Dr. Joaquim Luis}}{http://w3.ualg.pt/~jluis/} \\
Aerospace Engineer & Geophysicist \\
\htmladdnormallink{Altimetrics LLC}{http://www.altimetrics.com} &
\htmladdnormallink{Universidade do Algarve}{http://www.ualg.pt} \\
Cornish, New Hampshire & Faro, Portugal \\
\end{tabular}
\end{center}
...
Separation of Bathymetry, {\it Geochem. Geophys. Geosyst., 9(Q03005)}, doi:10.1029/2007GC001850.
...
{\it Computers \& Geosciences}, vol. 35, pp. 1247--1254, 2009  [\GMTprog{greenspline.c}].

\item  Wessel, P., Tools for Analyzing Intersecting Tracks: the x2sys package,
{\it Computers \& Geosciences}, vol. 36, 348--354, 2010  [\GMTprog{x2sys} supplement].

\item Wessel, P. and J. M. Becker, Interpolation using a Generalized
Green's Function for a Spherical Surface Spline in Tension,
{\it Geophys. J. Int.}, vol. 174, pp. 21--28, 2008  [\GMTprog{greenspline.c}].
