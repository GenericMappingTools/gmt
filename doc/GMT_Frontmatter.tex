%------------------------------------------
%       $Id: GMT_Frontmatter.tex,v 1.41 2008-03-07 17:24:23 remko Exp $
%
...
NEXT workstations and Windows PCs.
John Lillibridge provided the original example 11;
William Yip helped translate \GMT\ to POSIX ANSI C and incorporate netCDF 3; 
...
and Wayne Wilson implemented the full general perspective projection.
