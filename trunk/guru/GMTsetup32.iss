...
; $Id: GMTsetup32.iss,v 1.3 2011-07-08 23:17:25 guru Exp $
...
[Messages]
WelcomeLabel2=This will install the 32-bit version of [name/ver] on your computer, including supporting libraries (netCDF and GDAL), HTML documentation and the crude, low, and intermediate GSHHS (version 2.1.1) coastline data.%n%nThe high and full resolution GSHHS coastlines may be installed separately and are not included in this installer.  Likewise, PDF documentation may also be installed separately.
