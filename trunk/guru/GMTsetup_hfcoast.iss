...
; $Id: GMTsetup_hfcoast.iss,v 1.10 2010-01-08 21:35:19 guru Exp $
...
OutputBaseFilename=GSHHS2.0.2_highfull_install
...
[Messages]
WelcomeLabel2=This will install [name/ver] high and full resolution GSHHS coastlines (version 2.0.2) on your computer.%n%nYou should already have completed the basic GMT installation.
