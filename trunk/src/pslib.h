/*--------------------------------------------------------------------
 *	$Id: pslib.h,v 1.44 2008-03-22 11:55:36 guru Exp $
 *
...
#ifdef _WIN64
typedef __int64 PS_LONG;		/* A signed 8-byte integer; otherwise set in gmt.h */
#else
...
*/
	...
	PS_LONG portrait;			/* TRUE if start of plot was portrait */
	PS_LONG clip_level;			/* Add/sub 1 as we clip/unclip - should end at 0 */
        PS_LONG fontno[PSL_MAX_EPS_FONTS];	/* Array with font ids used (skip if -1). 6 is max fonts used in GMT anot/labels */
        char *name;			/* User name */
...
EXTERN_MSC PS_LONG ps_line (double *x, double *y, PS_LONG n, PS_LONG type, BOOLEAN close, BOOLEAN split);
EXTERN_MSC PS_LONG ps_plotinit (char *plotfile, PS_LONG overlay, PS_LONG mode, double xoff, double yoff, double xscl, double yscl, PS_LONG ncopies, PS_LONG dpi, PS_LONG unit, PS_LONG *page_width, PS_LONG *rgb, const char *encoding, struct EPS *eps);
...
EXTERN_MSC void ps_circle (double x, double y, double size, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_clipoff (void);
EXTERN_MSC void ps_clipon (double *x, double *y, PS_LONG n, PS_LONG rgb[], PS_LONG flag);
...
EXTERN_MSC void ps_diamond (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_ellipse (double x, double y, double angle, double major, double minor, PS_LONG rgb[], PS_LONG outline);
...
EXTERN_MSC void ps_hexagon (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
...
EXTERN_MSC PS_LONG ps_pattern (PS_LONG image_no, char *imagefile, PS_LONG invert, PS_LONG image_dpi, PS_LONG outline, PS_LONG f_rgb[], PS_LONG b_rgb[]);
EXTERN_MSC void ps_bitimage (double x, double y, double xsize, double ysize, unsigned char *buffer, PS_LONG nx, PS_LONG ny, PS_LONG invert, PS_LONG f_rgb[], PS_LONG b_rgb[]);
EXTERN_MSC void ps_itriangle (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_octagon (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_pentagon (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_pie (double x, double y, double radius, double az1, double az2, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_plot (double x, double y, PS_LONG pen);
EXTERN_MSC void ps_plotend (PS_LONG lastpage);
EXTERN_MSC void ps_plotr (double x, double y, PS_LONG pen);
EXTERN_MSC void ps_point (double x, double y, double diameter);
EXTERN_MSC void ps_polygon (double *x, double *y, PS_LONG n, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_rect (double x1, double y1, double x2, double y2, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_rotaterect (double x, double y, double angle, double x_len, double y_len, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_patch (double *x, double *y, PS_LONG np, PS_LONG rgb[], PS_LONG outline);
...
EXTERN_MSC void ps_setpaint (PS_LONG rgb[]);
EXTERN_MSC void ps_square (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_star (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_text (double x, double y, double pointsize, char *text, double angle, PS_LONG justify, PS_LONG form);
EXTERN_MSC void ps_textbox (double x, double y, double pointsize, char *text, double angle, PS_LONG justify, PS_LONG outline, double dx, double dy, PS_LONG rgb[]);
...
EXTERN_MSC void ps_triangle (double x, double y, double side, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC void ps_vector (double xtail, double ytail, double xtip, double ytip, double tailwidth, double headlength, double headwidth, double headshape, PS_LONG rgb[], PS_LONG outline);
EXTERN_MSC unsigned char *ps_load_image (char *file, struct imageinfo *header);
EXTERN_MSC void ps_words (double x, double y, char **text, PS_LONG n_words, double line_space, double par_width, PS_LONG par_just, PS_LONG font, double font_size, double angle, PS_LONG rgb[3], PS_LONG justify, PS_LONG draw_box, double x_off, double y_off, double x_gap, double y_gap, PS_LONG boxpen_width, char *boxpen_texture, PS_LONG boxpen_offset, PS_LONG boxpen_rgb[], PS_LONG vecpen_width, char *vecpen_texture, PS_LONG vecpen_offset, PS_LONG vecpen_rgb[], PS_LONG boxfill_rgb[3]);
EXTERN_MSC void ps_setline (PS_LONG linewidth);
EXTERN_MSC void ps_textdim (char *xdim, char *ydim, double pointsize, PS_LONG font, char *text, PS_LONG key);
EXTERN_MSC void ps_set_length (char *param, double value);
EXTERN_MSC void ps_set_height (char *param, double fontsize);
EXTERN_MSC void ps_define_rgb (char *param, PS_LONG rgb[]);
EXTERN_MSC void ps_define_pen (char *param, PS_LONG width, char *texture, PS_LONG offset, PS_LONG rgb[]);
