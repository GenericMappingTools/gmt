...
/* gmt_core_module.c populates the external array of GMT core module parameters
 * such as name, group and purpose strings.
 * This file also contains the following convenience function to display all module purposes:
 *
 *   void gmt_core_module_show_all (struct GMTAPI_CTRL *API); - Print core module names and purposes
 *
...
/* Look out for core modules given by their aliases or old names */
