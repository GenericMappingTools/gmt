...
/* gmt_coremodule.h declares the prototypes for core module functions
 * and the array that contains core GMT module parameters such as name and purpose strings.
 * DO NOT edit this file directly! Instead edit gmt_coremoduleinfo.txt and regenerate
...
EXTERN_MSC struct Gmt_moduleinfo g_coremodule[];
...
EXTERN_MSC void gmt_coremodule_show_all (struct GMTAPI_CTRL *API);
