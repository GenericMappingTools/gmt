...
int GMT_gmtwhich_parse (struct GMTAPI_CTRL *C, struct GMTWHICH_CTRL *Ctrl, struct GMT_OPTION *options)
{
...
int GMT_gmtwhich (struct GMTAPI_CTRL *API, int mode, void *args)
{
	int error = 0;
