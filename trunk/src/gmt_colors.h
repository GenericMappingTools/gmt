/*--------------------------------------------------------------------
 *	$Id: gmt_colors.h,v 1.29 2008-03-22 11:55:34 guru Exp $
 *
...
#define GMT_YIQ(rgb) ((GMT_LONG)irint (0.299 * (rgb[0]) + 0.587 * (rgb[1]) + 0.114 * (rgb[2])))
...
struct GMT_LUT {
	...
	GMT_LONG rgb_low[3], rgb_high[3], rgb_diff[3];
