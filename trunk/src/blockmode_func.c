/*--------------------------------------------------------------------
 *    $Id: blockmode_func.c,v 1.13 2011-06-20 21:45:14 guru Exp $
 *
...
GMT_LONG GMT_blockmode (struct GMTAPI_CTRL *API, struct GMT_OPTION *options)
{
	...
	Ctrl = (struct BLOCKMODE_CTRL *) New_blockmode_Ctrl (GMT);	/* Allocate and initialize a new control structure */
