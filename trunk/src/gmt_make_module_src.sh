 ...
 * and the array that contains ${L_TAG} GMT module parameters such as name and
 * purpose strings.
 * DO NOT edit this file directly! Instead edit gmt_${L_TAG}_moduleinfo.txt and
 * regenerate this file with gmt_make_module_src.sh ${L_TAG}. */
...
/* gmt_${L_TAG}_module.c populates the external array of GMT ${L_TAG} module parameters
 ...
 *
 *   void gmt_${L_TAG}_module_show_all (struct GMTAPI_CTRL *API); - Print ${L_TAG} module names and purposes
 *
 * DO NOT edit this file directly! Instead edit gmt_${L_TAG}_moduleinfo.txt and
 * regenerate this file with gmt_make_module_src.sh ${L_TAG} */
...
/* Look out for ${L_TAG} modules given by their aliases or old names */
