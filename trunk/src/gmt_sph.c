...
int ssrfpack_grid (struct GMT_CTRL *GMT, double *x, double *y, double *z, double *w, uint64_t n_in, uint32_t mode, double *par, bool vartens, struct GMT_GRID_HEADER *h, double *f)
{
