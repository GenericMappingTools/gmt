/* D772/Fortran77/Src/Sp/src.f -- translated by f2c (version 20060506).
	...
	*lend, integer *lnew, integer *lwk, integer *iwk, integer *ier)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___133 = { 0, 6, 0, fmt_100, 0 };
	...
	list, integer *lptr, integer *lend, integer *ier)
{
    ...
    static char fmt_130[] = "(//5x,\002*** Error in EDGE:  Invalid triangul"
	    "a\002,\002tion or null triangles on boundary\002/9x,\002IN1 ="
	    "\002,i4,\002, IN2=\002,i4/)";
    ...
    /* Fortran I/O blocks */
    static cilist io___168 = { 0, 6, 0, fmt_130, 0 };
    static cilist io___169 = { 0, 6, 0, fmt_140, 0 };
...
/* Subroutine */ int trlprt_(integer *n, doublereal *x, doublereal *y, 
	doublereal *z__, integer *iflag, integer *nrow, integer *nt, integer *
	ltri, integer *lout)
{
    /* Initialized data */
    ...
    static char fmt_108[] = "(///)";
    static char fmt_103[] = "(8x,i4,3e17.6)";
    static char fmt_102[] = "(//16x,\002Node\002,8x,\002Longitude\002,9x,"
	    "\002Latitude\002//)";
    static char fmt_104[] = "(16x,i4,2e17.6)";
    static char fmt_105[] = "(//1x,\002Triangle\002,8x,\002Vertices\002,12x"
	    ",\002Neighbors\002/4x,\002KT\002,7x,\002N1\002,5x,\002N2\002,5x"
	    ",\002N3\002,4x,\002KT1\002,4x,\002KT2\002,4x,\002KT3\002/)";
    static char fmt_106[] = "(//1x,\002Triangle\002,8x,\002Vertices\002,12x"
	    ",\002Neighbors\002,14x,\002Arcs\002/4x,\002KT\002,7x,\002N1\002,"
	    "5x,\002N2\002,5x,\002N3\002,4x,\002KT1\002,4x,\002KT2\002,4x,"
	    "\002KT3\002,4x,\002KA1\002,4x,\002KA2\002,4x,\002KA3\002/)";
    static char fmt_107[] = "(2x,i4,2x,6(3x,i4),3(2x,i5))";
    static char fmt_109[] = "(/1x,\002NB = \002,i4,\002 Boundary Nodes\002,5"
	    "x,\002NA = \002,i5,\002 Arcs\002,5x,\002NT = \002,i5,\002 Triang"
	    "les\002)";
    ...
    /* Fortran I/O blocks */
    static cilist io___335 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___337 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___338 = { 0, 0, 0, fmt_101, 0 };
    static cilist io___340 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___341 = { 0, 0, 0, fmt_103, 0 };
    static cilist io___342 = { 0, 0, 0, fmt_102, 0 };
    static cilist io___343 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___344 = { 0, 0, 0, fmt_104, 0 };
    static cilist io___345 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___346 = { 0, 0, 0, fmt_105, 0 };
    static cilist io___347 = { 0, 0, 0, fmt_106, 0 };
    static cilist io___349 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___350 = { 0, 0, 0, fmt_107, 0 };
    static cilist io___353 = { 0, 0, 0, fmt_109, 0 };
...
/* Subroutine */ int trplot_(integer *lun, doublereal *pltsiz, doublereal *
	elat, doublereal *elon, doublereal *a, integer *n, doublereal *x, 
	doublereal *y, doublereal *z__, integer *list, integer *lptr, integer 
	*lend, char *title, logical *numbr, integer *ier, ftnlen title_len)
{
    /* Initialized data */
    ...
    static char fmt_100[] = "(\002%!PS-Adobe-3.0 EPSF-3.0\002/\002%%Bounding"
	    "Box:\002,4i4/\002%%Title:  Triangulation\002/\002%%Creator:  STR"
	    "IPACK\002/\002%%EndComments\002)";
    ...
    static char fmt_180[] = "(2f12.6,\002 moveto\002,2f12.6,\002 lineto\002)";
    ...
    static doublereal x0, x1, y0, y1, z0, z1, cf, r11, r12, r21, ct, r22, r23,
	     sf;
    ...
    /* Fortran I/O blocks */
    static cilist io___377 = { 1, 0, 0, fmt_100, 0 };
    static cilist io___379 = { 1, 0, 0, fmt_110, 0 };
    static cilist io___380 = { 1, 0, 0, fmt_120, 0 };
    static cilist io___381 = { 1, 0, 0, fmt_130, 0 };
    static cilist io___385 = { 1, 0, 0, fmt_140, 0 };
    static cilist io___386 = { 1, 0, 0, fmt_110, 0 };
    static cilist io___387 = { 1, 0, 0, fmt_150, 0 };
    static cilist io___388 = { 1, 0, 0, fmt_160, 0 };
    static cilist io___389 = { 1, 0, 0, fmt_170, 0 };
    static cilist io___409 = { 1, 0, 0, fmt_180, 0 };
    static cilist io___410 = { 1, 0, 0, fmt_130, 0 };
    static cilist io___411 = { 1, 0, 0, fmt_190, 0 };
    static cilist io___412 = { 1, 0, 0, fmt_200, 0 };
    static cilist io___413 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___414 = { 1, 0, 0, fmt_220, 0 };
    static cilist io___415 = { 1, 0, 0, fmt_200, 0 };
    static cilist io___416 = { 1, 0, 0, fmt_230, 0 };
    static cilist io___417 = { 1, 0, 0, fmt_240, 0 };
    static cilist io___418 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___419 = { 1, 0, 0, fmt_250, 0 };
    static cilist io___420 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___421 = { 1, 0, 0, fmt_260, 0 };
    static cilist io___422 = { 1, 0, 0, fmt_270, 0 };
    static cilist io___423 = { 1, 0, 0, fmt_280, 0 };
...
/* Subroutine */ int trprnt_(integer *n, doublereal *x, doublereal *y, 
	doublereal *z__, integer *iflag, integer *list, integer *lptr, 
	integer *lend, integer *lout)
{
    /* Initialized data */
    ...
    /* Local variables */
    static integer i__, k, na, nb, nd, nl, lp, nn, nt, inc, lpl, lun, node, 
	    nabor[400];

    /* Fortran I/O blocks */
    static cilist io___428 = { 0, 0, 0, fmt_100, 0 };
    static cilist io___429 = { 0, 0, 0, fmt_110, 0 };
    static cilist io___432 = { 0, 0, 0, fmt_101, 0 };
    static cilist io___440 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___441 = { 0, 0, 0, fmt_104, 0 };
    static cilist io___443 = { 0, 0, 0, fmt_107, 0 };
    static cilist io___444 = { 0, 0, 0, fmt_102, 0 };
    static cilist io___445 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___446 = { 0, 0, 0, fmt_105, 0 };
    static cilist io___447 = { 0, 0, 0, fmt_107, 0 };
    static cilist io___448 = { 0, 0, 0, fmt_103, 0 };
    static cilist io___449 = { 0, 0, 0, fmt_108, 0 };
    static cilist io___450 = { 0, 0, 0, fmt_106, 0 };
    static cilist io___451 = { 0, 0, 0, fmt_107, 0 };
    static cilist io___454 = { 0, 0, 0, fmt_109, 0 };
...
/* Subroutine */ int vrplot_(integer *lun, doublereal *pltsiz, doublereal *
	elat, doublereal *elon, doublereal *a, integer *n, doublereal *x, 
	doublereal *y, doublereal *z__, integer *nt, integer *listc, integer *
	lptr, integer *lend, doublereal *xc, doublereal *yc, doublereal *zc, 
	char *title, logical *numbr, integer *ier, ftnlen title_len)
{
    /* Initialized data */
    ...
    /* Format strings */
    static char fmt_100[] = "(\002%!PS-Adobe-3.0 EPSF-3.0\002/\002%%Bounding"
	    "Box:\002,4i4/\002%%Title:  Voronoi diagram\002/\002%%Creator:  S"
	    "TRIPACK\002/\002%%EndComments\002)";
    static char fmt_110[] = "(f12.6,\002 setlinewidth\002)";
    static char fmt_120[] = "(\002306 396 \002,i3,\002 0 360 arc\002)";
    static char fmt_130[] = "(\002stroke\002)";
    static char fmt_140[] = "(2f12.6,\002 translate\002/2f12.6,\002 scale"
    ...
    static doublereal t;
    static integer n0;
    static doublereal x0, x1, x2, y0, y1, y2, z1, z2, cf, r11, r12, r21, ct, 
	    r22, r23, sf;
    static integer ir, lp;
    static doublereal ex, ey, ez, wr, tx, ty;
    ...
    /* Fortran I/O blocks */
    static cilist io___466 = { 1, 0, 0, fmt_100, 0 };
    static cilist io___468 = { 1, 0, 0, fmt_110, 0 };
    static cilist io___469 = { 1, 0, 0, fmt_120, 0 };
    static cilist io___470 = { 1, 0, 0, fmt_130, 0 };
    static cilist io___474 = { 1, 0, 0, fmt_140, 0 };
    static cilist io___475 = { 1, 0, 0, fmt_110, 0 };
    static cilist io___476 = { 1, 0, 0, fmt_150, 0 };
    static cilist io___477 = { 1, 0, 0, fmt_160, 0 };
    static cilist io___478 = { 1, 0, 0, fmt_170, 0 };
    static cilist io___501 = { 1, 0, 0, fmt_180, 0 };
    static cilist io___502 = { 1, 0, 0, fmt_130, 0 };
    static cilist io___503 = { 1, 0, 0, fmt_190, 0 };
    static cilist io___504 = { 1, 0, 0, fmt_200, 0 };
    static cilist io___507 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___508 = { 1, 0, 0, fmt_220, 0 };
    static cilist io___509 = { 1, 0, 0, fmt_200, 0 };
    static cilist io___510 = { 1, 0, 0, fmt_230, 0 };
    static cilist io___511 = { 1, 0, 0, fmt_240, 0 };
    static cilist io___512 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___513 = { 1, 0, 0, fmt_250, 0 };
    static cilist io___514 = { 1, 0, 0, fmt_210, 0 };
    static cilist io___515 = { 1, 0, 0, fmt_260, 0 };
    static cilist io___516 = { 1, 0, 0, fmt_270, 0 };
    static cilist io___517 = { 1, 0, 0, fmt_280, 0 };
...
/* Modules required by VRPLOT:  None */
