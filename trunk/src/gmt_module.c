...
struct Gmt_moduleinfo g_module[] = {
	...
	{"gmtgravmag3d", "potential", "Compute the gravity/magnetic anomaly of a body by the method of Okabe", k_mode_gmt, &GMT_gmtgravmag3d},
	...
	{"grdgravmag3d", "potential", "Computes the gravity effect of one (or two) grids by the method of Okabe", k_mode_gmt, &GMT_grdgravmag3d},
