...
EXTERN_MSC double GMT_in (struct GMT_CTRL *GMT, uint32_t n, double x);
EXTERN_MSC double GMT_k0 (struct GMT_CTRL *GMT, double x);
EXTERN_MSC double GMT_k1 (struct GMT_CTRL *GMT, double x);
EXTERN_MSC double GMT_kn (struct GMT_CTRL *GMT, uint32_t n, double x);
...
EXTERN_MSC double GMT_corrcoeff (struct GMT_CTRL *GMT, double *x, double *y, uint64_t n, uint32_t mode);
EXTERN_MSC double GMT_corrcoeff_f (struct GMT_CTRL *GMT, float *x, float *y, uint64_t n, uint32_t mode);
...
EXTERN_MSC int GMT_mode (struct GMT_CTRL *GMT, double *x, uint64_t n, uint64_t j, bool sort, uint32_t mode_selection, uint32_t *n_multiples, double *mode_est);
EXTERN_MSC int GMT_mode_f (struct GMT_CTRL *GMT, float *x, uint64_t n, uint64_t j, bool sort, uint32_t mode_selection, uint32_t *n_multiples, double *mode_est);
...
EXTERN_MSC void GMT_PvQv (struct GMT_CTRL *GMT, double x, double v_ri[], double pq[], uint32_t *iter);
