/*--------------------------------------------------------------------
 *	$Id: gmt_stat.h,v 1.9 2008-03-22 11:55:35 guru Exp $
 *
...
EXTERN_MSC double GMT_corrcoeff (double *x, double *y, size_t n, GMT_LONG mode);
EXTERN_MSC double GMT_corrcoeff_f (float *x, float *y, size_t n, GMT_LONG mode);
EXTERN_MSC double GMT_Fcrit (double alpha, double nu1, double nu2);
EXTERN_MSC double GMT_chi2crit (double alpha, double nu);
EXTERN_MSC double GMT_extreme (double x[], size_t n, double x_default, GMT_LONG kind, GMT_LONG way);
...
EXTERN_MSC GMT_LONG GMT_median (double *x, size_t n, double xmin, double xmax, double m_initial, double *med);
EXTERN_MSC GMT_LONG GMT_mode (double *x, size_t n, size_t j, GMT_LONG sort, GMT_LONG mode_selection, GMT_LONG *n_multiples, double *mode_est);
EXTERN_MSC GMT_LONG GMT_mode_f (float *x, size_t n, size_t j, GMT_LONG sort, GMT_LONG mode_selection, GMT_LONG *n_multiples, double *mode_est);
