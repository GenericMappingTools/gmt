/* MGD-77 Data Record Field Defaults:
		...
		{ "Bathy Two-Way Travel-Time",       "twt",        46,	   6,       "real",    10000,      "%06d",      12,       "%06d",     "%7.4f",      "999999" },
		{ "Bathy Corrected Depth",         "depth",        52,	   6,       "real",       10,      "%06d",      13,       "%06d",     "%7.1f",      "999999" },
		{ "Bathy Correction Code",           "bcc",        58,	   2,        "int",        1,      "%02d",      14,       "%02d",        NULL,          "99" },
		{ "Bathy Type Code",                 "btc",        60,	   1,        "int",        1,       "%1d",      15,        "%1d",        NULL,           "9" },
		{ "Mag First Sensor Total Field",   "mtf1",        61,	   6,       "real",       10,      "%06d",      16,       "%06d",     "%7.1f",      "999999" },
		{ "Mag Second Sensor Total Field",  "mtf2",        67,	   6,       "real",       10,      "%06d",      17,       "%06d",     "%7.1f",      "999999" },
		{ "Mag Residual Field", 	     "mag",        73,	   6,       "real",       10,      "%06d",      18,      "%+06d",     "%7.1f",      "+99999" },
		{ "Mag Sensor For Residual Field", "msens",        79,	   1,        "int",        1,       "%1d",      19,        "%1d",        NULL,           "9" },
		{ "Mag Diurnal Correction",         "diur",        80,	   5,       "real",       10,      "%05d",      20,      "%+05d",     "%6.1f",       "+9999" },
		{ "Mag Sensor Depth or Altitude",    "msd",        85,	   6,        "int",        1,      "%06d",      21,      "%+06d",       "%7d",      "+99999" },
		{ "Grav Observed",                  "gobs",        91,	   7,       "real",       10,      "%07d",      22,       "%07d",     "%8.1f",     "9999999" },
		{ "Grav Eotvos Correction",          "eot",        98,	   6,       "real",       10,      "%06d",      23,      "%+06d",     "%7.1f",      "+99999" },
		{ "Grav Free-Air Anomaly",           "faa",       104,	   5,       "real",       10,      "%05d",      24,      "%+05d",     "%6.1f",       "+9999" },
