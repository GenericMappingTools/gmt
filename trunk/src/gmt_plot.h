/*--------------------------------------------------------------------
 *	$Id: gmt_plot.h,v 1.13 2008-03-22 11:55:35 guru Exp $
 *
...
EXTERN_MSC void GMT_grid_clip_on (struct GRD_HEADER *h, GMT_LONG rgb[], GMT_LONG flag);
...
EXTERN_MSC void GMT_map_clip_on (GMT_LONG rgb[], GMT_LONG flag);
EXTERN_MSC void GMT_plot_line (double *x, double *y, GMT_LONG *pen, GMT_LONG n);
...
EXTERN_MSC void GMT_textbox3D (double x, double y, double z, double size, GMT_LONG font, char *label, double angle, GMT_LONG just, BOOLEAN outline, double dx, double dy, GMT_LONG rgb[]);
