...
\emph{stderr}. Even more verbose levels are \Opt{Vl} (long verbose) and \Opt{Vd}
(debug). Normal verbosity level produces only fatal error messages. This is the default
