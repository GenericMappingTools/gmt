%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.30 2004-01-03 23:03:30 pwessel Exp $
%
...
axis items {\bf a}, {\bf f}, and {\bf g} apply.  The annotations will be formatted according to
...
may want to tick and annotate the axis.  Not only do we have both upper and lower annotation
...
in the 0--360, 0--1, 0--1 range; to use this color system you must set {\bf COLOR\_MODEL} to HSV), or CMYK color ({\it cyan}/{\it magenta}/{\it yellow}/{\it black},
