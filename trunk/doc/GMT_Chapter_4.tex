%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.87 2006-10-30 02:59:36 remko Exp $
%
...
additional lower case specifier. For example, use \GMTprog{pscoast} \Opt{G}Cyan, instead of \Opt{G}cyan, to avoid
accidentally switching on the clip option \Opt{Gc}.
\end{enumerate}
