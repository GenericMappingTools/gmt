%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.146 2011-05-22 22:14:05 guru Exp $
%
...
A search radius of 50 statute miles using this mode of computation might be \Opt{S-}50\textbf{M}.
...
is required.  For instance, a search radius of 5000 feet using this mode of computation would be \Opt{S}5000\textbf{f}.
...
the specified distance (or to the unit itself in cases where no distance is required).
For instance, a search radius of 20 km using this mode of computation would be \Opt{S+}20\textbf{k}.
...
or m\textbf{e}ter [Default], \textbf{f}eet, \textbf{k}ilometer, \textbf{M}iles, and \textbf{n}autical miles.
...
termination of a solid line or at the end of all dashed line segments making up a line.
See the \GMTprog{gmt.conf} man page for more information.
\begin{table}[h]
\centering
\begin{tabular}{|l|l|} \hline
