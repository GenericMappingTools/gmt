%------------------------------------------
%	$Id: GMT_Chapter_4.tex,v 1.60 2005-09-12 03:42:57 pwessel Exp $
%
...
of the colorscale when plotted using \GMTprog{psscale}.  The optional {\bf A} may be {\bf L},
...
\begin{enumerate}
\item To write a binary float grd file, specify the name as \filename{my\_file.grd=bf}.
