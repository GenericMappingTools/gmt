%-----------------------------------------
%	$Id: GMT_Appendix_A.tex,v 1.24 2007-01-30 20:37:07 pwessel Exp $
%
...
\GMTprog{mgd77manage}, \GMTprog{mgd77path}, \GMTprog{mgd77sniffer}, and \GMTprog{mgd77track} which can be
...
polygons, \GMTprog{ps2raster} which simplifies the rasterization of \GMT
\PS\ to raster formats, and \GMTprog{nc2xy} which can extract data from netCDF files.
The package is maintained by Paul Wessel.
...
Newly added are the tools \GMTprog{x2sys\_init},  \GMTprog{x2sys\_binlist}, \GMTprog{x2sys\_put},
