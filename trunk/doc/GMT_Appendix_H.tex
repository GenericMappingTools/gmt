%------------------------------------------
%	$Id: GMT_Appendix_H.tex,v 1.24 2011-06-06 18:27:19 guru Exp $
%
...
file, which is supplied with 1200 when you get \GMT\ from us.
This seems a good size for most applications and should ideally
exceed the resolution of your hardcopy device (most laserwriters
have at least 600 dpi, hence our default value).  \GMT\ computes what the
...
of 1200 dpi or so.  Beware of making an excessively large path.
Note that if you change dpi the line widths produced by your
\Opt{W} options will change, unless you have appended \textbf{p}
for line width in points.
