%------------------------------------------
%       $Id: GMT_Tutorial.tex,v 1.37 2006-10-23 18:56:29 remko Exp $
%
...
or using color names found in the file rgb.txt on your system:
...
grdcontour ship.grd -J -O -K -C250 -A1000 >> map.ps
psmask -C -O >> map.ps
\end{verbatim}
