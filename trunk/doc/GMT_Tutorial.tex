%------------------------------------------
%       $Id: GMT_Tutorial.tex,v 1.71 2010-12-01 00:46:59 guru Exp $
%
...
3.3.1--6), 3.4, 3.4.1--5, and 4.0--4.5.3 were released between November 1998 and
July 2010, culminating in the \GMTDOCDATE\ introduction of \GMTDOCVERSION.
...
there with ``\texttt{cp -r \$GMTHOME/share/doc/gmt/tutorial/* .} ''.
