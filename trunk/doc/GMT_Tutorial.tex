%------------------------------------------
%       $Id: GMT_Tutorial.tex,v 1.40 2006-10-25 04:25:29 pwessel Exp $
%
...
%  boolmarksopenlevel=3, urlbordercolor={1 0 0}]{hyperref}
  \usepackage[pdftex,linkcolor={0 0 1}]{hyperref}
  \pdfcompresslevel=9
  \DeclareGraphicsExtensions{.pdf}

 \hypersetup{%
    pdftitle={The Generic Mapping Tools Version 4---A Map-making Tutorial},
...
to use the \filename{.nc} for NetCDF grids. Using that extension will help
...
\htmladdnormallinkfoot{NetCDF website}{http://www.unidata.ucar.edu/software/netcdf/software.html}
...
We will need to make an appropriate color scale, running from -2$^\circ$C (freezing temperature of salt
water) to 30$^\circ$C (highest likely ocean temperature). We do this as follows:
...
The addition \filename{?otemp[2,0]} indicates which variable to retreive from the NetCDF
