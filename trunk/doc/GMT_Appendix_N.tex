%------------------------------------------
%	$Id: GMT_Appendix_N.tex,v 1.9 2011-05-18 22:23:49 remko Exp $
%
...
\begin{quote}
	\textbf{N}: \emph{n\_extra\_parameters}
\end{quote}
...
\end{table} 
For \textbf{M}, \textbf{T}, and all the lower-case codes you may optionally append specific pens (with \Opt{W}\emph{pen})
