%------------------------------------------
%	$Id: GMT_Appendix_I.tex,v 1.20 2008-03-13 17:26:31 remko Exp $
%
...
(\textbf{HSV\_MAX\_SATURATION}, \textbf{HSV\_MAX\_VALUE}) if the illumination is positive positive (illuminated).
