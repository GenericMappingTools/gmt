%------------------------------------------
%	$Id: GMT_Chapter_7.tex,v 1.17 2004-05-26 22:59:16 pwessel Exp $
%
...
we specify that contour labels opnly be placed along the great-circle arc connecting
Rome to its antipode, and request curved text that follows the contours.
...
interesting the path from Seattle appears in this particular projection (Hammer).
