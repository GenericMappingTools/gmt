%------------------------------------------
%	$Id: GMT_Chapter_7.tex,v 1.12 2004-04-23 23:24:07 pwessel Exp $
%
...
\section{New Example 1}
\index{Example!New 1|(}

Here goes the description of this example.

\input{scripts/GMT_example_21} 
\GMTfig[ht]{GMT_example_21}{New Example 21.}

\index{Example!New 1|)}

\section{New Example 2}
\index{Example!New 2|(}

Here goes the description of this example.

\input{scripts/GMT_example_22} 
\GMTfig[ht]{GMT_example_22}{New Example 22.}

\index{Example!New 2|)}

\section{New Example 3}
\index{Example!New 3|(}

Here goes the description of this example.

\input{scripts/GMT_example_23} 
\GMTfig[ht]{GMT_example_23}{New Example 23.}

\index{Example!New 3|)}s

\section{New Example 4}
\index{Example!New 4|(}

Here goes the description of this example.

\input{scripts/GMT_example_24} 
\GMTfig[ht]{GMT_example_24}{New Example 24.}

\index{Example!New 4|)}s

\section{New Example 5}
\index{Example!New 5|(}

Here goes the description of this example.

\input{scripts/GMT_example_25} 
\GMTfig[ht]{GMT_example_25}{New Example 25.}

\index{Example!New 5|)}s
