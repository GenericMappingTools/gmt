%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.127 2009-09-10 04:11:13 guru Exp $
%
...
\begin{description}
	\item [\GMTprog{configure.ac}]:	Now use --enable-flock to enable file locking, instead of
		...
		Switch -DGMT\_QSORT on only for OSX prior to Snow Leopard as the latter now has
		a correctly working qsort function under 64-bit.
