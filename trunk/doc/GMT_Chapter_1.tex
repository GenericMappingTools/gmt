%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.113 2009-04-22 16:56:21 guru Exp $
%
...
A major new enhancement is the global option \Opt{g}, which is used to determine if excessive spacing (``gaps'')
between data points (gaps can be defined in a variety of ways) should be used to segment an otherwise continuous
