%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.93 2008-05-14 19:54:48 guru Exp $
%
...
\item [\GMTprog{grd2xyz.c}]: For option \Opt{E}, the test for {\it xinc} == {dy}\it yinc} was susceptible to round-off.
...
\begin{enumerate}
\item \GMTprog{gmt\_init.c} was enhanced so that the media size Custom_WxH can use W and H in inch, cm, or m
