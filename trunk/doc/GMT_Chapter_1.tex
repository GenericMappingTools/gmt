%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.61 2007-03-28 03:02:12 pwessel Exp $
%
...
in the coastline database.  Additionally, a few enhancements have been made to these programs:
...
\Opt{C} need to check for``.cpt'' at END of file name.  Fixed contour label angles were always ignored.
