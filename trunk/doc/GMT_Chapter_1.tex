%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.96 2008-12-08 02:22:00 guru Exp $
%
...
\item \GMTprog{ps2raster.c} now will scan for the optional comment \verb+%%HiResBoundingBox+
	...
	images.  Finally, added \Opt{C}{\it gs-command} to pass one or more
	custom switches directly to \progname{ghostscript}, and \Opt{Q}[{\bf g}$|${\bf t}]{\it bits} to
	set the level of anti-aliasing for graphics and text, respectively.
