%------------------------------------------
%	$Id: GMT_Chapter_1.tex,v 1.125 2009-07-10 20:31:55 remko Exp $
%
...
\begin{description}
	...
	\item [\GMTprog{psscale.c}]: When using \Opt{A} with a vertical color bar, the annotations where left-
		in stead of right-aligned.  When using -A on horizontal bar, the last tick mark would not appear. 
