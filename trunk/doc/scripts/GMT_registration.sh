...
psxy -R0/3/0/3 -JX2.5i/1.25i -B1g1 -Bwesn -P -K -Wthinner -L -Glightred << EOF > GMT_registration.ps
0.5	1.5
1.5	1.5
1.5	2.5
0.5	2.5
...
# Pixel registration
psxy -R0/3/0/3 -JX2.5i/1.25i -B1g1 -Bwesn -O -K -W0p -L -Glightred -X2.75i << EOF >> GMT_registration.ps
1	1
2	1
2	2
1	2
