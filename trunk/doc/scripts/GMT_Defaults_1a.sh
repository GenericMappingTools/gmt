#!/bin/sh
#	$Id: GMT_Defaults_1a.sh,v 1.4 2003-01-13 16:58:35 pwessel Exp $
#
gmtset BASEMAP_TYPE fancy PLOT_DEGREE_FORMAT ddd:mm:ssF GRID_CROSS_SIZE 0.1i ANOT_FONT_SIZE +8p CHAR_ENCODING ISOLatin1+
