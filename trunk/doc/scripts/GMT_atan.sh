#!/bin/sh
#	$Id: GMT_atan.sh,v 1.2 2004-04-10 17:19:14 pwessel Exp $
#

grdgradient -A45 ../../tutorial/us.grd -N -M -Gt.grd
grd2xyz -Z t.grd > $$
pshistogram $$ -R-0.75/0.75/0/20 -JX1.5/1 -B0.5/5f5WSne -W0.01 -P -K -Gblack -Z1 > GMT_atan.ps
...
psxy -R -JX -O -K -Sv0.004/0.03/0.02 -Gblack << EOF >> GMT_atan.ps
3	0.8	180	0.45
3	0.8	-90	0.4
EOF
...
grd2xyz -Z tt.grd > $$
pshistogram $$ -R-0.75/0.75/0/5 -JX1.5/1 -B0.5/2f1WSne -W0.01 -O  -K -Gblack -X1.85 -Z1 >> GMT_atan.ps
