REM		GMT EXAMPLE 06
REM
REM		$Id: job06.bat,v 1.4 2004-09-29 01:29:02 pwessel Exp $
REM
...
pshistogram -Ba2000f1000:"Topography (m)":/a10f5:"Frequency"::,%::."Two types of histograms":WSne v3206.t -R-6000/0/0/30 -JX4.8i/2.4i -Ggray -O -Y5.5i -X-0.5i -L0.5p -Z1 -W250 >> example_06.ps
del .gmt*
if %master%==y cd ..
