REM		GMT EXAMPLE 18
REM
REM		$Id: job18.bat,v 1.2 2003-12-18 02:27:21 pwessel Exp $
REM
...
psxy tmp -R -J -O -K -SC0.04i -G255/0/0 -W0.25p >> example_18.ps
...
psxy -R -J -A -O -K -L -W0.75p -G255 tmp >> example_18.ps
