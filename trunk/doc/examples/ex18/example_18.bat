...
gmt psscale -D2.75i/-0.4i/4i/0.15ih -Cgrav.cpt -B20f10/:mGal: -O -K >> %ps%
...
gmt grdcontour AK_gulf_grav.nc -J -C20 -B2f1WSEn -O -K -Y-4.85i -UL/-1.25i/-0.75i/"Example 18 in Cookbook" >> %ps%
