...
#		GMT EXAMPLE 07
#
#		$Id: job07.sh,v 1.5 2003-12-18 02:27:21 pwessel Exp $
#
...
$AWK '{print $1-360.0, $2, $3*0.01}' quakes.xym | psxy -R -J -O -K -H1 -Sci -G255 -W0.25p >> example_07.ps
psxy -R -J -O -K -M isochron.xy -W0.75p >> example_07.ps
psxy -R -J -O -K -M ridge.xy -W1.75p >> example_07.ps
psxy -R -J -O -K -G255 -W1p -A << END >> example_07.ps
-14.5	15.2
 -2	15.2
 -2	17.8
-14.5	17.8
END
psxy -R -J -O -K -G255 -W0.5p -A << END >> example_07.ps
-14.35	15.35
 -2.15	15.35
 -2.15	17.65
-14.35	17.65
...
pstext -R -J -O -S0.75p -G255 << END >> example_07.ps
