REM		GMT EXAMPLE 05
REM
REM		$Id: job05.bat,v 1.10 2011-06-09 04:12:31 guru Exp $
REM
...
echo 4.1 5.5 z(r) = cos (2@~p@~r/8) @~\327@~e@+-r/10@+ | pstext -R0/11/0/8.5 -Jx1i -F+f50p,ZapfChancery-MediumItalic+jBC -O >> %ps%
del gray.cpt
del *.nc
del .gmt*
