REM             GMT EXAMPLE 29
REM             $Id: job29.bat,v 1.7 2011-03-15 02:06:31 guru Exp $
REM
...
grdimage mars2.nc -Imars2_i.nc -Cmars.cpt -B30g30Wsne -JH0/6i -P -K -Ei -U"Example 29 in Cookbook" --FONT_ANNOT_PRIMARY=12p > %ps%
