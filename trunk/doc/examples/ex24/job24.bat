...
REM             GMT EXAMPLE 24
REM
REM             $Id: job24.bat,v 1.7 2004-09-29 05:18:46 pwessel Exp $
REM
...
gmtselect oz_quakes.d -L1000/dateline.d -M# -Nk/s -C3000/point.d -fg -R -J -Il | psxy -R -JM -O -K -Sc0.05i -Ggreen >> example_24.ps
echo {print $1, $2, 0, $3, $3} > awk.txt
