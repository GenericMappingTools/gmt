#!/bin/sh
#
#	GMT Example 01  $Id: job01.sh,v 1.6 2004-01-10 02:34:54 pwessel Exp $
#
...
grdcontour -R osu91a1f_16.grd -J -C10 -A50f7 -G4i -L-1000/-1 -Wc0.25pta -Wa0.75pt2_2:0 -O -K -T0.1i/0.02i >> example_01.ps
...
grdcontour osu91a1f_16.grd -J -C10 -A50f7 -G4i -L-1000/-1 -Wc0.25pta -Wa0.75pt2_2:0 -O -K -T0.1i/0.02i:-+ >> example_01.ps
