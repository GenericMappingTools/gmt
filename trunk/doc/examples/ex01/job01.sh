...
grdcontour -R osu91a1f_16.grd -J -C10 -A50+s7 -Gd4i -L-1000/-1 -Wc0.25p,- -Wa0.75p,- -O -K -T0.1i/0.02i >> example_01.ps
...
grdcontour osu91a1f_16.grd -J -C10 -A50+s7 -Gd4i -L-1000/-1 -Wc0.25p,- -Wa0.75p,- -O -K -T0.1i/0.02i:-+ >> example_01.ps
