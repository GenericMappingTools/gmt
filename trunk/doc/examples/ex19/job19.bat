REM		GMT EXAMPLE 19
REM
REM		$Id: job19.bat,v 1.8 2006-04-13 01:44:31 pwessel Exp $
REM
...
echo 0 -30 18 0 1 CM Honolulu, Hawaii, April 1, 2007 | pstext -R -J -O -K -Ggreen -S0.25p >> example_19.ps
...
echo 0 20 32 0 1 CM 5TH INTERNATIONAL | pstext -R -J -O -K -Gred -S0.5p >> example_19.ps
echo 0 -10 32 0 1 CM GMT CONFERENCE | pstext -R -J -O -K -Gred -S0.5p >> example_19.ps
echo 0 -30 18 0 1 CM Honolulu, Hawaii, April 1, 2007 | pstext -R -J -O -Ggreen -S0.25p >> example_19.ps
