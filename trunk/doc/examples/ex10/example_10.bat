...
gawk -f awk.txt languages.txt | gmt pstext -R -J -O -K -p -Gwhite@30 -D-0.2i/0 -F+f30p,Helvetica-Bold,firebrick=thinner+jRM >> %ps%
...
gmt pslegend -R -J -JZ -D-170/-80/1.2i/0/BL -O --FONT=Helvetica-Bold -F+glightgrey+pthinner+s-4p/-6p/grey20@40 -p legend.txt >> %ps%
del awk.txt .gmt*
