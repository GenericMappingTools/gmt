REM		GMT EXAMPLE 10
REM
REM		$Id: job10.bat,v 1.4 2004-04-10 17:19:14 pwessel Exp $
REM
...
gawk "{print $1-10, $2, 20, 0, 0, 7, $3}" agu.d | pstext -R-180/180/-90/90 -J -O -K -E200/40 -Gwhite -S0.5p >> example_10.ps
