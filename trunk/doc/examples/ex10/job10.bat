REM		GMT EXAMPLE 10
REM
REM		$Id: job10.bat,v 1.7 2006-10-22 14:26:49 remko Exp $
REM
...
psxyz agu.d -R-180/180/-90/90/1/100000 -J -JZ2.5il -So0.3ib1 -Ggray -Wthinner -B60g60/30g30/a1p:Memberships:WSneZ -O -K -E200/40 >> example_10.ps
gawk "{print $1-10, $2, 20, 0, 0, 7, $3}" agu.d | pstext -Rd -J -O -K -E200/40 -Gwhite -Sthinner >> example_10.ps
