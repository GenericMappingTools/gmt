REM		GMT EXAMPLE 10
REM
REM		$Id: job10.bat,v 1.11 2011-03-15 02:06:31 guru Exp $
REM
...
psxyz agu2008.d -R-180/180/-90/90/1/100000 -J -JZ2.5il -So0.3ib1 -Ggray -Wthinner -B60g60/30g30/a1p:Memberships:WSneZ -O -K -p200/40 >> %ps%
