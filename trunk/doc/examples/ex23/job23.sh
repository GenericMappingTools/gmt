#!/bin/sh
#
#	GMT Example 23  $Id: job23.sh,v 1.6 2004-06-02 22:52:32 pwessel Exp $
#
...
grdcontour dist.grd -A1000+T+ukm+kwhite -Glz-/z+ -S8 -C500 -O -K -J -Wathin,white -Wcthinnest,white,- >> example_23.ps
