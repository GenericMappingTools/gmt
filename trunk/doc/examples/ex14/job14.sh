...
#		GMT EXAMPLE 14
#
#		$Id: job14.sh,v 1.7 2004-01-08 06:05:47 pwessel Exp $
#
...
psxy -R -J -B2f1eSNw mean.xyz -Ss0.05i -G0 -O -K >> example_14.ps
...
psxy -R -J mean.xyz -Ss0.05i -G0 -O -K >> example_14.ps
