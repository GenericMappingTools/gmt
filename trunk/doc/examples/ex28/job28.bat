REM		GMT EXAMPLE 28
REM		$Id: job28.bat,v 1.1 2008-06-12 22:06:19 guru Exp $
REM
...
pscoast -R%LL%/%UR%r -Ju5Q/1:170000 -O -K -Df -Slightblue -W0.5p -B5mg5mNE --PLOT_DEGREE_FORMAT=ddd:mmF -Lf155:07:30W/19:15:40N/19:23N/5k --ANNOT_FONT_SIZE=10 --LABEL_FONT_SIZE=12 >> example_28.ps
