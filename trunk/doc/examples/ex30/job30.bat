REM             GMT EXAMPLE 30
REM             $Id: job30.bat,v 1.1 2010-01-05 03:49:47 guru Exp $
REM
...
psbasemap -R0/360/-1.25/1.75 -JX8i/6i -B90f30:,-\\232:/1g10:."Two Trigonometric Functions":WS -K -U"Example 30 in Cookbook" --BASEMAP_TYPE=graph --VECTOR_SHAPE=0.5 > %ps%
...
echo 120 -1.25 14 0 4 LB 120\\232 >> tmp
...
echo -0.33333 0.6 12 30 4 LB 120\\232 >> tmp
