REM		$Id: job11.bat,v 1.10 2007-05-14 21:35:33 remko Exp $
REM		GMT EXAMPLE 11
REM
...
psxy cut-here.dat -Wthinnest,. -M -R-51/306/0/1071 -JX3.5i/10.5i -X2.5i -Y0.5i -P -U/-2.0i/-0.2i/"Example 11 in Cookbook" -K > example_11.ps
