%------------------------------------------
%	$Id: GMT_Chapter_6.tex,v 1.10 2004-07-14 00:46:17 pwessel Exp $
%
...
to set either the \emph{smallest} or \emph{largest} map dimension.  Users may achieve
this by appending a character code to their map widths.  To specify map \emph{height},
append {\bf h}; to select the minimum map dimension, append {\bf -}, whereas you may
