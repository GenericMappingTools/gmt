%------------------------------------------
%	$Id: GMT_Chapter_3.tex,v 1.49 2011-05-01 21:17:59 guru Exp $
%
...
\Opt{n}[\emph{type}][{\bf +a}][{\bf b}{\it BC}][{\bf +t}{\it threshold}] 		&	Set grid interpolation mode \\ \hline
\Opt{p}\emph{azim/elev}[/\emph{zlevel}][{\bf +w}\emph{lon0/lat0}[/\emph{z0}]][{\bf +v}\emph{x0/y0}]	&	Control 3-D perspective view \\ \hline
