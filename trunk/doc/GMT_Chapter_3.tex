%------------------------------------------
%	$Id: GMT_Chapter_3.tex,v 1.50 2011-05-18 22:23:49 remko Exp $
%
...
\begin{tabular}{|ll|}
\multicolumn{2}{c}\textbf{STANDARDIZED COMMAND LINE OPTIONS #1} \\ \hline
...
\multicolumn{2}{|l|}{~[\textbf{t}]\emph{stride}[\emph{phase}][\textbf{u}][\textbf{l}$|$\textbf{p}][:"label":][:="prefix":][:,"unit":], where \textbf{l} and \textbf{p} apply to $\log_{10}$ axes only,} \\
