%------------------------------------------
%	$Id: GMT_Appendix_K.tex,v 1.14 2006-10-29 09:41:17 pwessel Exp $
%
...
call \progname{getbox.sh}:

\input{scripts/getbox} 
...
script \progname{getrect.sh}:

\input{scripts/getrect} 
