%------------------------------------------
%	$Id: GMT_Appendix_O.tex,v 1.5 2004-06-13 20:51:22 pwessel Exp $
%
...
\item [f:] Full syntax is {\bf f}{\it fix.d}[/{\it slop}].  Here, an ASCII file {\it fix.d} is
...
\GMTfig[H]{GMT_App_O_8}{Tsunami travel times from the Canary Islands to places
