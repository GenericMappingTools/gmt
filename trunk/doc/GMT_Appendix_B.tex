%------------------------------------------
%       $Id: GMT_Appendix_B.tex,v 1.15 2005-12-17 05:59:21 pwessel Exp $
%
...
By default, \GMT\ stores 2-D grids as COARD-compliant netCDF files.
...
\subsection{Generic grid files}
\index{grdfile!old style generic}

The old style generic grid file format that was common in earlier version of \GMT\ is still
