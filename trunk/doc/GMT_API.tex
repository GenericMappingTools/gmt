...
\index{Initialize and allocate resources}
\index{Resources!Initialize}
\index{Resources!Allocate}
...
%% Eliminate this duplication of constants; just refer to the table in the next section
\begin{description}
...
\end{tabular}
\caption{Modes used to determine status of current data record.  The \texttt{GMT\_IO\_GAP} mode depends on the current \Opt{g} settings.}
\label{tbl:iostatus}
\index{Record!Status}
\end{table}
