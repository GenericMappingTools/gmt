...
GMT\_VIA\_VECTOR	&	100	&       The user's data columns are addressed via a GMT\_VECTOR structure \\ \hline
...
\begin{verbatim}
int GMT_Begin_IO (void *API, unsigned int family, \
...
code of, say, \filename{blockmean.c} or \filename{pstext.c}.
