%------------------------------------------
%	$Id: GMT_Appendix_P.tex,v 1.19 2011-03-15 02:06:29 guru Exp $
%
...
two \GMT\ scripts simultaneously in the same directory, since those \filename{.gmtcommand4}
files may clash (contain different histories) and adversely affect the results of both scripts.
\item[\filename{.gmt\_bb\_info}.] This file contains the information about the
