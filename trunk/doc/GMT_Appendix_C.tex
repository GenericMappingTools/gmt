%------------------------------------------
%	$Id: GMT_Appendix_C.tex,v 1.2 2002-01-17 22:57:17 pwessel Exp $
%
...
the PAPER\_MEDIA parameter (see the \GMTprog{gmtdefaults} man
...
\progname{Freehand}, and Coral \progname{Draw} will allow you
...
as Microsoft \progname{Word} and Coral \progname{WordPerfect})
will let you include
a \PS\ file that you may place but not edit.  You won'’t
...
\htmladdnormallink{gmthelp@soest.hawaii.edu}{mailto:gmthelp@soest.hawaii.edu}.
