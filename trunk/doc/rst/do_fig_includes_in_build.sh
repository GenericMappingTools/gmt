...
path_build=${BIN_DIR}/_source/_images/ # Path to where ps2raster dumps the converted PNGs
...
#gmt ps2raster ${SRC_DIR}/../scripts/${name}.ps $com
echo ".. figure:: /_images/${name}.*" > ${pato}/fig_${name}.rst_
...
if [ "$ext" = "pdf" ]; then
	#gmt ps2raster ${SRC_DIR}/../examples/ex$1/example_$1.ps $comPDF
	echo ".. figure:: /_images/${name}.*" > ${pato}/fig_${name}.rst_
else
	#gmt ps2raster ${SRC_DIR}/../examples/ex$1/example_$1.ps $com
	echo ".. figure:: /_images/${name}.*" > ${pathGallery}/fig_${name}.rst_
	echo "   :width: 500 px" >> ${pathGallery}/fig_${name}.rst_
	echo "   :align: center" >> ${pathGallery}/fig_${name}.rst_
	echo "" >> ${pathGallery}/fig_${name}.rst_

	echo ".. |ex$1| image:: /_images/${name}.*" > ${pathGallery}/img_${name}.rst_
...
if [ "$ext" = "pdf" ]; then
	#gmt ps2raster ${SRC_DIR}/../examples/anim$1/anim_$1.ps $comPDF
	echo ".. figure:: /_images/${name}.*" > ${pato}/fig_${name}.rst_
else
	#gmt ps2raster ${SRC_DIR}/../examples/anim$1/anim_$1.ps $com
	echo ".. figure:: /_images/${name}.*" > ${pathGallery}/fig_${name}.rst_
	echo "   :width: 400 px" >> ${pathGallery}/fig_${name}.rst_
	echo "   :align: center" >> ${pathGallery}/fig_${name}.rst_
	echo "" >> ${pathGallery}/fig_${name}.rst_

	echo ".. |anim$1| image:: /_images/${name}.*" > ${pathGallery}/img_${name}.rst_
	echo "   :width: 150 px" >> ${pathGallery}/img_${name}.rst_
fi
}

function from_fig {
W=`gmt grdinfo -C ${SRC_DIR}/../fig/${name} | awk '{print $3}'`
H=`gmt grdinfo -C ${SRC_DIR}/../fig/${name} | awk '{print $5}'`
echo ".. figure:: /_images/${name}" > ${pato}/fig_${name}.rst_
