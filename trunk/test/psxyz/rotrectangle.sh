...
-80 25 0 70 500 300
EOF
psxyz -JZ2 -p135/30 -R270/20/305/25/0/3r -JOc280/25.5/22/69/5i -P -B10g5WSne -SJ tt.rects.d -Gred -W0.25p,green -K > $ps
...
-80 25 0 90 0.5 0.2
EOF
psxyz -JZ -p135/30 -R -J -O -K -B10g5WSne -Sji tt.rects.d -Gblue -W0.25p,green -Y3i >> $ps
psxyz -JZ -p135/30 -R -J -O -K -Sc0.05i tt.rects.d -Gblack >> $ps
