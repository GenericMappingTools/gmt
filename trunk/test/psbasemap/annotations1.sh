...
$psbasemap -R-25/25/-19/23 -B10WSne -P -K --PLOT_DEGREE_FORMAT=dddF -Xa1i -Ya1i > $ps
$psbasemap -R-1.5/1.5/-1.2/1.5 -B0.5wSnE -O -K  --PLOT_DEGREE_FORMAT=ddd.xF -Xa4.5i -Ya1i >> $ps
$psbasemap -R-1.05/1.05/-1.1/1.3 -B30mWSne -O -K --PLOT_DEGREE_FORMAT=ddd:mmF -Xa1i -Ya4.25i >> $ps
$psbasemap -R-0:00:50/0:01:00/-0:01:00/0:01:00 -B0.5mwSnE -O -K  --PLOT_DEGREE_FORMAT=ddd:mm.xF -Xa4.5i -Ya4.25i >> $ps
