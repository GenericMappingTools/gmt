...
grd2xyz tmp.nc | psxy -R$Rp -JX3.25i -Sc0.15c -W0.25p -Ct.cpt -P -K -B10f5 -BWSne -Xc -Y0.5i > $ps
psscale -D4i/4.75i/6i/0.15i -O -K -Ct.cpt -E+n >> $ps
# Set values higher than 7 to NaN and values lower than 0 to -6
grdclip tmp.nc -Sa7/NaN -Sb0/-6 -Gout.nc
grd2xyz out.nc | psxy -R$Rp -J -Sc0.15c -W0.25p -Ct.cpt -O -K -B10f5 -BWsne -Y3.5i >> $ps
# Set values between 0 and 5 to NaN
grdclip tmp.nc -Si0/5/NaN -Gout.nc
grd2xyz out.nc | psxy -R$Rp -J -Sc0.15c -W0.25p -Ct.cpt -O -K -B10f5 -BWsne -Y3.5i >> $ps
psxy -R$Rp -J -T -O >> $ps
