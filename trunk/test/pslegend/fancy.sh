...
pslegend -R -J -O -K -Dx0.25i/9.75i/2.75i/2.0i/TL -C0.1i/0.1i -Gwhite -L1.2 -F $$.txt >> $ps
pslegend -R -J -O -K -Dx6.25i/9.75i/2.75i/2.0i/TR -C0.1i/0.1i -Gwhite -L1.2 -F+r $$.txt >> $ps
pslegend -R -J -O -K -Dx0.25i/7.25i/2.75i/2.0i/TL -C0.1i/0.1i -Gwhite -L1.2 -F+p2p+i0.5p $$.txt >> $ps
pslegend -R -J -O -K -Dx6.25i/7.25i/2.75i/2.0i/TR -C0.1i/0.1i -Gwhite -L1.2 -F+p2p+i0.5p+s5p/-3p/gray $$.txt >> $ps
pslegend -R -J -O -K -Dx0.25i/4.75i/2.75i/2.0i/TL -C0.1i/0.1i -Gwhite -L1.2 -F+p2p,blue+i0.5p,blue $$.txt >> $ps
pslegend -R -J -O -K -Dx6.25i/4.75i/2.75i/2.0i/TR -C0.1i/0.1i -Gwhite -L1.2 -F+p2p,blue+i0.5p,blue+s5p/-3p/navy $$.txt >> $ps
