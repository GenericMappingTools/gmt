...
psbasemap -R-84/75/-78/81 -Jx${sclkm}i -O -K -Ba -BWSne+t"Multibeam bathymetry" >> $ps
grdimage $G.nc -I${G}_int.nc -Jx${scl}i -Cg.cpt -O -K -X3.25i >> $ps
psbasemap -R-84/75/-78/81 -Jx${sclkm}i -O -K -Ba -BWSne+t"Satellite gravity" >> $ps
...
psbasemap -R-100/91/-94/97 -Jx${sclkm}i -O -K -Ba -BWSne+t"Detrended and extended" >> $ps

grdimage ${G}_tmp.nc -I${G}_tmp_int.nc -Jx${scl}i -Cg.cpt -O -K -X3.25i >> $ps
psxy -R${G}_tmp.nc -J bbox -O -K -L -W0.5p,- >> $ps
psbasemap -R-100/91/-94/97 -Jx${sclkm}i -O -K -Ba -BWSne+t"Detrended and extended" >> $ps

psxy -R2/160/0/1 -JX-6il/2.5i -Bxa2f3g3+s" km" -Byafg0.5+l"Coherency@+2@+" -BWsNe -O -K -X-3.25i -Y3.5i cross.txt -i0,15 -W0.5p >> $ps
