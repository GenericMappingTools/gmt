#!/bin/bash
# $Id: x2sys_4.sh,v 1.2 2011-06-13 04:09:11 guru Exp $
#
...
. ../functions.sh
header "x2sys: Reproduce Wessel (2010) Comp. & Geosci., Figure 4"

ps=Wessel_x2sys_Fig_4.ps
OLDX=$X2SYS_HOME
...
psxy -R -J -O -T >> $ps
rm -f faa.cpt ss_gridded_fix[12]_int.nc ss_gridded_fix[12].nc COE_*.txt bad.lis data.lis corrections.txt
rm -rf TEST
