...
pscoast -Rpac_vel.nc -J -O -K -Ggray -B30f10 -BWSne >> $ps
echo "130 60 Plate velocity at formation" | pstext -R -J -O -K -T -Dj0.1i -F+jTL+f14p -Gwhite -W1p >> $ps
psscale -Ct.cpt -D2.25i/-0.4i/3.5i/0.15ih -O -K -Bx50f25 -By+lkm/Myr >> $ps
...
psscale -Ct.cpt -D2.25i/-0.4i/3.5i/0.15ih -O -K -Bx2000f1000 -By+lkm >> $ps
psxy -R -J -O -T >> $ps
