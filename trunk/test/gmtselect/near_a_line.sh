...
gmt gmtselect tt.xyz -L${D}/tt.d | gmt psxy -R -J -O -K -Sc0.02 -Ggreen >> $ps
gmt psxy -R -J -O -K tt.d -W1p >> $ps
# New behavior
gmt psxy -R -J -O -B1g1 -BWSne -K -Sc0.02 -Gred tt.xyz -X3.75i >> $ps
gmt gmtselect tt.xyz -Lp${D}/tt.d | gmt psxy -R -J -O -K -Sc0.02 -Ggreen >> $ps
gmt psxy -R -J -O -K tt.d -W1p >> $ps
# SPHERICAL DATA (-fg): distance D = 1 degree
D=1d
# Old behavior
gmt psxy -R -JM3.25i -O -B1g1 -BWSne -K -Sc0.02 -Gred tt.xyz -X-3.75i -Y4i >> $ps
gmt gmtselect tt.xyz -L${D}/tt.d -fg | gmt psxy -R -J -O -K -Sc0.02 -Ggreen >> $ps
gmt psxy -R -J -O -K tt.d -W1p >> $ps
# New behavior
gmt psxy -R -J -O -B1g1 -BWSne -K -Sc0.02 -Gred tt.xyz -X3.75i >> $ps
gmt gmtselect tt.xyz -Lp${D}/tt.d -fg | gmt psxy -R -J -O -K -Sc0.02 -Ggreen >> $ps
