...
grdimage mask.nc -Jx0.015id -Cmask.cpt -Bx60 -By30 -BWSne -K -P -Xc -Y1.5i > $ps
psxy -Rmask.nc -J -O -K 2k.dat -W0.25p,blue >> $ps
psscale -Cmask.cpt -L0.1i -D2.7i/-0.5i/3i/0.1ih -O -K >> $ps
grdimage mask.nc -R295/345/59/82 -Jx0.108i -Cmask.cpt -B10g1 -BWSne -O -K -Y3.1i >> $ps
...
grdimage mask.nc -R295/345/59/82 -Jx0.108i -Cmask.cpt -B10g1 -BWSne -O -K -Y2.9i >> $ps
