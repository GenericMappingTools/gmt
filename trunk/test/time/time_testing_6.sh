...
grdmath -R0/90/0/90 -I1 X Y ADD = tt6.nc
grdcontour tt6.nc -JX6t/6 -C5 -A10 --TIME_EPOCH=2004-01-01T --TIME_UNIT=d  -Bpxa7Rf1d -Bpy10 -Bsxa1O -P --FORMAT_DATE_MAP="-o-yy" --FONT_ANNOT_PRIMARY=9p > $ps
