...
grd2xyz tmp.nc | psxy -R$Rp -JX6i -Sc0.25c -Ct.cpt -P -K -B10f5 -BWSne -Xc -Y1.5i > $ps
psscale -D3i/-0.4i/6i/0.15ih -O -K -Ct.cpt -E >> $ps
# Extract portion of grid with values less than 5
grdcut tmp.nc -Z0/5 -Gout.nc
grd2xyz out.nc | psxy -R -J -Sc0.25c -W0.5p -O -K -B10f5 -BWSne+t"Rectangular subset with z <= 5" >> $ps
psxy -R$Rp -J -O -T >> $ps
