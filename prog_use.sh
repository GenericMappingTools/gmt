#!/bin/sh
# $Id: prog_use.sh,v 1.1 2011-06-17 18:55:48 guru Exp $
...
# Determines in which test and example scripts each GMT program is used
(cd src; ls *_func.c | awk -F_ '{print $1}' > /tmp/t.lis )
while read prog; do
