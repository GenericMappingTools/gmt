...
gmt grdimage @HI_geoid_02.nc -R160/20/220/30r -JOc190/25.5/292/69/4.5i -E50 -K -P -B10 -Cg.cpt -X1.5i -Y1.25i > %ps%
gmt psscale -Cg.cpt -DJRM+o0.6i/0+e+mc -J -R -O -K -Bx2+lGEOID -By+lm >> %ps%
gmt grd2cpt @HI_topo_02.nc -Crelief -Z > t.cpt
gmt grdimage @HI_topo_02.nc -I+a0+nt -R -J -E50 -B+t"H@#awaiian@# T@#opo and @#G@#eoid@#" -B10 -O -K -Ct.cpt -Y4.5i --MAP_TITLE_OFFSET=0.5i >> %ps%
