...
# GMT modules:  grdcontour, greenspline, psxy, pstext, movie
# Unix progs:   echo, cat
...
cat << EOF > main.sh
gmt begin
	let k=\${GMT_MOVIE_FRAME}+1
	gmt greenspline @Table_5_11.txt -R0/6.5/0/6.5 -I0.05 -Sc -Gt.nc -D1 -Cn\${k} -Emisfit.txt
	gmt grdcontour t.nc -C25 -A50 -Baf -BWsNE -JX4i -P -Gl3.6/6.5/4.05/0.75 -X0.25i -Y0.4i
