...
psmeca -X2i -Y5i -R238.5/242/32.5/35.5 -Jm1.3i -B2/2/:.psmeca:WeSn -Sm0.4i/12pu -T0 -P -C0.5pP5p -Gred -K -W0.75p << EOF > $ps
...
psmeca -o -R -J -Sa0.4i/16p -C0.25p,blueP5p -O -K -N << EOF >> $ps
