...
gmt psvelo t.txt -Jm1.5i -R-1/1/-1/1 -Se1.5i/0.95/12 -A9p+e -W1.5p,red -P -Bafg1 -BWSne -K -Xc > $ps
echo 0	60	0	1	0.1	0.1  0 > t.txt
gmt psvelo t.txt -Jm1.5i -R-1/1/59/61 -Se1.5i/0.95/12 -A9p+e -W1.5p,red -O -Bxafg1 -Byafg0.5 -BWsne -Xc -Y3.25i >> $ps
