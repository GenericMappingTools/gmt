...
D=0.05
R=0/7.2/-0.2/7
gmt greenspline -R$R -I$D -GWB1998.grd @table_5.11 -St0.5 -D1
gmt greenspline -R$R -I$D -GMM1993.grd @table_5.11 -Sr0.99 -D1
gmt surface @table_5.11 -R$R -I$D -Graws5.grd -T0.5 -N10000 -C0.0000001
...
gmt psxy -R -J -O @table_5.11 -Sc0.1 -G0 >> $ps
