...
gmt psxy -R-25/25/0/5 -JX6i/-2i cyl.txt -Ggray -W1p -P -Xc -K -Bxaf+u" km" -Byaf+l"km" -BWSne > $ps
gmt psxy -R-25/25/0/15 -JX6i/2.25i -O -K -Y2.15i g_truth.txt -Sc0.1c -Gred -Bxaf -Byaf+l"mGal" -BWsne >> $ps
gmt psxy -R -J -O -K faa.txt -W0.5p,blue >> $ps
gmt psxy -R-25/25/0/15 -JX6i/2.25i -O -K -Y2.4i n_truth.txt -Sc0.1c -Gred -Bxaf -Byaf+l"m" -BWsne >> $ps
