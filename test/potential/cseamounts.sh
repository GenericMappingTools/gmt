...
50	-50	50	1000	0.3
EOF
gmt grdseamount -Cc cart_circ.txt -R-100/100/-100/100 -I1 -F -Z-3000 -r -Gcart_circ.nc
...
gmt psscale -Ct.cpt -Dx3.25i/-0.4i+w5i/0.1i+h+jTC -B200f100 -O -K >> $ps
# LR. Input file for Geographic circular
cat << EOF > geo_circ.txt
-0.5	0.5	50	1000	0
0.5	-0.5	50	1000	0.3
EOF
gmt grdseamount -Cc geo_circ.txt -R-1/1/-1/1 -I0.01 -F -Z-3000 -r -Ggeo_circ.nc -fg
...
EOF
gmt grdseamount -Cc cart_ellipse.txt -R-100/100/-100/100 -I1 -E -F -Z-3000 -r -Gcart_ellipse.nc
...
EOF
gmt grdseamount -Cc geo_ellipse.txt -R-1/1/-1/1 -I0.01 -E -F -Z-3000 -r -Ggeo_ellipse.nc -fg
