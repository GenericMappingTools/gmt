...
gmt psxy adm.txt -R3/1000/0/2 -JX-6il/4.5i -O -Bxa1g3+l"Wavelength (km)" -Byafg+l"Admittance (mGal/km)" -BWSne -Sc0.05i -Ey+w0.2c+p0.5p,red -Gred -K -i0,1+s1000,2+s1000 -Y5.3i >> $ps
gmt psxy cross.txt -R -J -O -K -Sp -Ey+w0.1c+p0.5p,green -i0,11+s1000,12+s1000 >> $ps
gmt psxy cross.txt -R -J -O -W0.25p,green -i0,11+s1000 >> $ps
