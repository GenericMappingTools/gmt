...
ls smt_*.*.nc > t.lis
makecpt -Cjet -T0/41/1 -N > t.cpt
makecpt -Cjet -T0/41/1 -N -I> t2.cpt
...
while read file; do
	...
	grdtrack -G${file}+Uk -E0/75/200/75 -o0,2 -nn | psxy -R -J -O -K -G$rgb -Wfaint >> $ps
	let k=k+1
done < t.lis
