...
EOF
gmt grdseamount -Rk0/200/0/150 -I1000 -Gsmt_%05.2f.nc t.txt -T10/0/0.25 -Qc/l -Dk -E -F$f -C$m -Z-1
gmt grdseamount -Rk0/200/0/150 -I1000 -Gsmt.nc t.txt -C$m -Dk -E -F$f -Z-1
...
gmt grdtrack -Gsmt_00.00.nc+Uk -E0/75/200/75 -o0,1 -nn | psxy -R0/200/20/130 -J -O -K -W1p >> $ps
ls smt_*.*.nc > t.lis
gmt makecpt -Cjet -T0/41/1 -N -I > t.cpt
gmt makecpt -Cjet -T0/10/1 -N -I > t2.cpt
...
gmt grdtrack -Gsmt.nc+Uk -E0/75/200/75 -o0,2 -nn | psxy -R -J -O -K -W1p >> $ps
gmt psscale -Ct2.cpt -D3i/-0.4i/-5.5i/0.15ih -O -K -Baf -Bx+l"Time of emplacement" >> $ps
gmt psxy -R -J -O -T >> $ps
