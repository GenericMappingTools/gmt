...
awk '{print $1, $3*'"$corr"'}' cylinder25.txt | gmt psxy -R-100000/100000/-100/250 -J -Wfaint,blue -O -K >> $ps
awk '{print $1, $3*'"$corr"'}' cylinder25.txt | gmt psxy -R -J -Sc0.1c -Gblue -O -K >> $ps
awk '{print $1, $2*'"$corr"'}' cylinder25.txt | gmt psxy -R -J -Sc0.1c -Gred -O -K >> $ps
