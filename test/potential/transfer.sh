...
gmt begin transfer
	gmt subplot begin 6x3 -Fs5.5c/3c -SRl -SCb -JX5.5cl/3.25c -R1/5000/0/1.1 -Bxaf+ukm -Byafg1 -Bwesn -M3p -Y2c -T"Transfer Functions" -A
		# Elastic
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E
		...
		# Viscoelastic
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E10 -M20k
		...
		# Firmoviscous 1
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E10 -F2e20
		...
		# Firmoviscous 2
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E10 -F2e20/100k/1e21
		...
		gmt plot grdflexure_transfer_function_te_020_km.txt -i0,8 -W1p
		# Viscous 1
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E0 -F2e20
		...
		# Viscous 2
		gmt grdflexure -D3300/2700/2700/1000 -G+d -E0 -F2e20/100k/1e21
