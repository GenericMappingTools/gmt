...
gmt grdgravmag3d ${GMT_SOURCE_DIR}/doc/examples/ex48/etopo10m.nc -R$lim -fg -C1700 -Ggrdokb_grav.nc -I0.05 -Q0.5

# Generate a line to compute a profile
gmt project -C-11.7/37.2 -E-11/35.8 -G1 -Q > tt.xyp

# Compute the anomaly along the tt line
gmt grdgravmag3d ${GMT_SOURCE_DIR}/doc/examples/ex48/etopo10m.nc -R$lim -fg -C1700 -Ftt.xyp -Q0.5 > tt.grv
