...
while read t color; do
	gmt grdflexure smt.nc+uk -D${rhom}/${rhol}/${rhos}/${rhow} -E10k -F2e20/100k/1e22 -Gfv_%.12g.nc -Nf+a -T$t -L >> flist
done < times.txt
...
gmt psbasemap -R-200/200/-40/200 -J -O -K -BWsne+t"T@-e@- = 10 km A = 100 km @~\150@~@-a@- = 2\26410@+20@+ Pa\264s @~\150@~@-m@- = 1\26410@+22@+ Pa\264s" -Bafg1000 -Y3i >> $ps
