...
grd2xyz tmp.nc | psxy -R$Rp -JX3.25i -Sc0.15c -W0.25p -Ct.cpt -P -K -B10f5WSne -Xc -Y0.5i > $ps
...
grd2xyz out.nc | psxy -R$Rp -J -Sc0.15c -W0.25p -Ct.cpt -O -K -B10f5Wsne -Y3.5i >> $ps
