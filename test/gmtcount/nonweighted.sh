...
gmt begin nonweighted ps
	gmt set FONT_TAG 12p MAP_FRAME_TYPE plain
		...
		gmt count -I5 @capitals.gmt -a2=population -Ca -Gt.grd -S2000k
		gmt grdimage t.grd -JQ70E/3i
		# Plot MAD population
		gmt subplot set 2 -Ad
		gmt count -I5 @capitals.gmt -a2=population -Cd -Gt.grd -S2000k
		gmt grdimage t.grd
		...
		gmt count -I5 @capitals.gmt -a2=population -Ci -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot minimum population
		gmt subplot set 5 -Al
		gmt count -I5 @capitals.gmt -a2=population -Cl -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot median population
		gmt subplot set 6 -Am
		gmt count -I5 @capitals.gmt -a2=population -Cm -Gt.grd -S2000k
		gmt grdimage t.grd
		...
		gmt count -I5 @capitals.gmt -a2=population -Co -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot mode population
		gmt subplot set 9 -Ap
		gmt count -I5 @capitals.gmt -a2=population -Cp -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot quantile 75 population
		gmt subplot set 10 -Aq75
		gmt count -I5 @capitals.gmt -a2=population -Cq75 -Gt.grd -S2000k
		gmt grdimage t.grd
		...
		gmt count -I5 @capitals.gmt -a2=population -Cu -Gt.grd -S2000k
		gmt grdimage t.grd
	gmt subplot end
gmt end show
