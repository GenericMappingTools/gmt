#!/usr/bin/env bash
# Test most operators in gmtcount, with -W
gmt begin weighted ps
	...
	gmt set FONT_TAG 12p MAP_FRAME_TYPE plain
		...
		gmt count -I5 tmp.txt -W -Ca -Gt.grd -S2000k
		gmt grdimage t.grd -JQ70E/3i
		# Plot MAD population
		gmt subplot set 2 -Ad
		gmt count -I5 tmp.txt -W -Cd -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot stdev population
		gmt subplot set 3 -As
		gmt count -I5 tmp.txt -W -Cs -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot inter-quartile range population
		gmt subplot set 4 -Ai
		gmt count -I5 tmp.txt -W -Ci -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot minimum population
		gmt subplot set 5 -Al
		gmt count -I5 tmp.txt -W -Cl -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot median population
		gmt subplot set 6 -Am
		gmt count -I5 tmp.txt -W -Cm -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot number of points
		gmt subplot set 7 -An
		gmt count -I5 @capitals.gmt -Cn -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot LMSscale population
		gmt subplot set 8 -Ao
		gmt count -I5 tmp.txt -W -Co -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot mode population
		gmt subplot set 9 -Ap
		gmt count -I5 tmp.txt -W -Cp -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot quantile 75 population
		gmt subplot set 10 -Aq75
		gmt count -I5 tmp.txt -W -Cq75 -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot range population
		gmt subplot set 11 -Ag
		gmt count -I5 tmp.txt -W -Cg -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot sum population
		gmt subplot set 12 -Az
		gmt count -I5 tmp.txt -W -Cz -Gt.grd -S2000k
		gmt grdimage t.grd
		# Plot maximum population
		gmt subplot set 13 -Au
		gmt count -I5 tmp.txt -W -Cu -Gt.grd -S2000k
		gmt grdimage t.grd
	gmt subplot end
gmt end show
