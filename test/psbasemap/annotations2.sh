...
$psbasemap -R-25/25/-19/23 -B10WSne -P -K --FORMAT_GEO_MAP=ddd -Xa1i -Ya1i > $ps
$psbasemap -R-1.5/1.5/-1.2/1.5 -B0.5wSnE -O -K  --FORMAT_GEO_MAP=ddd.x -Xa4.5i -Ya1i >> $ps
$psbasemap -R-1.05/1.05/-1.1/1.3 -B30mWSne -O -K --FORMAT_GEO_MAP=ddd:mm -Xa1i -Ya4.25i >> $ps
