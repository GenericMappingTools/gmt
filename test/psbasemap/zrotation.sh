...
# Currently fails.  Faked the orig by using -JA<rot>... instead
...
gmt pscoast -R -JA45/-90/3.25i -Bg90a360f360 -Gred -Dc -X4.15i -O -K -p0+w0/-90 >> $ps
# UL corner is 180 degrees rotation
gmt pscoast -R -JA180/-90/3.25i -Bg90a360f360 -Gred -Dc -X-4.15i -Y4.15i -O -K -p0+w0/-90 >> $ps
# UR corner is 245 degrees rotation
gmt pscoast -R -JA245/-90/3.25i -Bg90a360f360 -Gred -Dc -X4.15i -O -p0+w0/-90 >> $ps
