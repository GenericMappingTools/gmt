...
# use that as input cols 2 and 3, then scale col 3 (mag ~ log10)
# to get symbol sizes.

ps=quakes.ps

gmt makecpt -Crainbow -T0/300 > t.cpt
gmt psxy quakes.gmt -R15/25/15/25 -JM6i -B5 -Sci -Ct.cpt -P -K -Wthin -a2=depth,3=magnitude -i0,1,2,3s0.05 -Yc -Xc > $ps
