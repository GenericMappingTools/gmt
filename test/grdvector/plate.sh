...
gmt grdvector plate_vel.nc plate_az.nc -A -R-30/80/-5/70 -JM3.5i -P -Baf -BWSnE -Q0.1i+e+n0.1i -W0.25p -Gblack -S200i -K -Xc -Y0.75i > $ps
gmt grdvector plate_vel.nc plate_az.nc -A -JG30/0/6i -O -K -Baf -Q0.1i+e+n0.1i -W0.25p -Gblack -S200i -X-1.25i -Y3.6i >> $ps
