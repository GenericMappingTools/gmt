...
gmt grdvector -O -K wx_grd000.nc wy_grd000.nc -R-180/180/-70/70 -J -Q4p+e+jc+gwhite -Si50 -W0.75p,white -I10 >> $ps
gmt pscoast -Rg -JG0/0/12c -Dc -Sblue -Glightgray -W0.01p,black -Baf --FONT_ANNOT_PRIMARY=9p,Helvetica,black -O -K -X3c -Y12c >> $ps
gmt grdvector -O wx_grd000.nc wy_grd000.nc -R-180/180/-70/70 -J -Q4p+e+jc+gwhite -Si50 -W0.75p,white -I10 >> $ps
