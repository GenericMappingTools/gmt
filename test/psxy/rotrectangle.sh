...
-80 25 70 500 300
EOF
psxy -R270/20/305/25r -JOc280/25.5/22/69/4i -P -B10g5WSne -SJ $$.rects.d -Gred -W0.25p,green -K > $ps
psxy -R -J -O -K -Sc0.05i $$.rects.d -G0 >> $ps
...
-80 25 90 0.5 0.2
EOF
psxy -R -J -O -K -B10g5WSne -Sji $$.rects.d -Gblue -W0.25p,green -Y3i >> $ps
psxy -R -J -O -K -Sc0.05i $$.rects.d -G0 >> $ps
