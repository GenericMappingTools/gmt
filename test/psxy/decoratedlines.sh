...
echo "> The second curve -S~n5:+ss0.5i+p0.25p+gcyan" >> data.txt
gmt math -T0/180/1 T SIND 1 ADD = >> data.txt
echo "> The third curve -S~N15:+sc0.1i+gblue+a0" >> data.txt
gmt math -T0/180/1 T SIND 2 ADD = >> data.txt
echo "> The fourth curve -S~lLM/RM:+sn0.3i+gblack" >> data.txt
gmt math -T0/180/1 T SIND 2.5 ADD = >> data.txt
echo "> The fifth curve -S~xvert.txt:+si0.3i+p1p+ggreen -W2p" >> data.txt
gmt math -T0/180/1 T SIND 3 ADD = >> data.txt
echo "> The sixth curve -S~N15:+sd0.1i+p0.25p,red -Wfaint" >> data.txt
gmt math -T0/180/1 T SIND 4 ADD = >> data.txt
echo "> The seventh curve -S~n5:+ss0.5i+p0.25p+gpurple+a0 -W1p,orange" >> data.txt
