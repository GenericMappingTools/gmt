...
gmt psxy -R -J -O -K -W1p -Gred -Sf0.4i/0.1i+t -X1i t.txt >> $ps
...
gmt psxy -R -J -O -K -W1p -Gred -Sf-1/0.1i+t -X1i t.txt >> $ps
...
gmt psxy -R -J -O -K -W1p -Gblue -Sf0.4i/0.1i+s+r -X0.5i t.txt >> $ps
...
gmt psxy -R -J -O -K -W1p -Gblue -Sf-1/0.1i+s+r -X0.5i t.txt >> $ps
...
gmt psxy -R -J -O -K -W1p -Gyellow -Sf0.4i/0.1i+s+l -X0.5i t.txt >> $ps
...
gmt psxy -R -J -O -K -W1p -Gyellow -Sf-1/0.1i+s+l -X0.5i t.txt >> $ps
