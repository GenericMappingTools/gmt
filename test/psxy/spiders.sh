...
echo 0.5 1.75 30 100 | gmt psxy -R -J -O -K -Sw2i+a0.25i -W1p >> $ps
echo 2.5 1.75 30 100 | gmt psxy -R -J -O -K -Sw2i+r15 -W0.5p -Glightyellow >> $ps
echo 4.5 1.75 30 100 | gmt psxy -R -J -O -K -Sw2i+a0.25i+r15 -W1p -Gpink >> $ps
# Geographic
...
echo 50 -30 -50 -110  | gmt psxy -R -J -O -K -SW30d+a5d -W1p -Gcyan >> $ps
echo -50 -30 50 110  | gmt psxy -R -J -O -K -SW30d+r30 -W1p -Gorange >> $ps
echo -10 80 -60 240  | gmt psxy -R -J -O -K -SW20d+a5d+r60 -W1p -Gyellow >> $ps
gmt psxy -R -J -O -T >> $ps
