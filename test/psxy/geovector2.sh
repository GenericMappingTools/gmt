...
0 -30 20 8000n
EOF
gmt psxy -R-180/180/-75/75 -JM6i -Bag -W0.5p,red -S=0.4i+jb+e+r -P -Gred --MAP_VECTOR_SHAPE=1 t.txt -K -Xc > $ps
...
-140 -65 80 6000
EOF
gmt psxy -R -J -W0.5p,black -S=0.4i+je+e+a20+l --MAP_VECTOR_SHAPE=1 t.txt -O -K >> $ps
