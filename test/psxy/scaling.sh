...
# echo 0 0 150 | gmt psxy -Scc -i0,1,2s0.01o-0.5
...
echo 0 0 100 | gmt psxy -R -J  -Baf -O -K -Scc -i0,1,2s0.01 -Gblack -X6c >> $ps
# Convert the value of 100 to 1 inch
echo 0 2 100 | gmt psxy -R -J -O -K -Sci -i0,1,2s0.01 -Gblack >> $ps
# UL
