...
gmt math -T0/50/1 T -C0 10 ADD = | gmt psxy -R -J -O -K -W2p+o1000k+v0.4i+p0.25p,blue --MAP_VECTOR_SHAPE=1 >> $ps
gmt math -T0/50/1 T -C0 15 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 15 ADD = | gmt psxy -R -J -O -K -W2p+o1000k+v0.4i+p0.25p,blue --MAP_VECTOR_SHAPE=0 >> $ps
gmt math -T0/50/1 T -C0 20 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 20 ADD = | gmt psxy -R -J -O -K -W2p+o1i/0.5i+ve0.3i+p2.5p,blue+gpink+ec+vb0.3i+p2.5p,blue+ggreen+es >> $ps
...
gmt math -T0/50/1 T -C0 35 ADD = | gmt psxy -R -J -O -K -W2p+o0/1000k+ve0.3i+p2.5p,blue+et >> $ps
gmt math -T0/50/1 T -C0 40 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 40 ADD = | gmt psxy -R -J -O -K -W2p+o1i/0+v0.3i+p0.25p,blue+gcyan --MAP_VECTOR_SHAPE=1 >> $ps
gmt math -T0/50/1 T -C0 45 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 45 ADD = | gmt psxy -R -J -O -K -W2p+o0/1i+vb0.3i+gblack --MAP_VECTOR_SHAPE=0.5 >> $ps
# Cartesian
...
gmt math -T0/50/1 T -C0 10 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 10 ADD = | gmt psxy -R -J -O -K -W2p+o10+v0.4i+p0.25p,blue --MAP_VECTOR_SHAPE=1 >> $ps
gmt math -T0/50/1 T -C0 15 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 15 ADD = | gmt psxy -R -J -O -K -W2p+o10+v0.4i+p0.25p,blue --MAP_VECTOR_SHAPE=0 >> $ps
gmt math -T0/50/1 T -C0 20 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 20 ADD = | gmt psxy -R -J -O -K -W2p+o1i/0.5i+ve0.3i+p2.5p,blue+gpink+ec+vb0.3i+p2.5p,blue+ggreen+es >> $ps
gmt math -T0/50/1 T -C0 25 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
...
gmt math -T0/50/1 T -C0 35 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 35 ADD = | gmt psxy -R -J -O -K -W2p+o0/10+ve0.3i+p2.5p,blue+et >> $ps
gmt math -T0/50/1 T -C0 40 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 40 ADD = | gmt psxy -R -J -O -K -W2p+o1i/0+v0.3i+p0.25p,blue+gcyan --MAP_VECTOR_SHAPE=1 >> $ps
gmt math -T0/50/1 T -C0 45 ADD = | gmt psxy -R -J -O -K -Wfaint,red >> $ps
gmt math -T0/50/1 T -C0 45 ADD = | gmt psxy -R -J -O -K -W2p+o0/1i+vb0.3i+gblack --MAP_VECTOR_SHAPE=0.5 >> $ps
