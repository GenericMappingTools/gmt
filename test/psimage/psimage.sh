...
gmt psimage -E80 -Dx3i/3i/BL ${GMT_SOURCE_DIR}/share/pattern/ps_pattern_10.ras -Gfred -Gb- -O -K >> $ps
gmt psimage -E80 -Dx3i/3i/TL ${GMT_SOURCE_DIR}/share/pattern/ps_pattern_10.ras -O >> $ps
