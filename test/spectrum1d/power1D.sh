...
psxy -R4992/5504/-1.25/1.25 t.txt -JX6i/2i -B64f32 -BWSne+t"Sinusoid @~l@~ = 25.6 from 0 to 10239" -W2p -P -K -Xc > $ps
...
psxy -R2/256/1e-19/100 -JX-6il/6.5il -Bxa2f3 -Bya-2p -BWsNe -O -K -Y3i pow5.txt -W0.25p >> $ps
