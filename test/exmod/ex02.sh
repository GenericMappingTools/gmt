...
gmt begin ex02 ps
  ...
  gmt subplot begin 2x1 -A+JTL+o0.1i/0 -Fs6i/3.5i -M0.2i -LWESN -T"H@#awaiian@# T@#opo and @#G@#eoid@#"
    gmt subplot 2,1 -Ce1.1i
    gmt grdimage @HI_geoid_02.nc -R160/20/220/30+r -JOc190/25.5/292/69 -B10 -Cg.cpt
    gmt psscale -Cg.cpt -DJRM+o0.6i/0+e+mc -Bx2+lGEOID -By+lm
    gmt subplot 1,1 -Ce1.15i
    gmt grdimage @HI_topo_02.nc -I+a0 -Ct.cpt -B10
