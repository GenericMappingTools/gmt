...
gmt mapproject pt.txt -J+proj=mill+ellps=WGS84+units=m | gmt math -o1 STDIN -C0 545131.546415 SUB -C1 6431916.372717 SUB 0 COL HYPOT 0.01 GT = >> results.txt
...
gmt mapproject pt.txt -J+proj=vandg+ellps=WGS84+units=m | gmt math -o1 STDIN -C0 489005.929978 SUB -C1 6431581.024949 SUB 0 COL HYPOT 0.01 GT = >> results.txt
gmt mapproject pt.txt -J+proj=omerc+ellps=WGS84+units=m+lat_1=20n+lat_2=60n+lon_1=1e+lon_2=30e | gmt math -o1 STDIN -C0 1009705.329154 SUB -C1 5829437.254923 SUB 0 COL HYPOT 0.01 GT = >> results.txt
