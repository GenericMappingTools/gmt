...
3 4
EOF
echo -e "0\t0\t246419.226859\t1\t2\tnot important text" > input.txt
...
cat << EOF > answer.txt
0	0	246419.226859	1	2	246419.226859	1	2	not important text
0	0	246419.226859	1	2	246419.226859	1	2
not important text
246419.226859	2
