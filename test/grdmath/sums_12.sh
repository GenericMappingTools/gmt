...
gmt grd2xyz c.grd | gmt pstext -R -J -O -K -B0g1 -B+t"1 CUMSUM" -Y-3.25i -N -F+f18p+jCM -Gwhite >> $ps
gmt grd2xyz r.grd | gmt pstext -R -J -O -B0g1 -B+t"2 CUMSUM" -Y-3.25i -N -F+f18p+jCM -Gwhite >> $ps
