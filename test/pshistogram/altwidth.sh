...
gmt begin altwidth ps
	gmt subplot begin 3x2 -Fs7c -SCb -SRl -R3/7/0/8 -BWSrt -A
		...
		gmt subplot set -A"Width 0.1"
		gmt histogram  hist.txt -T0.2 -Gred -W0.5p -E0.1
		gmt subplot set -A"Width 0.1 and offset -0.05"
		gmt histogram  hist.txt -T0.2 -Gred -W0.5p -E0.1+o-0.05
		gmt histogram  hist.txt -T0.2 -Ggreen -W0.5p -E0.1+o0.05
		gmt subplot set -A"Width 0.2c"
		gmt histogram  hist.txt -T0.2 -Gred -W0.5p -E0.2c
		gmt subplot set -A"Width 0.2c and offset -0.1c"
		gmt histogram  hist.txt -T0.2 -Gred -W0.5p -E0.2c+o-0.1c
		gmt subplot set -A"Width 0.2c and offset -0.1c"
		gmt histogram  hist.txt -T0.2 -Gred -W0.5p -E0.2c+o-0.1c
