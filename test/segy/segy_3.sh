...
gmt pssegyz wa1_mig13.segy $area1 $proj1 -Qx0.1i -D0.35 -C8.0 -Qy0.1i -W -Fgreen -Qb-1.2 -Sc/5 -P -K -Xc > $ps
gmt pssegyz wa1_mig13.segy -R $proj1 -Qx0.1i -D0/0.35 -C8.0 -Qy0.1i -Fred -Qb-1.2 -S5/c -O -K >> $ps
