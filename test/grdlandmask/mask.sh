...
grdimage tt.i2=bs -Jx0.017id -Bx30g180 -By30g90 -BWSnE -Ctt.cpt -Xc -Y0.75i -P -K > $ps
#
grdlandmask -Gtt.i2=bs -I60m -Rg -Di -N1/NaN/NaN/NaN/NaN -A500/1/1
grdimage tt.i2=bs -J -Bx30g180 -By30g90 -BWsnE -Ctt.cpt -Y3.25i -O -K >> $ps
#
grdlandmask -Gtt.i2=bs -I60m -Rd -Di -N1/NaN/NaN/NaN/NaN -A500/1/1
grdimage tt.i2=bs -J -Bx30g180 -By30g90 -BWsnE -Ctt.cpt -Y3.25i -O >> $ps
