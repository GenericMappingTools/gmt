...
gmt grdimage mask_c.grd -R0/360/0/80 -JPa3.250i -Ct.cpt -Bafg -O -K -X-0.75i -Y3.25i >> $ps
gmt grdimage mask_g.grd -R0/360/0/80 -JPa3.250i -Ct.cpt -Bafg -O -K -X3.75i >> $ps
gmt grdimage mask_g.grd -JH0/5.5i -Ct.cpt -Baf -O  -X-3i -Y3.65i >> $ps
