...
grdimage t.nc -JX6i -Ct.cpt -B64f32 -BWSne+t"Sinusoid @~l@~ = 25.6" -P -K -Xc > $ps
...
psxy -R2/100/1e-19/1 -JX-6il/2.5il -Bxa2f3 -Bya-2p -BWsNe -O -K -Y7i pow5.txt -Sc0.15c -Ggreen >> $ps
psxy -R -J -O -K pow4.txt -Sc0.075c -Gred >> $ps
