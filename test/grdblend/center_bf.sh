...
# This is for the native float format
ps=center_bf.ps
...
gmt grdblend -R-2/2/-2/2 -I1 -r LL.grd=bf LR.grd=bf UL.grd=bf UR.grd=bf -Gbig.nc
...
gmt grdimage big.nc -Ct.cpt -J -P -Bafg2 -BWsNE+t"Native binary bf" -O -K -Y4.5i >> $ps
