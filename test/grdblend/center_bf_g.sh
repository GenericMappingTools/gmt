...
gmt grd2xyz CM.nc | gmt pstext -RCM.nc -J -O -K -F+f16p+jCM -N -Gwhite >> $ps
gmt grdimage all.nc -Ct.cpt -J -P -Bafg2 -BWsNE+t"Gridline Native binary bf" -O -K -Y4.5i >> $ps
gmt grdinfo CM.nc -Ib | gmt psxy -Rall.nc -J -W4p -O -K -A >> $ps
gmt grd2xyz all.nc | gmt pstext -R -J -O -F+f16p+jCM -N -Gwhite >> $ps
