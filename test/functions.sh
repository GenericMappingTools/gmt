#
#	$Id: functions.sh,v 1.1 2007-11-15 04:16:54 remko Exp $
#
...
pscmp () {
	...
	compare -density 100 -metric PSNR $file.ps orig/$file.ps ${file}_diff.png 2>&1 | grep -v inf > fail
	passfail $file
}
