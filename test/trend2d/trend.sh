...
pscontour -R0/6.5/0/6.5 ../../doc/examples/ex16/table_5.11 -C25 -A50 -JX3i -Y6.5i -Baf:.Data: -K -X1i -I -Cz.cpt -P > $ps
triangulate -M ../../doc/examples/ex16/table_5.11 | psxy -R -J -O -K -W0.25p,- >> $ps
psxy -R -J -O -K ../../doc/examples/ex16/table_5.11 -Sc0.1c -Gblack >> $ps
psscale -Cz.cpt -D1.5i/-0.5i/3i/0.1ih -O -K -Ba >> $ps
trend2d ../../doc/examples/ex16/table_5.11 -Fxyrmw -N3r > trend.txt
