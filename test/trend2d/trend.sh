...
gmt pscontour -R0/6.5/0/6.5 @table_5.11 -C25 -A50 -JX3i -Y6.5i -Baf -B+tData -K -X1i -I -Cz.cpt -P > $ps
gmt triangulate -M @table_5.11 | gmt psxy -R -J -O -K -W0.25p,- >> $ps
gmt psxy -R -J -O -K @table_5.11 -Sc0.1c -Gblack >> $ps
gmt psscale -Cz.cpt -D1.5i/-0.5i+w3i/0.1i+h+jTC -O -K -Ba >> $ps
gmt trend2d @table_5.11 -Fxyrmw -N3r > trend.txt
...
gmt psscale -Cw.cpt -D1.5i/-0.5i+w3i/0.1i+h+jTC -O -K -Ba >> $ps
gmt psxy -R -J -O -T >> $ps
