...
grdimage aspect.nc -JX10c -Cpal.cpt -P -K -B2 -BWSne -Xc > $ps
psscale -D11c/5c/6c/0.6c -Cpal.cpt -B90+s"\\312" -O -K -E+n >> $ps
makecpt -Cjet -T0/1/0.1 > t.cpt
grdimage piramide.nc -J -O -K -Ct.cpt -B2 -BWSne -Y13c >> $ps
