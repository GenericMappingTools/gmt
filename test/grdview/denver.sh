...
gmt grdgradient @tut_relief.nc -A225 -Nt1 -Gint.nc
gmt grdmath -Rint.nc 104.9903W 39.7392N SDIST = r.nc
gmt grdmath r.nc $radius_of_spaceship LT = inside.nc
gmt grdgradient @tut_relief.nc -A90 -Nt1 -Gint1.nc
gmt grdgradient @tut_relief.nc -A-45 -Nt1 -Gint2.nc
gmt grdmath int1.nc int2.nc 0.5 MUL ADD inside.nc ADD 0.5 SUB = int.nc
gmt grdview @tut_relief.nc -Iint.nc -JM5i -JZ0.25i -p155/25 -Ct.cpt -P -K -Baf -Qi200 -X0.75i -N1000+glightgray > $ps
