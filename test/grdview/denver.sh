...
gmt grdgradient ${GMT_SOURCE_DIR:-../..}/doc/tutorial/us.nc -A90 -Nt1 -Gint1.nc
gmt grdgradient ${GMT_SOURCE_DIR:-../..}/doc/tutorial/us.nc -A-45 -Nt1 -Gint2.nc
gmt grdmath int1.nc int2.nc 0.5 MUL ADD inside.nc ADD 0.5 SUB = int.nc
gmt grdview ${GMT_SOURCE_DIR:-../..}/doc/tutorial/us.nc -Iint.nc -JM5i -JZ0.25i -p155/25 -Ct.cpt -P -K -Baf -Qi200 -X0.75i -N1000+glightgray > $ps
