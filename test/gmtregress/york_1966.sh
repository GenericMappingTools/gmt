...
gmt regress -Ey -Fxm -N2 york.txt -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W0.5p,red,- >> $ps
# Plot LSX solution ignoring data errors
gmt regress -Ex -Fxm -N2 york.txt -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W0.5p,black,. >> $ps
# Plot LSY solution using y-errors
gmt regress -Ey -Fxm -N2 -Wwy york.txt -i0,1,3 -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W1p,red >> $ps
# Plot LSX solution using x-errors
gmt regress -Ex -Fxm -N2 -Wwx york.txt -i0:2 -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W0.25p,black >> $ps
...
gmt regress -Eo -Fxm -N2 york.txt -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W0.5p,red,- >> $ps
# Plot LSXY solution using both x- and y-errors
gmt regress -Eo -Fxm -N2 -Wwxy york.txt -T-0.5/8.5/2+n | gmt psxy -R -J -O -K -W1p,red >> $ps
