...
pstext -R0/6/0/4 -Jx1i -Bag1 -P -Dj0.5i/0.5i -F+f32p+jLB -Gyellow -W0.25p,green  -K -C1c << EOF > $ps
2	2	TEXT
EOF
pstext -R0/6/0/4 -Jx1i -Bag1 -O -K -Dj0.5i/0.5i -F+f32p+jLB -Y5i -Gc -C1c << EOF >> $ps
2	2	TEXT
EOF
