...
\texttt{	union GMT_UNIVECTOR *data;}	&       /* \emph{Array with unions for each column}  */\\
\texttt{\};}	&        \\  \hline
\end{tabular}
...
\texttt{	union GMT_UNIVECTOR data;}	&       /* \emph{Union with pointers a data matrix of any type}  */\\
\texttt{\};}	&        \\  \hline
\end{tabular}
