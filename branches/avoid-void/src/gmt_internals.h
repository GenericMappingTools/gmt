...
EXTERN_MSC GMT_LONG GMT_ascii_textinput (struct GMT_CTRL *C, FILE *fp, GMT_LONG *ncol, char **ptr);
...
EXTERN_MSC GMT_LONG GMT_create_textset (struct GMT_CTRL *C, GMT_LONG n_tables, GMT_LONG n_segments, GMT_LONG n_rows, struct GMT_TEXTSET **Dout);
EXTERN_MSC GMT_LONG GMT_create_palette (struct GMT_CTRL *C, GMT_LONG n_colors, struct GMT_PALETTE **Pout);
