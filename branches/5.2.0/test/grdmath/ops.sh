...
echo -2 -2 Unit Spike | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
gmt grdimage B.grd -Ct.cpt -J -B0 -O -K -X3.25i >> $ps
echo -2 -2 CURV | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
gmt grdimage C.grd -Ct.cpt -J -B0 -O -K -X-3.25i -Y-3.25i >> $ps
echo -2 -2 D2DX2 | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
gmt grdimage D.grd -Ct.cpt -J -B0 -O -K -X3.25i >> $ps
echo -2 -2 D2DY2 | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
gmt grdimage E.grd -Ct.cpt -J -B0 -O -K -X-3.25i -Y-3.25i >> $ps
echo -2 -2 D2DX2 + D2DY2 | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
gmt grdimage F.grd -Ct.cpt -J -B0 -O -K -X3.25i >> $ps
echo -2 -2 EXTREMA | pstext -R -J -O -K -Dj0.1i -F+jLB+f12p >> $ps
psscale -Ct.cpt -D3.125i/-0.2i/6i/0.2ih -L0.1i -O -K -X-3.25i >> $ps
psxy -R -J -O -T >> $ps
