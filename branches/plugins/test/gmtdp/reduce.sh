#!/bin/sh
#	$Id$
# Testing gmt gmtdp on GSHHS high Australia polygon.

ps=reduce.ps

gmt psxy GSHHS_h_Australia.txt -R112/154/-40/-10 -JM5.5i -P -Sc0.01c -Gred -K -B20 -BWSne -Xc > $ps
gmt gmtdp GSHHS_h_Australia.txt -T50k | gmt psxy -R -J -O -K -W0.25p,blue >> $ps
...
gmt gmtdp GSHHS_h_Australia.txt -T100k | gmt psxy -R -J -O -K -W0.25p,blue >> $ps
