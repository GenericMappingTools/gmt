...
gmt grdcontour HI_geoid4.nc -R195/210/18/25 -Jm0.45i -p60/30 -C1 -A5+o -Gd4i -K -P -X1.5i -Y1.5i -UL/-1.25i/-1.25i/"Example 4 in Cookbook" > %ps%
gmt pscoast -R -J -p -B2/2NEsw -Gblack -O -K -T209/19.5/1i >> %ps%
gmt grdview HI_topo4.nc -R195/210/18/25/-6/4 -J -Jz0.34i -p -Czero.cpt -N-6/200/200/200 -Qsm -O -K -B2/2/2:"Topo (km)":neswZ -Y2.2i >> %ps%
...
gmt pscoast -R -J -p -B2/2NEsw -Gblack -O -K >> %ps%
gmt psscale -R -J -p -D3.375i/4.3i/5i/0.3ih -Cgeoid.cpt -I -O -K -A "-B2:Geoid (m):" >> %ps%
gmt psbasemap -R -J -p -O -K -T209/19.5/1i --COLOR_BACKGROUND=red --MAP_TICK_PEN_PRIMARY=thinner,red --FONT=red >> %ps%
gmt grdview HI_topo4.nc -It_intens.nc -R195/210/18/25/-6/4 -J -JZ3.4i -p -Ctopo.cpt -N-6/lightgray -Qc100 -O -K -Y2.2i -B2/2/2:"Topo (km)":neswZ >> %ps%
echo 3.25 5.75 H@#awaiian@# R@#idge | gmt pstext -R0/10/0/10 -Jx1i -F+f60p,ZapfChancery-MediumItalic+jCB -O >> %ps%
del *_intens.nc
del .gmt*
