...
gmt psxy -R0/6.5/-0.2/6.5 -JX3.06i/3.15i -B2f1WSNe net.xy -Wthinner -P -K -X0.9i -Y4.65i > %ps%
...
REM
gmt psxy -R -J -B2f1eSNw net.xy -Wthinner -O -K -X3.25i >> %ps%
...
gmt pscontour -R -J table_5.11 -B2f1WSne -Wthin -Ctopo.cpt -Lthinnest,- -Gd1i -X-3.25i -Y-3.65i -O -K -U"Example 12 in Cookbook" >> %ps%
REM
REM Finally color the topography
REM
gmt pscontour -R -J table_5.11 -B2f1eSnw -Ctopo.cpt -I -X3.25i -O -K >> %ps%
