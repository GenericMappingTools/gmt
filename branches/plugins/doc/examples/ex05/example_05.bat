...
gmt grdview sombrero.nc -JX6i -JZ2i -B5/5/0.5SEwnZ -N-1/white -Qs -Iintensity.nc -X1.5i -Cgray.cpt -R-15/15/-15/15/-1/1 -K -p120/30 -UL/-1.25i/-0.75i/"Example 5 in Cookbook" > %ps%
