...
EXTERN_MSC float GMT_decode (struct GMT_CTRL *C, void *vptr, COUNTER_LARGE k, GMT_LONG type);
EXTERN_MSC void GMT_encode (struct GMT_CTRL *C, void *vptr, COUNTER_LARGE k, float z, GMT_LONG type);
...
EXTERN_MSC size_t GMT_grd_data_size (struct GMT_CTRL *C, GMT_LONG format, double *nan_value);
...
EXTERN_MSC COUNTER_LARGE * GMT_split_line (struct GMT_CTRL *C, double **xx, double **yy, COUNTER_LARGE *nn, GMT_LONG add_crossings);
...
EXTERN_MSC COUNTER_LARGE GMT_fix_up_path_cartesian (struct GMT_CTRL *C, double **a_x, double **a_y, COUNTER_LARGE n, double step, GMT_LONG mode);
