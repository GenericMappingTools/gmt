...
EXTERN_MSC void GMT_get_lon_minmax (struct GMT_CTRL *C, double *lon, COUNTER n, double *min, double *max);
...
EXTERN_MSC char * GMT_ascii_textinput (struct GMT_CTRL *C, FILE *fp, GMT_LONG *ncol, GMT_LONG *status);
...
EXTERN_MSC GMT_LONG GMT_akima (struct GMT_CTRL *C, double *x, double *y, COUNTER nx, double *c);
EXTERN_MSC GMT_LONG GMT_cspline (struct GMT_CTRL *C, double *x, double *y, COUNTER n, double *c);
...
EXTERN_MSC float GMT_decode (struct GMT_CTRL *C, void *vptr, COUNTER k, GMT_LONG type);
EXTERN_MSC void GMT_encode (struct GMT_CTRL *C, void *vptr, COUNTER k, float z, GMT_LONG type);
...
EXTERN_MSC void GMT_rotate2D (struct GMT_CTRL *C, double x[], double y[], COUNTER n, double x0, double y0, double angle, double xp[], double yp[]);
EXTERN_MSC void GMT_set_bin_input (struct GMT_CTRL *C);
EXTERN_MSC COUNTER * GMT_split_line (struct GMT_CTRL *C, double **xx, double **yy, COUNTER *nn, GMT_LONG add_crossings);
...
EXTERN_MSC GMT_LONG GMT_genper_map_clip_path (struct GMT_CTRL *C, COUNTER np, double *work_x, double *work_y);
...
EXTERN_MSC struct GMT_TEXTSET * GMT_create_textset (struct GMT_CTRL *C, GMT_LONG n_tables, GMT_LONG n_segments, COUNTER n_rows);
...
EXTERN_MSC COUNTER GMT_fix_up_path_cartesian (struct GMT_CTRL *C, double **a_x, double **a_y, COUNTER n, double step, GMT_LONG mode);
