...
double vol_prism_frac_x (struct GMT_GRID *G, COUNTER ij, double x0, double x1, double a, double b, double c, double d)
{
...
double vol_prism_frac_y (struct GMT_GRID *G, COUNTER ij, double y0, double y1, double a, double b, double c, double d)
{
...
void SW_triangle (struct GMT_GRID *G, COUNTER ij, GMT_LONG triangle, double *dv, double *da)
...
void NE_triangle (struct GMT_GRID *G, COUNTER ij, GMT_LONG triangle, double *dv, double *da)
...
void SE_triangle (struct GMT_GRID *G, COUNTER ij, GMT_LONG triangle, double *dv, double *da)
...
void NW_triangle (struct GMT_GRID *G, COUNTER ij, GMT_LONG triangle, double *dv, double *da)
...
void NS_trapezoid (struct GMT_GRID *G, COUNTER ij, GMT_LONG right, double *dv, double *da)
...
void EW_trapezoid (struct GMT_GRID *G, COUNTER ij, GMT_LONG top, double *dv, double *da)
