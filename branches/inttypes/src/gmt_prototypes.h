...
EXTERN_MSC void GMT_grd_do_scaling (struct GMT_CTRL *C, float *grid, COUNTER nm, double scale, double offset);
...
EXTERN_MSC void GMT_set_segmentheader (struct GMT_CTRL *C, GMT_LONG direction, GMT_LONG true_false);
...
EXTERN_MSC struct GMT_DATASET * GMT_create_dataset (struct GMT_CTRL *C, GMT_LONG n_tables, int64_t n_segments, GMT_LONG n_columns, COUNTER n_rows);
EXTERN_MSC struct GMT_TABLE * GMT_create_table (struct GMT_CTRL *C, int64_t n_segments, GMT_LONG n_columns, COUNTER n_rows);
...
EXTERN_MSC struct GMT_DATASET * GMT_alloc_dataset (struct GMT_CTRL *C, struct GMT_DATASET *Din, GMT_LONG n_columns, COUNTER n_rows, GMT_LONG mode);
...
EXTERN_MSC GMT_LONG GMT_alloc_segment (struct GMT_CTRL *C, struct GMT_LINE_SEGMENT *S, COUNTER n_rows, GMT_LONG n_columns, GMT_LONG first);
...
EXTERN_MSC struct GMT_VECTOR * GMT_create_vector (struct GMT_CTRL *C, GMT_LONG n_columns);
...
EXTERN_MSC GMT_LONG GMT_alloc_vectors (struct GMT_CTRL *C, struct GMT_VECTOR *V, COUNTER n_rows);
EXTERN_MSC GMT_LONG GMT_alloc_univector (struct GMT_CTRL *C, union GMT_UNIVECTOR *u, GMT_LONG type, COUNTER n_rows);
EXTERN_MSC int gmt_byteswap_file (struct GMT_CTRL *C,
		FILE *outfp, FILE *infp, const SwapWidth nbytes,
		const COUNTER offset, const COUNTER length);
...
EXTERN_MSC void GMT_hold_contour (struct GMT_CTRL *C, double **xx, double **yy, COUNTER nn, double zval, char *label, char ctype, double cangle, GMT_LONG closed, struct GMT_CONTOUR *G);
EXTERN_MSC void GMT_x_free (struct GMT_CTRL *C, struct GMT_XOVER *X);
EXTERN_MSC GMT_LONG GMT_init_track (struct GMT_CTRL *C, double y[], COUNTER n, struct GMT_XSEGMENT **S);
EXTERN_MSC GMT_LONG GMT_crossover (struct GMT_CTRL *C, double xa[], double ya[], GMT_LONG sa[], struct GMT_XSEGMENT A[], COUNTER na, double xb[], double yb[], GMT_LONG sb[], struct GMT_XSEGMENT B[], COUNTER nb, GMT_LONG internal, struct GMT_XOVER *X);
...
EXTERN_MSC GMT_LONG GMT_detrend (struct GMT_CTRL *C, double *x, double *y, COUNTER n, double increment, double *intercept, double *slope, GMT_LONG mode);
...
EXTERN_MSC GMT_LONG GMT_compact_line (struct GMT_CTRL *C, double *x, double *y, COUNTER n, GMT_LONG pen_flag, int *pen);
EXTERN_MSC GMT_LONG GMT_geo_to_xy_line (struct GMT_CTRL *C, double *lon, double *lat, COUNTER n);
...
EXTERN_MSC void GMT_xyz_to_xy_n (struct GMT_CTRL *C, double *x, double *y, double z, COUNTER n);
EXTERN_MSC double * GMT_dist_array (struct GMT_CTRL *C, double x[], double y[], COUNTER n, double scale, GMT_LONG dist_flag);
EXTERN_MSC GMT_LONG GMT_map_truncate (struct GMT_CTRL *C, double *x, double *y, COUNTER n, COUNTER start, GMT_LONG side);
...
EXTERN_MSC double GMT_corrcoeff (struct GMT_CTRL *C, double *x, double *y, COUNTER n, GMT_LONG mode);
EXTERN_MSC double GMT_corrcoeff_f (struct GMT_CTRL *C, float *x, float *y, COUNTER n, GMT_LONG mode);
...
EXTERN_MSC double GMT_extreme (struct GMT_CTRL *C, double *x, COUNTER n, double x_default, GMT_LONG kind, GMT_LONG way);
...
EXTERN_MSC GMT_LONG GMT_median (struct GMT_CTRL *C, double *x, COUNTER n, double xmin, double xmax, double m_initial, double *med);
EXTERN_MSC GMT_LONG GMT_mode (struct GMT_CTRL *C, double *x, COUNTER n, COUNTER j, GMT_LONG sort, GMT_LONG mode_selection, GMT_LONG *n_multiples, double *mode_est);
EXTERN_MSC GMT_LONG GMT_mode_f (struct GMT_CTRL *C, float *x, COUNTER n, COUNTER j, GMT_LONG sort, GMT_LONG mode_selection, GMT_LONG *n_multiples, double *mode_est);
EXTERN_MSC double GMT_mean (struct GMT_CTRL *C, double *x, COUNTER n);
EXTERN_MSC double GMT_std (struct GMT_CTRL *C, double *x, COUNTER n);
EXTERN_MSC double GMT_median_weighted (struct GMT_CTRL *C, fpair *data, COUNTER n, double quantile);
EXTERN_MSC double GMT_mode_weighted (struct GMT_CTRL *C, fpair *data, COUNTER n);
...
EXTERN_MSC void GMT_getmad (struct GMT_CTRL *C, double *x, COUNTER n, double location, double *scale);
EXTERN_MSC void GMT_getmad_f (struct GMT_CTRL *C, float *x, COUNTER n, double location, double *scale);
...
EXTERN_MSC double GMT_quantile (struct GMT_CTRL *C, double *x, double q, COUNTER n);
EXTERN_MSC double GMT_quantile_f (struct GMT_CTRL *C, float *x, double q, COUNTER n);
...
EXTERN_MSC void GMT_sort_array (struct GMT_CTRL *C, void *base, COUNTER n, GMT_LONG type);
...
EXTERN_MSC GMT_LONG GMT_polygon_is_open (struct GMT_CTRL *C, double x[], double y[], COUNTER n);
EXTERN_MSC double GMT_polygon_area (struct GMT_CTRL *C, double x[], double y[], COUNTER n);
EXTERN_MSC GMT_LONG GMT_polygon_centroid (struct GMT_CTRL *C, double *x, double *y, COUNTER n, double *Cx, double *Cy);
EXTERN_MSC GMT_LONG GMT_get_distance (struct GMT_CTRL *C, char *line, double *dist, char *unit);
EXTERN_MSC COUNTER GMT_contours (struct GMT_CTRL *C, struct GMT_GRID *Grid, GMT_LONG smooth_factor, GMT_LONG int_scheme, GMT_LONG orient, GMT_LONG *edge, GMT_LONG *first, double **x, double **y);
...
EXTERN_MSC GMT_LONG GMT_intpol (struct GMT_CTRL *C, double *x, double *y, COUNTER n, COUNTER m, double *u, double *v, GMT_LONG mode);
...
EXTERN_MSC GMT_LONG GMT_non_zero_winding (struct GMT_CTRL *C, double xp, double yp, double *x, double *y, COUNTER n_path);
...
EXTERN_MSC struct GMT_LINE_SEGMENT * GMT_dump_contour (struct GMT_CTRL *C, double *x, double *y, COUNTER n, double z);
...
EXTERN_MSC void * GMT_memory_func (struct GMT_CTRL *C, void *prev_addr, size_t nelem, size_t size, char *fname, GMT_LONG line);
...
EXTERN_MSC COUNTER GMT_fix_up_path (struct GMT_CTRL *C, double **a_lon, double **a_lat, COUNTER n, double step, GMT_LONG mode);
...
/* grdmath_func */
EXTERN_MSC double GMT_mindist_to_point (struct GMT_CTRL *C, double lon, double lat, struct GMT_TABLE *T, COUNTER *id);
...
/* pscontour_func */
EXTERN_MSC GMT_LONG GMT_delaunay (struct GMT_CTRL *C, double *x_in, double *y_in, COUNTER n, int **link);
...
/* triangulate_func */
EXTERN_MSC GMT_LONG GMT_voronoi (struct GMT_CTRL *C, double *x_in, double *y_in, COUNTER n, double *we, double **x_out, double **y_out);

/* grd2xyz_func & xyz2grd_func */
EXTERN_MSC GMT_LONG GMT_parse_z_io (struct GMT_CTRL *C, char *txt, struct GMT_PARSE_Z_IO *z);
EXTERN_MSC GMT_LONG GMT_init_z_io (struct GMT_CTRL *C, char format[], GMT_LONG repeat[], int swab, off_t skip, char type, struct GMT_Z_IO *r);
