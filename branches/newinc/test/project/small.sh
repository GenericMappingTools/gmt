...
gmt project -C$C -T$P -G1 -L-20/60 | gmt psxy -Rg -J -O -K -W2p >> $ps
# Try plot 80 degree small circle around P
gmt project -C$C -T$P -G1/80 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,darkgray >> $ps
# Try plot 70 degree small circle around P
gmt project -C$C -T$P -G1/70 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,red >> $ps
# Try plot 60 degree small circle around P
gmt project -C$C -T$P -G1/60 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,orange >> $ps
# Try plot 50 degree small circle  around P
gmt project -C$C -T$P -G1/50 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,yellow >> $ps
# Try plot 40 degree small circle around P
gmt project -C$C -T$P -G1/40 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,green >> $ps
# Try plot 30 degree small circle around P
gmt project -C$C -T$P -G1/30 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,cyan >> $ps
# Try plot 20 degree small circle around P
gmt project -C$C -T$P -G1/20 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,purple >> $ps
# Try plot 10 degree small circle around P
gmt project -C$C -T$P -G1/10 -L-20/60 | gmt psxy -Rg -J -O -K -W2p,sandybrown >> $ps
#
...
grep Pole tmp | $AWK '{print $5, $6}' | gmt psxy -Rg -J -O -K -Sc0.1i -Gblue >> $ps
...
grep Pole tmp | $AWK '{print $5, $6}' | gmt psxy -Rg -J -O -K -Sc0.1i -Gmagenta >> $ps
...
grep Pole tmp | $AWK '{print $5, $6}' | gmt psxy -Rg -J -O -K -Sc0.1i -Gtan >> $ps
...
grep Pole tmp | $AWK '{print $5, $6}' | gmt psxy -Rg -J -O -K -Sc0.1i -Gbrown >> $ps
# Plot P and C and create circle through P and C
gmt project -C$C -E$P -G1 -L-180/180 | gmt psxy -Rg -J -O -K -W2p,- >> $ps
echo 85 40 | gmt psxy -Rg -J -O -K -Sa0.3i -Gblack >> $ps
echo 15 15 | gmt psxy -Rg -J -O -K -Sa0.3i -Gblack >> $ps
echo 85 40 P | gmt pstext -Rg -J -O -K -D0/-0.2i -F+f14p >> $ps
echo 15 15 C | gmt pstext -Rg -J -O -K -D0/-0.2i -F+f14p >> $ps
