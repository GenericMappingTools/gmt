...
for az in 30 135 200 290 ; do
	...
	while read x y; do
		...
		echo "$cx $cy $az 0.75" | psxy -R -J -O -K -SV0.15i+e -W0.5p -Gred -Xa$xpos -Ya$ypos >> $ps
		echo "$cx $cy $az90 0.75" | psxy -R -J -O -K -SV0.15i+e -W0.5p -Gred -Xa$xpos -Ya$ypos >> $ps
		...
		echo "$cx $cy 0 0.75" | psxy -R -J -O -K -SV0.15i+e -W0.5p -Gblack -Xa$xpos -Ya$ypos >> $ps
		echo "$cx $cy 90 0.75" | psxy -R -J -O -K -SV0.15i+e -W0.5p -Gblack -Xa$xpos -Ya$ypos >> $ps
