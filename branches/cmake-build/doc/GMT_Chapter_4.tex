...
\GMT\ supports plotting vectors in various forms.  Vectors is one of many symbols
that may be plotted by \GMTprog{psxy} and \GMTprog{psxyz}, is the main feature
in \GMTprog{grdvector}, and are indirectly used by others.  All vectors plotted by \GMT\ consist of two separate
...
\begin{enumerate}
	...
	start point and the direction and length (in map units) of the vector, or by the beginning and end point.
	They may also be specified giving the azimuth and length (in km) instead.
	
	\item Circular vectors are (as the name implies) circular and can be used to indicate opening
	...
	and the azimuth and length (in km) of the vector, or by the beginning and end point.
\end{enumerate}
...
There are numerous attributes you can modify for the vectors, including how the vector should be justified relative
