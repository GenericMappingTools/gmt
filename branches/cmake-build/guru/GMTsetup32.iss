...
; $Id$
; Creates Windows Setup file for the 32-bit GMT5 installation w/ GDAL support (complete GSHHS coastlines, no PDF)
...
Source: c:\GMTdev\GMT5\bin32\*.*; DestDir: {app}\bin; Flags: ignoreversion
...
[Messages]
WelcomeLabel2=This will install the 32-bit version of [name/ver] on your computer, including supporting libraries (netCDF and GDAL), HTML documentation, and the complete GSHHS coastlines (version 2.2.0).%n%nThe complete PDF documentation may be installed separately.
