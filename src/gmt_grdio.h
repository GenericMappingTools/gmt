/*--------------------------------------------------------------------
 *	$Id: gmt_grdio.h,v 1.46 2009-06-12 02:03:40 remko Exp $
 *
...
EXTERN_MSC GMT_LONG GMT_grd_setregion (struct GRD_HEADER *h, double *xmin, double *xmax, double *ymin, double *ymax, int interpolant);
