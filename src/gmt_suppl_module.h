...
/* gmt_suppl_module.h declares the prototypes for suppl module functions
 * and the array that contains suppl GMT module parameters such as name and
 * purpose strings.
 * DO NOT edit this file directly! Instead edit gmt_suppl_moduleinfo.txt and
 * regenerate this file with gmt_make_module_src.sh suppl. */

#pragma once
#ifndef _GMT_SUPPL_MODULE_H
#define _GMT_SUPPL_MODULE_H
...
/* Prototypes of all modules in the GMT suppl library */
...
/* Pretty print all modules in the GMT suppl library and their purposes */
EXTERN_MSC void gmt_suppl_module_show_all (struct GMTAPI_CTRL *API);

#ifdef __cplusplus
}
#endif

#endif /* !_GMT_SUPPL_MODULE_H */
