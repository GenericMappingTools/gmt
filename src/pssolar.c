...
EXTERN_MSC int GMT_pssolar (void *V_API, int mode, void *args) {
	...
	if (Ctrl->I.active) {
		...
		gmt_set_basemap_orders (GMT, Ctrl->N.active ? GMT_BASEMAP_FRAME_BEFORE : GMT_BASEMAP_FRAME_AFTER, Ctrl->N.active ? GMT_BASEMAP_GRID_BEFORE : GMT_BASEMAP_GRID_AFTER, Ctrl->N.active ? GMT_BASEMAP_ANNOT_BEFORE : GMT_BASEMAP_ANNOT_AFTER);
