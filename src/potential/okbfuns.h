...
EXTERN_MSC double okabe (struct GMT_CTRL *GMT, double x_o, double y_o, double z_o, double rho, GMT_BOOLEAN is_grav, struct BODY_DESC bd_desc, struct BODY_VERTS *bd_vert, COUNTER_MEDIUM km, COUNTER_MEDIUM pm, struct LOC_OR *loc_or);
...
EXTERN_MSC void rot_17 (COUNTER_MEDIUM n_vert, GMT_BOOLEAN top, struct LOC_OR *loc_or, double *c_tet, double *s_tet, double *c_phi, double *s_phi);
