...
static int usage (struct GMTAPI_CTRL *API, int level) {
	...
	GMT_Message (API, GMT_TIME_NONE, "\t       But be warn that this is a purely Cartesian operation so <width> must be in data units.\n");
	GMT_Message (API, GMT_TIME_NONE, "\t       That is, for geographical coordinates you o <width> must be\n");
#endif
