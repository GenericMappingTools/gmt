/*-----------------------------------------------------------------
 *	$Id: x2sys.h,v 1.29 2008-01-23 03:22:50 guru Exp $
 *
...
extern int x2sys_read_file (char *fname, double ***data, struct X2SYS_INFO *s, struct X2SYS_FILE_INFO *p, struct GMT_IO *G, int *n_rec);
