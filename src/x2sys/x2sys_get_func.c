...
GMT_LONG GMT_x2sys_get_usage (struct GMTAPI_CTRL *C, GMT_LONG level) {
	...
	GMT_message (GMT, "\n\tOPTIONS:\n");
	GMT_message (GMT, "	-C reports center of each tile with tracks instead [Default is track files]\n");
	GMT_message (GMT, "	-F is comma-separated list of column names that must ALL be present [Default is any field]\n");
	...
	GMT_message (GMT, "	-N is comma-separated list of column names that ALL must be missing\n");
