...
static struct Gmt_moduleinfo g_supplements_module[] = {
	...
	{"mgd77track", "mgd77track", "mgd77", "Plot track-line map of MGD77 cruises", ">X}"},
	...
	{"segy", "pssegy", "segy", "Plot a SEGY file on a map", ">X}"},
	...
	{"grdspotter", "grdspotter", "spotter", "Create CVA image from a gravity or topography grid", "<G{,AG(,DG),LG),GG}"},
	{"hotspotter", "hotspotter", "spotter", "Create CVA image from seamount locations", "<D{,GG}"},
