...
static struct Gmt_moduleinfo g_supplements_module[] = {
	...
	{"psmeca", "meca", "Plot focal mechanisms on maps", "<T{,>X},RG-"},
	{"pspolar", "meca", "Plot polarities on the inferior focal half-sphere on maps", "<T{,>X},RG-"},
	{"psvelo", "meca", "Plot velocity vectors, crosses, and wedges on maps", "<T{,>X},RG-"},
	{"mgd77convert", "mgd77", "Convert MGD77 data to other file formats", ""},
	{"mgd77info", "mgd77", "Extract information about MGD77 files", ">T}"},
	{"mgd77list", "mgd77", "Extract data from MGD77 files", ">?},RG-"},
	...
	{"gpsgridder", "potential", "Interpolate GPS velocity vectors using Green's functions for a thin elastic sheet", "<D{,ND(,TG(,CD)=f,GG},RG-"},
	...
	{"grdseamount", "potential", "Compute synthetic seamount (Gaussian, parabolic, cone or disc, circular or elliptical) bathymetry", "<T{,GG},MT),TD(,RG-"},
