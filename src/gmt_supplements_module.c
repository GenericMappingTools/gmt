...
struct Gmt_moduleinfo g_supplements_module[] = {
	{"grd2sph", "core", "Compute spherical harmonic coefficients from grid", "<GI,>DO"},
	...
	{"gmtflexure", "potential", "Compute flexural deformation of 2-D loads, forces, bending and moments", "<DI,QDI,>DO"},
	...
	{"grdpmodeler", "spotter", "Evaluate a plate model on a geographic grid", "<GI,ETI,FDI,GGO"},
