...
enum GMT_enum_gridio {
	...
	GMT_GRID_NEEDS_PAD1	   = 16384,	/* This module requires grids or images to have at least 1 boundary pad all around */
	GMT_GRID_NEEDS_PAD2	   = 32768	/* This module requires grids or images to have at least 2 boundary pad all around */
};
