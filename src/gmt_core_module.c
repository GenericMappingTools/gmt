...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,DDx,-Xo"},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", "-Xo,>Dx"},
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,DDx,-Xo"},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,DDx,-Xo"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,DDx,-Xo", &GMT_grdcontour},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", "-Xo,>Dx", &GMT_pscoast},
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,DDx,-Xo", &GMT_pscontour},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,DDx,-Xo", &GMT_psmask},
