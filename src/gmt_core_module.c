...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtinfo", "core", "Get information about data tables", "<DI,>?O"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,>DD,-Xo"},
	...
	{"grdinfo", "core", "Extract information from grids", "<GI,>TO,>DC"},
	...
	{"mapproject", "core", "Do forward and inverse map transformations, datum conversions and geodesy", "<DI,LDi,>DO,W-i"},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", "-Xo,>DM"},
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,>DD,-Xo"},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,C-i,-Xo"},
	...
	{"sphtriangulate", "core", "Delaunay or Voronoi construction of spherical lon,lat data", "<DI,>DO,NDo"},
	...
	{"gmtinfo", "core", "Get information about data tables", "<DI,>?O", &GMT_gmtinfo},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,>DD,-Xo", &GMT_grdcontour},
	...
	{"grdinfo", "core", "Extract information from grids", "<GI,>TO,>DC", &GMT_grdinfo},
	...
	{"mapproject", "core", "Do forward and inverse map transformations, datum conversions and geodesy", "<DI,LDi,>DO,W-i", &GMT_mapproject},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", "-Xo,>DM", &GMT_pscoast},
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,>DD,-Xo", &GMT_pscontour},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,C-i,-Xo", &GMT_psmask},
	...
	{"sphtriangulate", "core", "Delaunay or Voronoi construction of spherical lon,lat data", "<DI,>DO,NDo", &GMT_sphtriangulate},
