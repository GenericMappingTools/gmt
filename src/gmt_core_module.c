...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<D{,DD(=f,ND(=,TD(,>D},RG-,>TD,>TI,>TN+r"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<G{,AT)=t,CC(,DDD,>X},G?(=1,RG-"},
	...
	{"grdfilter", "core", "Filter a grid in the space (or time) domain", "<G{,FG(=1,GG},RG-"},
	...
	{"grdimage", "core", "Project grids or images and plot them on maps", "<G{+,CC(,IG(,>X},RG-,>IA,<ID"},
	...
	{"grdtrack", "core", "Sample grids at specified (x,y) locations", "<D{,DD),E-<,GG(,>D},RG-,SD)=s"},
	...
	{"greenspline", "core", "Interpolate using Green's functions for splines in 1-3 dimensions", "<D{,AD(=,ND(,TG(,CD)=f,G?},RG-,GDN"},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<D{,AT)=t,CC(,ED(,DDD,G?(=1,>X},RG-"},
	...
	{"pssolar", "core", "Plot day-light terminators and other sunlight parameters", ">X},>DI,>DM,RG-"},
	{"pstext", "core", "Plot or typeset text on maps", "<T{,>X},RG-"},
	{"pswiggle", "core", "Plot z = f(x,y) anomalies along tracks", "<D{,>X},RG-"},
	{"psxyz", "core", "Plot lines, polygons, and symbols in 3-D", "<D{,CC(,T-<,>X},S?(=2,RG-"},
	{"psxy", "core", "Plot lines, polygons, and symbols on maps", "<D{,CC(,T-<,>X},S?(=2,RG-"},
	...
	{"surface", "core", "Grid table data using adjustable tension continuous curvature splines", "<D{,DD(,LG(=1,GG},RG-"},
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<D{,DD(=f,ND(=,TD(,>D},RG-,>TD,>TI,>TN+r", &GMT_gmtspatial},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<G{,AT)=t,CC(,DDD,>X},G?(=1,RG-", &GMT_grdcontour},
	...
	{"grdfilter", "core", "Filter a grid in the space (or time) domain", "<G{,FG(=1,GG},RG-", &GMT_grdfilter},
	...
	{"grdimage", "core", "Project grids or images and plot them on maps", "<G{+,CC(,IG(,>X},RG-,>IA,<ID", &GMT_grdimage},
	...
	{"grdtrack", "core", "Sample grids at specified (x,y) locations", "<D{,DD),E-<,GG(,>D},RG-,SD)=s", &GMT_grdtrack},
	...
	{"greenspline", "core", "Interpolate using Green's functions for splines in 1-3 dimensions", "<D{,AD(=,ND(,TG(,CD)=f,G?},RG-,GDN", &GMT_greenspline},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<D{,AT)=t,CC(,ED(,DDD,G?(=1,>X},RG-", &GMT_pscontour},
	...
	{"pssolar", "core", "Plot day-light terminators and other sunlight parameters", ">X},>DI,>DM,RG-", &GMT_pssolar},
	...
	{"psxyz", "core", "Plot lines, polygons, and symbols in 3-D", "<D{,CC(,T-<,>X},S?(=2,RG-", &GMT_psxyz},
	{"psxy", "core", "Plot lines, polygons, and symbols on maps", "<D{,CC(,T-<,>X},S?(=2,RG-", &GMT_psxy},
	...
	{"surface", "core", "Grid table data using adjustable tension continuous curvature splines", "<D{,DD(,LG(=1,GG},RG-", &GMT_surface},
