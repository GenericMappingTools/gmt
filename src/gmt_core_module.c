...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdblend", "core", "Blend several partially over-lapping grids into one larger grid", "<G{,ED(,GG}"},
	...
	{"grdblend", "core", "Blend several partially over-lapping grids into one larger grid", "<G{,ED(,GG}", &GMT_grdblend},
