...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<DI,DDi,NDi,TDi,>DO,>TD,>TN+r"},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", ">XO,>DM,RG-,>TE+w-rR"},
	...
	{"pssolar", "core", "Plot day-light terminators and other sun-light parameters", ">XO,>DM,RG-"},
	...
	{"spectrum1d", "core", "Compute auto- [and cross-] spectra from one [or two] time series", "<DI,>DO,T-o"},
	...
	{"sphtriangulate", "core", "Delaunay or Voronoi construction of spherical data", "<DI,>DO,NDo,RG-"},
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<DI,DDi,NDi,TDi,>DO,>TD,>TN+r", &GMT_gmtspatial},
	...
	{"pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", ">XO,>DM,RG-,>TE+w-rR", &GMT_pscoast},
	...
	{"pssolar", "core", "Plot day-light terminators and other sun-light parameters", ">XO,>DM,RG-", &GMT_pssolar},
	...
	{"spectrum1d", "core", "Compute auto- [and cross-] spectra from one [or two] time series", "<DI,>DO,T-o", &GMT_spectrum1d},
	...
	{"sphtriangulate", "core", "Delaunay or Voronoi construction of spherical data", "<DI,>DO,NDo,RG-", &GMT_sphtriangulate},
