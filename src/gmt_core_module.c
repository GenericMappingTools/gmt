...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdcontour", "core", "Make contour map using a grid", "<G{,AT)=t,CC(,DDD,>X},G?(=1@<G{,AT)=t,CC(,DD),G?(=1"},
	...
	{"grdraster", "core", "Extract subregion from a binary raster and save as a GMT grid", "GG},DD)"},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<D{,AT)=t,CC(,ED(,DDD,G?(=1,>X}@<D{,AT)=t,CC(,ED(,DD),G?(=1"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<G{,AT)=t,CC(,DDD,>X},G?(=1@<G{,AT)=t,CC(,DD),G?(=1", &GMT_grdcontour},
	...
	{"grdraster", "core", "Extract subregion from a binary raster and save as a GMT grid", "GG},DD)", &GMT_grdraster},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<D{,AT)=t,CC(,ED(,DDD,G?(=1,>X}@<D{,AT)=t,CC(,ED(,DD),G?(=1", &GMT_pscontour},
