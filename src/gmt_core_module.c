...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdfft", "core", "Do mathematical operations on grids in the wavenumber (or frequency) domain", "<GI,GGO,RG-,>DE"},
	...
	{"grdfft", "core", "Do mathematical operations on grids in the wavenumber (or frequency) domain", "<GI,GGO,RG-,>DE", &GMT_grdfft},
