...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtregress", "core", "Linear regression of 1-D data sets"},
	...
	{"grdconvert", "core", "Convert between different grid formats"},
	...
	{"psconvert", "core", "Convert [E]PS file(s) to other formats using GhostScript"},
	...
	{"gmtregress", "core", "Linear regression of 1-D data sets", &GMT_gmtregress},
	...
	{"grdconvert", "core", "Convert between different grid formats", &GMT_grdconvert},
	...
	{"psconvert", "core", "Convert [E]PS file(s) to other formats using GhostScript", &GMT_psconvert},
