...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<D{,DD(=f,ND(=,TD(,>D},RG-,>TD,>TN+r"},
	...
	{"gmtspatial", "core", "Geospatial operations on lines and polygons", "<D{,DD(=f,ND(=,TD(,>D},RG-,>TD,>TN+r", &GMT_gmtspatial},
