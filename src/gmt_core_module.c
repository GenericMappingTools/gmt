...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,>DD,>XO,RG!"},
	...
	{"grdmask", "core", "Create mask grid from polygons or point coverage", "<DI,GGO,RG!"},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,>DD,>XO,RG!"},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,C-i,>XO,RG!"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,>DD,>XO,RG!", &GMT_grdcontour},
	...
	{"grdmask", "core", "Create mask grid from polygons or point coverage", "<DI,GGO,RG!", &GMT_grdmask},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,>DD,>XO,RG!", &GMT_pscontour},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,C-i,>XO,RG!", &GMT_psmask},
