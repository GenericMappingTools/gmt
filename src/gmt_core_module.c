...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdfft", "core", "Do mathematical operations on grids in the wavenumber (or frequency) domain", "<GI,GGO,RG-,GDE"},
	...
	{"sphdistance", "core", "Make Voronoi distance, node, or nearest-neighbor grid on a sphere", "<DI,NDi,QDi,GGO,RG-,Q-i"},
	...
	{"grdfft", "core", "Do mathematical operations on grids in the wavenumber (or frequency) domain", "<GI,GGO,RG-,GDE", &GMT_grdfft},
	...
	{"sphdistance", "core", "Make Voronoi distance, node, or nearest-neighbor grid on a sphere", "<DI,NDi,QDi,GGO,RG-,Q-i", &GMT_sphdistance},
