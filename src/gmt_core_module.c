...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"blockmean", "blockmean", "core", "Block average (x,y,z) data tables by L2 norm", "<D{,>D},GG),A->"},
	{"blockmedian", "blockmedian", "core", "Block average (x,y,z) data tables by L1 norm (spatial median)", "<D{,>D},GG),A->"},
	{"blockmode", "blockmode", "core", "Block average (x,y,z) data tables by mode estimation", "<D{,>D},GG),A->"},
	{"clear", "clear", "core", "Delete current defaults, or the cache, data or sessions directories", ""},
	{"clip", "psclip", "core", "Initialize or terminate polygonal clip paths", "<D{,>X},C-("},
	{"coast", "pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", ">?}"},
	{"colorbar", "psscale", "core", "Plot a gray-scale or color-scale on maps", "CC{,>X},ZD("},
	...
	{"gmt2kml", "gmt2kml", "core", "Convert GMT data tables to KML files for Google Earth", "<D{,>D},CC("},
	...
	{"gmtdefaults", "gmtdefaults", "core", "List current GMT default parameters", ""},
	{"gmtget", "gmtget", "core", "Get individual GMT default parameters", ">D}"},
	{"gmtinfo", "gmtinfo", "core", "Get information about data tables", "<D{,>D}"},
	{"gmtlogo", "gmtlogo", "core", "Plot the GMT logo on maps", ">X}"},
	...
	{"gmtset", "gmtset", "core", "Change individual GMT default parameters", ""},
	...
	{"grd2xyz", "grd2xyz", "core", "Convert grid file to data table", "<G{+,>D}"},
	{"grdblend", "grdblend", "core", "Blend several partially over-lapping grids into one larger grid", "<G{+,GG}"},
	...
	{"grdfft", "grdfft", "core", "Mathematical operations on grids in the wavenumber (or frequency) domain", "<G{+,GG},GDE"},
	...
	{"grdimage", "grdimage", "core", "Project grids or images and plot them on maps", "<G{+,CC(,IG(,>X},>IA,<ID@<G{+,CC(,IG(,AI),<ID"},
	...
	{"image", "psimage", "core", "Place images or EPS files on maps", "<I{,>X}"},
	...
	{"legend", "pslegend", "core", "Plot legends on maps", "<D{,>X}"},
	...
	{"plot", "psxy", "core", "Plot lines, polygons, and symbols on maps in 2-D", "<D{,CC(,T-<,>X},S?(=2"},
	{"plot", "psxy", "core", "Plot lines, polygons, and symbols on maps", "<D{,CC(,T-<,>X},S?(=2"},
	{"plot3d", "psxyz", "core", "Plot lines, polygons, and symbols in 3-D", "<D{,CC(,T-<,>X},S?(=2"},
	{"project", "project", "core", "Project data onto lines or great circles, generate tracks, or translate coordinates", "<D{,>D},G-("},
	...
	{"text", "pstext", "core", "Plot or typeset text on maps", "<D{,>X}"},
	{"trend1d", "trend1d", "core", "Fit a [weighted] [robust] polynomial/Fourier model for y = f(x) to xy[w] data", "<D{,>D}"},
	{"trend2d", "trend2d", "core", "Fit a [weighted] [robust] polynomial for z = f(x,y) to xyz[w] data", "<D{,>D}"},
	...
	{"xyz2grd", "xyz2grd", "core", "Convert data table to a grid file", "<D{,SD),GG}"},
	...
	{"blockmean", "blockmean", "core", "Block average (x,y,z) data tables by L2 norm", "<D{,>D},GG),A->", &GMT_blockmean},
	{"blockmedian", "blockmedian", "core", "Block average (x,y,z) data tables by L1 norm (spatial median)", "<D{,>D},GG),A->", &GMT_blockmedian},
	{"blockmode", "blockmode", "core", "Block average (x,y,z) data tables by mode estimation", "<D{,>D},GG),A->", &GMT_blockmode},
	{"clear", "clear", "core", "Delete current defaults, or the cache, data or sessions directories", "", &GMT_clear},
	{"clip", "psclip", "core", "Initialize or terminate polygonal clip paths", "<D{,>X},C-(", &GMT_clip},
	{"coast", "pscoast", "core", "Plot continents, countries, shorelines, rivers, and borders on maps", ">?}", &GMT_coast},
	{"colorbar", "psscale", "core", "Plot a gray-scale or color-scale on maps", "CC{,>X},ZD(", &GMT_colorbar},
	...
	{"gmt2kml", "gmt2kml", "core", "Convert GMT data tables to KML files for Google Earth", "<D{,>D},CC(", &GMT_gmt2kml},
	...
	{"gmtdefaults", "gmtdefaults", "core", "List current GMT default parameters", "", &GMT_gmtdefaults},
	{"gmtget", "gmtget", "core", "Get individual GMT default parameters", ">D}", &GMT_gmtget},
	{"gmtinfo", "gmtinfo", "core", "Get information about data tables", "<D{,>D}", &GMT_gmtinfo},
	{"gmtlogo", "gmtlogo", "core", "Plot the GMT logo on maps", ">X}", &GMT_gmtlogo},
	...
	{"gmtset", "gmtset", "core", "Change individual GMT default parameters", "", &GMT_gmtset},
	...
	{"grd2kml", "grd2kml", "core", "Create KML image quadtree from single grid", "<G{,CC(,IG(", &GMT_grd2kml},
	{"grd2xyz", "grd2xyz", "core", "Convert grid file to data table", "<G{+,>D}", &GMT_grd2xyz},
	{"grdblend", "grdblend", "core", "Blend several partially over-lapping grids into one larger grid", "<G{+,GG}", &GMT_grdblend},
	...
	{"grdfft", "grdfft", "core", "Mathematical operations on grids in the wavenumber (or frequency) domain", "<G{+,GG},GDE", &GMT_grdfft},
	...
	{"grdimage", "grdimage", "core", "Project grids or images and plot them on maps", "<G{+,CC(,IG(,>X},>IA,<ID@<G{+,CC(,IG(,AI),<ID", &GMT_grdimage},
	...
	{"image", "psimage", "core", "Place images or EPS files on maps", "<I{,>X}", &GMT_image},
	...
	{"legend", "pslegend", "core", "Plot legends on maps", "<D{,>X}", &GMT_legend},
	...
	{"plot", "psxy", "core", "Plot lines, polygons, and symbols on maps in 2-D", "<D{,CC(,T-<,>X},S?(=2", &GMT_plot},
	{"plot", "psxy", "core", "Plot lines, polygons, and symbols on maps", "<D{,CC(,T-<,>X},S?(=2", &GMT_plot},
	{"plot3d", "psxyz", "core", "Plot lines, polygons, and symbols in 3-D", "<D{,CC(,T-<,>X},S?(=2", &GMT_plot3d},
	{"project", "project", "core", "Project data onto lines or great circles, generate tracks, or translate coordinates", "<D{,>D},G-(", &GMT_project},
	...
	{"text", "pstext", "core", "Plot or typeset text on maps", "<D{,>X}", &GMT_text},
	{"trend1d", "trend1d", "core", "Fit a [weighted] [robust] polynomial/Fourier model for y = f(x) to xy[w] data", "<D{,>D}", &GMT_trend1d},
	{"trend2d", "trend2d", "core", "Fit a [weighted] [robust] polynomial for z = f(x,y) to xyz[w] data", "<D{,>D}", &GMT_trend2d},
	...
	{"xyz2grd", "xyz2grd", "core", "Convert data table to a grid file", "<D{,SD),GG}", &GMT_xyz2grd},
