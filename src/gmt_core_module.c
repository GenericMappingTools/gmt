...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtinfo", "core", "Get information about data tables", "<D{,>?}"},
	...
	{"subplot", "core", "Set multi-panel figure attributes under a GMT modern mode session", ""},
	...
	{"gmtinfo", "core", "Get information about data tables", "<D{,>?}", &GMT_gmtinfo},
	...
	{"subplot", "core", "Set multi-panel figure attributes under a GMT modern mode session", "", &GMT_subplot},
