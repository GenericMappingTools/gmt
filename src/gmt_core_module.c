...
static struct Gmt_moduleinfo g_core_module[] = {
	...
	{"clear", "core", "Delete current defaults, or the cache, data or sessions directories", ""},
	{"dimfilter", "core", "Directional filtering of grids in the space domain", "<G{,GG},>DQ"},
	{"docs", "core", "Show HTML documentation of specified module", ""},
	...
	{"grdinterpolate", "core", "Interpolate a 3-D data cube", "<G{,GG}"},
	...
	{"grdtrend", "core", "Fit trend surface to grids and compute residuals", "<G{,DG),TG),WG(,WG)"},
	...
	{"psevents", "core", "Plot event symbols and labels for a moment in time", "<D{,CC(,>X}"},
	...
	{"psrose", "core", "Plot a polar histogram (rose, sector, windrose diagrams)", "<D{,CC(,ED(,>X},>D),>DI@<D{,ID),CC("},
	...
	{"clear", "core", "Delete current defaults, or the cache, data or sessions directories", "", &GMT_clear},
	{"dimfilter", "core", "Directional filtering of grids in the space domain", "<G{,GG},>DQ", &GMT_dimfilter},
	{"docs", "core", "Show HTML documentation of specified module", "", &GMT_docs},
	...
	{"grdinterpolate", "core", "Interpolate a 3-D data cube", "<G{,GG}", &GMT_grdinterpolate},
	...
	{"grdtrend", "core", "Fit trend surface to grids and compute residuals", "<G{,DG),TG),WG(,WG)", &GMT_grdtrend},
	...
	{"psevents", "core", "Plot event symbols and labels for a moment in time", "<D{,CC(,>X}", &GMT_psevents},
	...
	{"psrose", "core", "Plot a polar histogram (rose, sector, windrose diagrams)", "<D{,CC(,ED(,>X},>D),>DI@<D{,ID),CC(", &GMT_psrose},
