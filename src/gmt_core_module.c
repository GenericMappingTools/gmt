...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"psconvert", "core", "Convert [E]PS file(s) to other formats using GhostScript", "FI)"},
	...
	{"psconvert", "core", "Convert [E]PS file(s) to other formats using GhostScript", "FI)", &GMT_psconvert},
