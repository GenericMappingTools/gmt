...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"gmtflexure", "potential", "Compute flexural deformation of 2-D loads, forces, bending and moments", &GMT_gmtflexure},
	...
	{"grdflexure", "potential", "Compute flexural deformation of 3-D surfaces for various rheologies", &GMT_grdflexure},
	...
	{"grdseamount", "potential", "Compute synthetic seamount (Gaussian, parabolic, cone or disc, circular or elliptical) bathymetry", &GMT_grdseamount},
