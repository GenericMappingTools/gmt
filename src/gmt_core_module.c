...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,DDD,-Xo"},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,DDD,-Xo"},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,-Xo"},
	...
	{"grdcontour", "core", "Make contour map using a grid", "<GI,CCi,DDD,-Xo", &GMT_grdcontour},
	...
	{"pscontour", "core", "Contour table data by direct triangulation", "<DI,CCi,EDi,DDD,-Xo", &GMT_pscontour},
	...
	{"psmask", "core", "Use data tables to clip or mask map areas with no coverage", "<DI,>DD,-Xo", &GMT_psmask},
