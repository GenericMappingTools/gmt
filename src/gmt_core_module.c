...
struct Gmt_moduleinfo g_core_module[] = {
	...
	{"pssolar", "core", "Plot day-light terminators and other sun-light parameters", "CCI,>XO"},
	...
	{"pssolar", "core", "Plot day-light terminators and other sun-light parameters", "CCI,>XO", &GMT_pssolar},
