...
"  /.setfillconstantalpha where {   % Using ghostscript; pop off dictionary first before setting mode salpha falpha\n"
"    pop .setblendmode .setstrokeconstantalpha .setfillconstantalpha\n"
"  }\n"
"  {  % Or Adobe; pop off dictionary first before saving mode salpha falpha then loading the structure\n"
"    /pdfmark where {pop /PSL_model edef /PSL_salpha edef /SPL_falpha edef [ /BM PSL_model /CA PSL_salpha /ca PSL_falpha /SetTransparency pdfmark\n"
"  }\n"
"  {pop pop pop} ifelse} ifelse        % Or skip if neither are supported\n"
"}!\n";
