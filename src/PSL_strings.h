...
"\n"
"/PSL_CT_textline\n"
"{ /psl_fnt PSL_fnt k get def		% Get this label's font attributes\n"
"  psl_fnt (FS) search {pop pop pop /PSL_fmode 2 def} {pop /PSL_fmode 1 def} ifelse	% 1 if regular font, 2 if outline font\n"
"  psl_fnt cvx exec					% Set this label's font attributes\n"
...
"  /psl_label PSL_label_str psl_k get def	% Current text label\n"
"  /psl_fnt PSL_label_font psl_k get def	% Get this label's font attributes\n"
"  psl_fnt cvx exec				% Set this label's font attributes\n"
"  psl_fnt (FS) search {pop pop pop /PSL_fmode 2 def} {pop /PSL_fmode 1 def} ifelse	% 1 if regular font, 2 if outline font\n"
...
"    psl_label dup sd neg 0 exch G	% Place the text, adjust vertically for any depth below baseline\n"
"    PSL_fmode 1 eq {show} {false charpath V S U fs N} ifelse	% Draw or fill the text with outline\n"
