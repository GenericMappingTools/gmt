...
EXTERN_MSC void gmt_M_free_shore_polygons (struct GMT_CTRL *GMT, struct GMT_GSHHS_POL *p, unsigned int n);
EXTERN_MSC void gmt_M_free_shore (struct GMT_CTRL *GMT, struct GMT_SHORE *c);
EXTERN_MSC void gmt_M_free_br (struct GMT_CTRL *GMT, struct GMT_BR *c);
