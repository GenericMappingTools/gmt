...
EXTERN_MSC int gmt_legend_file (struct GMTAPI_CTRL *API, char *file, int set_fig);
...
EXTERN_MSC bool gmt_get_legend_info (struct GMTAPI_CTRL *API, double *width, double *scale, char justification[], int set_fig);
