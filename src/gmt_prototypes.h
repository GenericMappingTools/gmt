...
EXTERN_MSC void gmt_plot_image_graticules (struct GMT_CTRL *GMT, struct GMT_IMAGE *I, struct GMT_GRID *Intens, struct GMT_PEN *pen, bool skip, double *intensity, struct GMT_GRID *Drape);
