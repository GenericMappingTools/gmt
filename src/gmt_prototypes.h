...
EXTERN_MSC int gmt_remove_dir (struct GMTAPI_CTRL *API, char *dir);
...
EXTERN_MSC unsigned int gmt_download_file_if_not_found (struct GMT_CTRL *GMT, const char* file_name);
