...
EXTERN_MSC GMT_LONG GMT_fft_1d (struct GMT_CTRL *C, float *data, COUNTER_MEDIUM n, GMT_LONG direction, GMT_LONG mode);
EXTERN_MSC GMT_LONG GMT_fft_2d (struct GMT_CTRL *C, float *data, COUNTER_MEDIUM nx, COUNTER_MEDIUM ny, GMT_LONG direction, GMT_LONG mode);
...
EXTERN_MSC GMT_LONG GMT_read_image (struct GMT_CTRL *C, char *file, struct GMT_IMAGE *I, double *wesn, 
			COUNTER_MEDIUM *pad, GMT_LONG complex);		/* Function to read true images via GDAL */
...
EXTERN_MSC void GMT_add_to_record (struct GMT_CTRL *C, char *record, double val, COUNTER_MEDIUM col, GMT_LONG sep);
...
EXTERN_MSC struct GMT_DATASET * GMT_alloc_dataset (struct GMT_CTRL *C, struct GMT_DATASET *Din, COUNTER_MEDIUM n_columns, COUNTER_LARGE n_rows, GMT_LONG mode);
EXTERN_MSC struct GMT_DATASET * GMT_duplicate_dataset (struct GMT_CTRL *C, struct GMT_DATASET *Din, COUNTER_MEDIUM n_columns, GMT_LONG mode);
...
EXTERN_MSC GMT_LONG GMT_alloc_segment (struct GMT_CTRL *C, struct GMT_LINE_SEGMENT *S, COUNTER_LARGE n_rows, COUNTER_MEDIUM n_columns, GMT_LONG first);
...
EXTERN_MSC void GMT_hold_contour (struct GMT_CTRL *C, double **xx, double **yy, COUNTER_LARGE nn, double zval, char *label, char ctype, double cangle, GMT_LONG closed, struct GMT_CONTOUR *G);
...
EXTERN_MSC COUNTER_MEDIUM * GMT_prep_nodesearch (struct GMT_CTRL *GMT, struct GMT_GRID *G, double radius, GMT_LONG mode, COUNTER_MEDIUM *d_row, COUNTER_MEDIUM *actual_max_d_col);
...
EXTERN_MSC double GMT_corrcoeff (struct GMT_CTRL *C, double *x, double *y, COUNTER_LARGE n, GMT_LONG mode);
EXTERN_MSC double GMT_corrcoeff_f (struct GMT_CTRL *C, float *x, float *y, COUNTER_LARGE n, GMT_LONG mode);
...
EXTERN_MSC void GMT_sort_array (struct GMT_CTRL *C, void *base, COUNTER_LARGE n, GMT_LONG type);
...
EXTERN_MSC GMT_LONG GMT_polygon_is_open (struct GMT_CTRL *C, double x[], double y[], COUNTER_LARGE n);
...
EXTERN_MSC COUNTER_LARGE GMT_fix_up_path (struct GMT_CTRL *C, double **a_lon, double **a_lat, COUNTER_LARGE n, double step, GMT_LONG mode);
