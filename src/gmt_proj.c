...
#if 0
GMT_LOCAL void gmtproj_genper_setup_obsolete (struct GMT_CTRL *GMT, double h0, double altitude, double lat, double lon0) {
/* if ellipsoid lat0 is geodetic latitude and must convert to geocentric latitude */
	...
	if (GMT->current.proj.g_radius || altitude < -10.0) {	/* Negative beyond -10 is deprecated but must have meant the same thing */
		/* Use altitude as the radial distance from the center of the earth in km */
