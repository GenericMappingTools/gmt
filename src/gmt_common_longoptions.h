     ...
     * multi_directive:  Indicates via GMT_MULTIDIR_DISABLE, etc., whether or how multi-directives are supported
     *
    ...
    {   0, 'Y', "yshift",
                ...
                "",                      "",
                GMT_MULTIDIR_DISABLE },
    {   0, 'a', "aspatial",              "", "", "", "", GMT_MULTIDIR_DISABLE },
    {   0, 'b', "binary",
                "i,o",                   "in,out",
                "b,l",                   "bigendian,littleendian",
                GMT_MULTIDIR_DISABLE },
    {   0, 'c', "panel",                 "", "", "", "", GMT_MULTIDIR_DISABLE },
    {   0, 'd', "nodata",
                "i,o",                   "in,out",
                "c",                     "column",
                GMT_MULTIDIR_DISABLE },
    ...
    {   0, 'w', "wrap",
                ...
                "c",                     "column",
                GMT_MULTIDIR_DISABLE },
    {   0, 'x', "cores",                 "", "", "", "", GMT_MULTIDIR_DISABLE },
    {   0, ':', "swapcols",
                "i,o",                   "input,output",
                "",                      "",
                GMT_MULTIDIR_DISABLE },
    {   0, '\0', "", "", "", "", "", GMT_MULTIDIR_DISABLE }    /* End of list is marked with empty short-option code and strings */
