 ...
 * and the array that contains core GMT module parameters such as name and
 * purpose strings.
 * DO NOT edit this file directly! Instead edit gmt_core_moduleinfo.txt and
 * regenerate this file with gmt_make_module_src.sh core. */
...
EXTERN_MSC int GMT_colmath (void *API, int mode, void *args);
...
EXTERN_MSC int GMT_gmtstitch (void *API, int mode, void *args);
...
EXTERN_MSC int GMT_minmax (void *API, int mode, void *args);
