...
{
	COUNTER_LARGE s, i;
	GMT_LONG nu1, nu2, prev1 = last - 1, prev2 = last - 2;
	double alpha;
...
{
	COUNTER_LARGE s, i;
	GMT_LONG prev1 = last - 1, prev2 = last - 2, inrange;
