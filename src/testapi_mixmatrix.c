...
int main () {
	...
	if ((M = GMT_Create_Data (API, GMT_IS_TEXTSET|GMT_VIA_MATRIX, GMT_IS_POINT, GMT_CONTAINER_ONLY, dim, NULL, NULL, 0, 0, NULL)) == NULL) return (EXIT_FAILURE);
	...
	GMT_Open_VirtualFile (API, GMT_IS_TEXTSET|GMT_VIA_MATRIX, GMT_IS_POINT, GMT_IN|GMT_IS_REFERENCE, M, input);
