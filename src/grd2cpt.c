...
static int usage (struct GMTAPI_CTRL *API, int level) {
	...
	GMT_Message (API, GMT_TIME_NONE, "\t   Instead, append +c to use the cumulative density function to set color bounds.\n");
