...
void GMT_textbox3D (double x, double y, double z, double size, GMT_LONG font, char *label, double angle, GMT_LONG just, BOOLEAN outline, double dx, double dy, int rgb[])
{
	double xoff, yoff;
	if (project_info.three_D) {
