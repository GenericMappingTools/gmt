...
/* Check if a module option has been called more than once */
#define gmt_M_repeated_module_option(API,active) (gmt_M_check_condition (API->GMT, active, "Option -%c: Given more than once\n", opt->option))
