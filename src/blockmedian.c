...
int GMT_blockmedian (void *V_API, int mode, void *args) {
	...
	if ((GMT = gmt_init_module (API, THIS_MODULE_LIB, THIS_MODULE_CLASSIC_NAME, THIS_MODULE_KEYS, THIS_MODULE_NEEDS, local_kw, &options, &GMT_cpy)) == NULL) bailout (API->error); /* Save current state */
