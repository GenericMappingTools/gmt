		...
		switch (opt->option) {
			...
			case 'C':
				...
				if (sscanf (opt->arg, "%[^/]/%s", txt_a, txt_b) != 2) {
					...
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_X], gmt_scanf_arg (GMT, txt_a, GMT->current.io.col_type[GMT_IN][GMT_X], false, &Ctrl->C.x), txt_a);
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_Y], gmt_scanf_arg (GMT, txt_b, GMT->current.io.col_type[GMT_IN][GMT_Y], false, &Ctrl->C.y), txt_b);
			...
			case 'E':
				...
				if (sscanf (opt->arg, "%[^/]/%s", txt_a, txt_b) != 2) {
					...
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_X], gmt_scanf_arg (GMT, txt_a, GMT->current.io.col_type[GMT_IN][GMT_X], false, &Ctrl->E.x), txt_a);
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_Y], gmt_scanf_arg (GMT, txt_b, GMT->current.io.col_type[GMT_IN][GMT_Y], false, &Ctrl->E.y), txt_b);
			...
			case 'G':
				...
				if (sscanf (opt->arg, "%[^/]/%s", txt_a, txt_b) == 2) {	/* Got dist/colat */
					...
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_Y], gmt_scanf_arg (GMT, txt_b, GMT->current.io.col_type[GMT_IN][GMT_Y], false, &Ctrl->G.colat), txt_b);
				}
				else
			...
			case 'T':
				...
				if (sscanf (opt->arg, "%[^/]/%s", txt_a, txt_b) != 2) {
					...
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_X], gmt_scanf_arg (GMT, txt_a, GMT->current.io.col_type[GMT_IN][GMT_X], false, &Ctrl->T.x), txt_a);
					n_errors += gmt_verify_expectations (GMT, GMT->current.io.col_type[GMT_IN][GMT_Y], gmt_scanf_arg (GMT, txt_b, GMT->current.io.col_type[GMT_IN][GMT_Y], false, &Ctrl->T.y), txt_b);
