...
int GMT_mgd77magref (void *V_API, int mode, void *args)
{
	...
	if (!options || options->option == GMTAPI_OPT_USAGE) bailout (GMT_mgd77magref_usage (API, GMTAPI_USAGE));	/* Return the usage message */
	if (options->option == GMTAPI_OPT_SYNOPSIS) bailout (GMT_mgd77magref_usage (API, GMTAPI_SYNOPSIS));	/* Return the synopsis */
