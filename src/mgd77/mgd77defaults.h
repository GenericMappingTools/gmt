/* MGD-77 Data Record Field Defaults:
		...
		{ "BathyTwoWayTravelTime",         "twt",        46,	   6,       "real",    10000,      "%06d",      12,       "%06d",     "%7.4f",   "999999",         0,           15,         .01},
		{ "BathyCorrectedDepth",         "depth",        52,	   6,       "real",       10,      "%06d",      13,       "%06d",     "%7.1f",   "999999",         0,        12000,          20},
		{ "BathyCorrectionCode",           "bcc",        58,	   2,        "int",        1,      "%02d",      14,       "%02d",        NULL,   "99",		   1,           99,       FALSE},
		{ "BathyTypeCode",                 "btc",        60,	   1,        "int",        1,       "%1d",      15,        "%1d",        NULL,   "9",		   1,            9,       FALSE},
		{ "MagFirstSensorTotalField",     "mtf1",        61,	   6,       "real",       10,      "%06d",      16,       "%06d",     "%7.1f",   "999999",     20000,        70000,           1},
		{ "MagSecondSensorTotalField",    "mtf2",        67,	   6,       "real",       10,      "%06d",      17,       "%06d",     "%7.1f",   "999999",     20000,        70000,           1},
		{ "MagResidualField", 	           "mag",        73,	   6,       "real",       10,      "%06d",      18,      "%+06d",     "%7.1f",   "+99999",     -1000,         1000,           1},
		{ "MagSensorForResidualField",   "msens",        79,	   1,        "int",        1,       "%1d",      19,        "%1d",        NULL,   "9",		   1,            9,       FALSE},
		{ "MagDiurnalCorrection",         "diur",        80,	   5,       "real",       10,      "%05d",      20,      "%+05d",     "%6.1f",   "+9999",	-200,          200,          .5},
		{ "MagSensorDepthAltitude",        "msd",        85,	   6,        "int",        1,      "%06d",      21,      "%+06d",       "%7d",   "+99999",     -1000,        10000,          10},
		{ "GravObserved",                 "gobs",        91,	   7,       "real",       10,      "%07d",      22,       "%07d",     "%8.1f",   "9999999",   977000,       983500,          .1},
		{ "GravEotvosCorrection",          "eot",        98,	   6,       "real",       10,      "%06d",      23,      "%+06d",     "%7.1f",   "+99999",      -200,          200,         .05},
		{ "GravFreeAirAnomaly",            "faa",       104,	   5,       "real",       10,      "%05d",      24,      "%+05d",     "%6.1f",   "+9999",       -300,          300,          .1},
