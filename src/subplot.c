...
GMT_LOCAL int usage (struct GMTAPI_CTRL *API, int level) {
	...
	GMT_Message (API, GMT_TIME_NONE, "usage: gmt %s begin <nrows>x<ncols> -F[f|s]<width(s)>/<height(s)>[:<wfracs/hfracs>] [-A<autolabelinfo>]\n", name);
	...
	GMT_Message (API, GMT_TIME_NONE, "usage: gmt %s <row>,<col> [-A<fixedlabel>] [-C<side><clearance>[u]] [%s] [%s]\n\n", name, GMT_V_OPT, GMT_PAR_OPT);
	GMT_Message (API, GMT_TIME_NONE, "usage: gmt %s end [%s] [%s]\n\n", name, GMT_V_OPT, GMT_PAR_OPT);
