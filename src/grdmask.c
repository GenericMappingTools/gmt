...
static int usage (struct GMTAPI_CTRL *API, int level) {
	...
	GMT_Usage (API, 3, "a) If OGR/GMT files, get z-value via -aZ=<name> for attribute <name>.");
	GMT_Usage (API, 3, "b) Interpret segment z-values (-Z<zval>) as the z-value.");
	GMT_Usage (API, 3, "c) Interpret segment labels (-L<label>) as the z-value.");
