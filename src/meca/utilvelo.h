/*	$Id: utilvelo.h,v 1.5 2008-03-22 11:55:36 guru Exp $
...
void paint_ellipse (double x0, double y0, double angle, double major, double minor, double scale, double t11,double t12,double t21,double t22, GMT_LONG polygon, GMT_LONG rgb[3], BOOLEAN outline);
