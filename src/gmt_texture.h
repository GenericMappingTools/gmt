...
struct GMT_FILL {	/* Holds fill attributes */
	...
	uint32_t dpi;		/* Desired dpi of image building-block */
...
struct GMT_FONT {	/* Holds font attributes */
	...
	uint32_t id;		/* Font ID number from predefined list */
	uint32_t form;		/* Combination of binary 1 = fill, 2 = outline, 4 = pattern fill [1] */
