...
EXTERN_MSC void GMT_img_syntax (struct GMT_CTRL *C);
EXTERN_MSC void GMT_fft_syntax (struct GMT_CTRL *C, char option, char *string);
...
EXTERN_MSC void GMT_extract_label (struct GMT_CTRL *C, char *line, char *label, struct GMT_OGR_SEG *G);
EXTERN_MSC void GMT_check_lattice (struct GMT_CTRL *C, double *inc, unsigned int *registration, bool *active);
...
EXTERN_MSC int GMT_report_func (struct GMT_CTRL *C, unsigned int level, const char *source_line, const char *format, ...);
