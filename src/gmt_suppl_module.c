...
/* gmt_suppl_module.c populates the external array of GMT suppl module parameters
 ...
 *
 *   void gmt_suppl_module_show_all (struct GMTAPI_CTRL *API); - Print suppl module names and purposes
 *
...
/* Look out for suppl modules given by their aliases or old names */
