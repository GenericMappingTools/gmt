/*--------------------------------------------------------------------
 *	$Id: gmt.h,v 1.24 2001-09-15 19:55:48 pwessel Exp $
 *
...
EXTERN_MSC struct MAP_FRAME frame_info;		/* Boundary info for linear plots and maps */
EXTERN_MSC struct TIME_FRAME tframe_info;	/* Boundary info for time axis plots */
