/*--------------------------------------------------------------------
 *	$Id: gmt_contour.h,v 1.40 2008-03-22 11:55:34 guru Exp $
 *
...
struct GMT_CONTOUR_LINE {
	...
	GMT_LONG font_rgb[3];		/* Font color */
...
struct GMT_CONTOUR {
	...
	GMT_LONG rgb[3];			/* Opaque box color */
	GMT_LONG font_rgb[3];		/* Font color */
...
EXTERN_MSC GMT_LONG GMT_crossover (double xa[], double ya[], GMT_LONG sa[], struct GMT_XSEGMENT A[], GMT_LONG na, double xb[], double yb[], GMT_LONG sb[], struct GMT_XSEGMENT B[], GMT_LONG nb, BOOLEAN internal, struct GMT_XOVER *X);
