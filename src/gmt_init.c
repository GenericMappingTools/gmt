/*--------------------------------------------------------------------
 *	$Id: gmt_init.c,v 1.431 2010-02-20 20:24:23 jluis Exp $
 *
...
GMT_LONG GMT_parse_R_option (char *item, double *w, double *e, double *s, double *n) {
	...
	/* Chop any eventual EOLs characters that might be in *item if it was generated by a shell command */
	GMT_chop(item);
...
BOOLEAN GMT_check_region (double w, double e, double s, double n)
