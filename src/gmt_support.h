/*--------------------------------------------------------------------
 *	$Id: gmt_support.h,v 1.32 2008-03-22 11:55:35 guru Exp $
 *
...
EXTERN_MSC GMT_LONG GMT_check_rgb (GMT_LONG *rgb);
...
EXTERN_MSC GMT_LONG GMT_contours (float *grd, struct GRD_HEADER *header, GMT_LONG smooth_factor, GMT_LONG GMT_LONG_scheme, GMT_LONG orient, GMT_LONG *side, GMT_LONG *edge, GMT_LONG first, double **x_array, double **y_array);
...
EXTERN_MSC GMT_LONG GMT_get_rgb_from_z (double value, GMT_LONG *rgb);
...
EXTERN_MSC GMT_LONG GMT_getrgb (char *line, GMT_LONG *rgb);
...
EXTERN_MSC GMT_LONG GMT_just_decode (char *key, GMT_LONG i, GMT_LONG j);
...
EXTERN_MSC void GMT_illuminate (double intensity, GMT_LONG *rgb);
EXTERN_MSC void GMT_init_fill (struct GMT_FILL *fill, GMT_LONG r, GMT_LONG g, GMT_LONG b);
...
EXTERN_MSC char *GMT_convertpen (struct GMT_PEN *pen, GMT_LONG *width, GMT_LONG *offset, GMT_LONG rgb[]);
...
#ifdef DEBUG
EXTERN_MSC void *GMT_memory_func (void *prev_addr, size_t nelem, size_t size, char *progname, char *fname, GMT_LONG line);
...
EXTERN_MSC void GMT_memtrack_add (struct MEMORY_TRACKER *M, char *name, GMT_LONG line, void *ptr, void *prev_ptr, size_t size);
