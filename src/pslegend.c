				...
				switch (line[0]) {
					...
					case 'S':	/* Symbol record */
						...
						if (symbol[0] == 'f') {	/* Front is different, must plot as a line segment */
							...
							Ds[FRONT]->coord[GMT_X][0] = x_off + off_ss-x;	Ds[FRONT]->coord[GMT_Y][0] = y0;
							Ds[FRONT]->coord[GMT_X][1] = x_off + off_ss+x;	Ds[FRONT]->coord[GMT_Y][1] = y0;
							D[FRONT]->n_records += 2;
							n_fronts++;
							...
							/* Set begin and end coordinates of the line segment */
							Ds[QLINE]->coord[GMT_X][0] = x_off + off_ss-x;	Ds[QLINE]->coord[GMT_Y][0] = y0;
							Ds[QLINE]->coord[GMT_X][1] = x_off + off_ss+x;	Ds[QLINE]->coord[GMT_Y][1] = y0;
							D[QLINE]->n_records += 2;
							n_quoted_lines++;
