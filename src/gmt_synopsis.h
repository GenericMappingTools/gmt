...
/* Full syntax of input and output grids */
#define GMT_INGRID   "<ingrid>[=<ID>][+d<divisor>][+n<invalid>][+o<offset>][+s<scale>]"
#define GMT_OUTGRID  "<outgrid>[=<ID>][+d<divisor>][+n<invalid>][+o<offset>|a][+s<scale>|a]"
...
#define GMT_f_OPT	"-f[i|o]c|g|p[<unit>]|<col>f|t|T|x|y"
