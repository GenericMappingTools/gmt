...
**-H**\ *f_dec/f_dip/m_int/m_dec/m_dip* **-H**\ *magfile*  **-Hx**\|\ **y**\|\ **z**\|\ **h**\|\ **t**\|\ **d**\|\ **i** **-H+i**\|\ **g**\|\ **r**\|\ **f**\|\ **n**
    ...
    To compute a component, specify any of:
      ...
      **d**\|\ **D**  to compute the declination of the anomaly.

      **i**\|\ **I**  to compute the inclination of the anomaly.
