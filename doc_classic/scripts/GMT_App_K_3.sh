...
gmt psbasemap -R -J -O -K -Tm133/2+w1i+t45/10/5+jCM --FONT_TITLE=12p --MAP_TICK_LENGTH_PRIMARY=0.05i \
	--FONT_ANNOT_SECONDARY=8p >> GMT_App_K_3.ps
gmt psbasemap -R -J -O -Dg130.35/-0.2+w200k+jCM -F+pthicker >> GMT_App_K_3.ps
