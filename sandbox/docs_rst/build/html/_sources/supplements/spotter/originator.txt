...
**originator** [ *table* ] **-E**\ *rotfile* **-F**\ *hs\_file* [
**-D**\ *d\_km* ] [ **-L**\ [*flag*\ ] ] [ **-N**\ *upper\_age* ] [
**-Q**\ *r/t* ] [ **-S**\ [*n\_hs*\ ] ] [ **-T** ] [ **-V**\ [*level*\ ]
] **-W**\ *maxdist* ] [ **-Z** ] [ **-bi**\ [*ncol*\ ][**t**\ ] ] [
**-h**\ [**i**\ \|\ **o**][*n*\ ] ] [
...
*r*,\ *t* that
    will be implied for each record. **-S**\ [*n\_hs*\ ] Set the number
    of closest hotspots to report [Default is 1].
**-T**
...
**originator** seamounts.d **-S**\ 2 **-E**\ DC85.d **-F**\ pac\_hs.d >
origins.d

`See Also <#toc7>`_
-------------------

`*GMT*\ (1) <GMT.1.html>`_ , `*grdrotater*\ (1) <grdrotater.1.html>`_ ,
