...
If the symbol size is expected via the third data column then you may
...
(1) <in.1.html>`_ the current directory, (2) the ~/.gmt directory, `and
(3) <and.3.html>`_ the **$GMT\_SHAREDIR**/custom directory, in that
...
`*psbasemap*\ (1) <psbasemap.1.html>`_ , `*psxyz*\ (1) <psxyz.1.html>`_
