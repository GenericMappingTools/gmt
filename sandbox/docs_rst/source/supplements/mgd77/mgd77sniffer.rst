...
**-D**\ **d**\ \|\ **e**\ \|\ **E**\ \|\ **f**\ \|\ **l**\ \|\ **m**\ \|\ **s**\ \|\ **v**\ [*r*\ ]
    ...
    **-De** output E77 error classification format. Error output is
    divided `into (1) <into.1.html>`_ a header containing information
...
**-g**\ *fieldabbrev*,\ *imggrid*,\ *scale*,\ *mode*
    ...
    elsewhere, `and (3) <and.3.html>`_ Img file with constraints coded,
...
**mgd77sniffer** 08010001 **-G**\ depth,/data/GRIDS/etopo5\_hdr.i2
**-g**\ faa,/data/GRIDS/grav.11.2.img,0.1,1
