...
3.3.1--6), 3.4, 3.4.1--5, and 4.0--4.5.8 were released between November 1998 and
April 2012, culminating in the \GMTDOCDATE\ introduction of \GMTDOCVERSION.
...
\item Edit your \filename{gmt.conf} file, change \GMTdef{FORMAT\_GEO\_MAP}
...
\item Change the parameter \GMTdef{MAP\_GRID\_CROSS\_SIZE\_PRIMARY} to make grid crosses instead of gridlines.
...
set \GMTdef{PS\_CHAR\_ENCODING} to ISOLatin1 in your \filename{gmt.conf} file.
...
\Opt{Qc}\emph{dpi}[\textbf{g}] & Same as \Opt{Qi} but using \PS\ Level 3 to make NaN color transparent. \\ \hline
...
\item Wessel, P., and W.H.F. Smith, The Generic Mapping Tools Technical Reference and Cookbook, \emph{Version 4.5.9}, pp. 155, 2013.
