...
grdmask -R77:03:35W/77:03:10W/38:52:05N/38:52:25N -I0.25s -fg -A "$src"/pentagon.gmt -N0/1/2 -Gmask.nc
cat << EOF > mask.cpt
0	blue	1	-
1	green	2	-
2	red	3	-
...
psxy -Rmask.nc -J -O -K "$src"/pentagon.gmt -W0.25p,white >> $ps
# 2. make an ID grid from a multipolygon file with IDs set to CPT entries
grdmask -R-3/8/-3/5 -I0.1 -r "$src"/multihole.gmt -aZ=ID -Ni -GID.nc
cat << EOF > mask.cpt
0	blue	1	- ;B
1	green	2	- ;G
2	red	3	- ;R
...
psxy -RID.nc -J -O -K "$src"/multihole.gmt -W0.25p,white >> $ps
