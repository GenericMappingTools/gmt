...
if (UNIX AND NOT WEBKIT_FOUND)
	...
	if (WEBKIT_CONFIG)
		execute_process (COMMAND ${WEBKIT_CONFIG} --cflags gtk+-${WEBKIT_VERSION} webkit2gtk-${WEBKIT_VERSION}
		...
		execute_process (COMMAND ${WEBKIT_CONFIG} --libs gtk+-${WEBKIT_VERSION} webkit2gtk-${WEBKIT_VERSION}
			ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE
