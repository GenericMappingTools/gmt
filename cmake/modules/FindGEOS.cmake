...
IF(WIN32)
  ...
  IF (MSVC)
    FIND_PATH(GEOS_INCLUDE_DIR geos_c.h HINTS ${GEOS_DIR} ${GEOS_INCLUDE_DIR} $ENV{LIB_DIR}/include $ENV{INCLUDE})
    FIND_LIBRARY(GEOS_LIBRARY NAMES geos_c_i geos_c geos  HINTS ${GEOS_DIR} PATHS
      "$ENV{LIB_DIR}/lib"
      $ENV{LIB}
      )
  ENDIF (MSVC)
