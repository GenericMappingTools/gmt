...
; $Id: GMTsetup64.iss,v 1.3 2011-07-08 23:17:25 guru Exp $
; Creates Windows Setup file for the 64-bit GMT installation w/ GDAL support (no h/f coastlines, no PDF)
...
Source: c:\GMTdev\GMT\bin64\*.*; DestDir: {app}\bin; Flags: ignoreversion
Source: c:\GMTdev\GMT\gmtswitch.bat; DestDir: {app}\bin; Flags: ignoreversion
